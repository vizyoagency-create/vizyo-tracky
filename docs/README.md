...
| [`rdv-installation/`](./rdv-installation/) | La prise de RDV d'installation (`/book/:token`) : week-end, visites (qui, quand, depuis quoi), liens de découverte, entretien quotidien (14/09) ; conception v2 (16/09) et son **lot A** (17/09 : lien prospect sans flotte, contact obligatoire, multi-véhicules, validation avec rattachement, annulation, suppression « conserver / effacer »). |
