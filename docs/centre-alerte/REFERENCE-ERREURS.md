...
EAI_AGAIN <HOTE>`
**Statut : 🟠 CORRECTIF ÉCRIT ET COMMITÉ (`3c36cce0`), NON DÉPLOYÉ** · **gravité 3** · famille **brut** · 2026-09-02 *(🧹 en-tête rectifié le 2026-09-04 — ancien libellé : « 🔴 NON CORRIGÉ ». Le message dit désormais la conséquence avant la pile ; le motif technique est conservé en fin de phrase.)*
...
**Statut : 🟠 CORRECTIF ÉCRIT ET COMMITÉ (`eadc0e72`), NON DÉPLOYÉ** · gravité **1** · 3 lignes / 2 incidents · 2026-09-03 → 2026-09-04 *(🧹 en-tête rectifié le 2026-09-04 — ancien libellé : « 🔴 NON CORRIGÉ · 2 lignes / 1 incident ». ⚠️ Le volet CODE est traité ; **le compte reste à sec**, et ça, aucun correctif ne le fera.)*
...
**Statut : 🟠 CORRECTIF ÉCRIT ET COMMITÉ (`bacc9b44`), NON DÉPLOYÉ** · gravité **1** · famille **à lire, pas à notifier** · 2026-09-04 *(⚠️ le volet CODE est traité — la sentinelle sait désormais dire qu'elle n'a rien à garder. **Le réglage par défaut reste une décision produit.**)*
...
**Statut : 🟠 CORRECTIF ÉCRIT ET COMMITÉ (`68034a1d`), NON DÉPLOYÉ** · gravité **3** · 1 occurrence · 2026-09-04 *(🧹 en-tête rectifié le 2026-09-04 — ancien libellé : « 🔵 TERRAIN / action humaine ». Le volet CODE écarte les comptes techniques ; **prévenir le second titulaire reste une action humaine**.)*
