...
| [TRK-071](#trk-071) | `AI_ROUTER` | **Le repli IA est né inerte : le SECOND compte est à sec aussi** — `Repli IA en échec : claude → gpt (provider_unfunded) — …` | 🔵 **TERRAIN** *(action humaine : recharger)* · **gravité 1** · famille **terrain** *(1 occurrence, 05/09 12:23:59. Le repli `claude → gpt` livré le jour même (chantier C3 point 1) a été exercé **six minutes après sa mise en ligne** et n'avait nulle part où aller : Anthropic à sec depuis le 03/09 00:13, OpenAI constaté vide. **Ce n'est PAS un défaut de code** — le routeur bascule, échoue, l'écrit, le date et le classe correctement en `DEGRADATION`. 🔑 **Un mécanisme de secours ne vaut que par la ressource qu'il vise** : livrer une redondance sans provisionner sa cible, c'est livrer une ligne de journal. Action : recharger **au moins un** des deux comptes)* | 2026-09-06 | 2026-09-06 |
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`68034a1d`), NON EXERCÉ** · gravité **3** · 1 occurrence · 2026-09-04 *(🧹 en-tête rectifié le 2026-09-05 — ancien libellé : « CORRECTIF ÉCRIT ET COMMITÉ, NON DÉPLOYÉ », lui-même rectifié le 04/09 depuis « 🔵 TERRAIN / action humaine ». Marqueur `comptesTechniquesEcartes` **vérifié le 05/09 sur l'artefact SERVI**. Refroidissement **hebdomadaire** : prochaine ligne attendue vers le **11/09**. **Prévenir le second titulaire reste une action humaine.**)*
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-07 à 00:58:58 (`c80632ba`), NON EXERCÉ** · gravité **2** · famille **brut** · 1 occurrence · 2026-09-04 · *(🧹 en-tête recalé le 07/09 : `AbortSignal` et `ServiceUnavailableException` vérifiés sur l ARTEFACT SERVI. Ancien en-tête : « 🔴 NON CORRIGÉ ». ⚠️ **Déployé n est pas prouvé** — aucun rejet de transport depuis le 04/09 12:57)*
