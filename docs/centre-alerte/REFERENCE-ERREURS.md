...
- Dernière mise à jour : **2026-09-21 01:30 UTC** *(🟢🔴 **CINQUIÈME NUIT PROBANTE DU COUPE-CIRCUIT — SOUS UNE VM À 10 % DE SON CPU, LE MÉCANISME A TENU ET CE SONT SES INSTRUMENTS QUI ONT MENTI.** Journée du 20/09 (VPS-045, limitation Hostinger levée à 13:36) : **31 reprises / 31 acquittées** le matin (2,6 → 220 s au lieu de 0,4 → 7 s, **5 SMS de secours dont 2 pour rien**), **30 coupes / 30** le soir (0 refus, HM-733-GA pas rallumé à la main pour la première fois en 6 nuits). 🆕 [TRK-090](#trk-090) **gravité 2** : la **preuve SMS quotidienne** de 02:30 et 04:30 déclarée « REFUSÉE » puis « **en ÉCHEC — la chaîne SMS est cassée** » (4 `CRITICAL`, 2 e-mails, 2 pushs) **alors que le téléphone l'avait reçue 38 s après** — 5 échos entrants en base, ignorés parce que la soumission avait dépassé le délai client de 10 s (`failed`) et que `verify` ne consulte l'écho que sur un sortant « accepté » ; l'interlock n'a tenu que grâce à un SMS de secours payant remis à 05:02:57. 🆕 [TRK-091](#trk-091) **gravité 3** : le **worker RESTORE ré-émet une commande dont le dispatch en ligne est encore en vol** (3–4 s de latence base) — bail absent à la création, numéro de tentative lu en mémoire, trame écrite avant la ligne — 6 commandes, **4 `CRITICAL` « Worker RESTORE en erreur — intention conservée »** (+1 fondue) sur des remises acquittées 6–17 s plus tard. 📏 [TRK-083](#trk-083) **exercé 3 fois** dont **1 SANS charge** (EP-047-TY CUT 18:00:02, `jt` 43 ms avant la trame journalisée → `SENT_UNCONFIRMED` pour une coupe exécutée) ; AL-927-QM a payé un SMS **7 s après son ACK**. 📏 [TRK-089](#trk-089) **2ᵉ épisode, cause serveur** : 8 `CRITICAL` watchdog « aborted due to timeout » (`reachable: false`), 7 pushs, 0 sortie. 📏 [TRK-068](#trk-068) exercé ×8 : **personne n'a pu se connecter de 05:10 à 06:58**. 🆕 [TRK-092](#trk-092) ⚪ : `email` ×2, `sims-sync`, `positions`, `wire-logger` — 5ᵉ récidive du message de transport brut. 🔴 [TRK-069](#trk-069) : pause **4 j**, 99 h sans récit. ✅ V35 prouvé côté application (steal 2 %, passage de 00:45 en 0,6 min), V34 jour 1/7, reboot V4 sans passage interrompu)* · *Précédent (20/09 01:30, couvre 18→20/09) :* *(🟢 nuits 3 et 4 probantes (59 coupes / 59 ACK TCP), S21 hors ligne 2 h 22 dans la nuit du 18 au 19 → 🆕 [TRK-089](#trk-089) (9 `CRITICAL` watchdog, 2 `INDETERMINEE` jamais refermées après remise à 04:46), V33 + VPS-016 nº 7 : `%steal` 89 %)* · *Précédent (18/09 01:30) :* *(🟢 **DEUXIÈME NUIT PROBANTE DU CHANTIER COUPE-CIRCUIT** (nuit 17→18, prod `1d1521b2` = `origin/main`) : preuve de 21:30 Paris remise en 5 s, **0 refus d'interlock**, **28 coupes** (4 MH Cars, 24 CDEF31), **28 acquittées en 0,4–5,1 s** dont **EY-613-MF par SMS en 5 s**, 0 « non confirmée » ; **T62 et T69 (2) exercés pour la première fois** — T65 : 6 OK / 0 non exercé, second passage OK. 🔴 **MAIS LA JOURNÉE DU 17 PORTE L'INCIDENT QUE LE CENTRE D'ALERTE N'A PAS VU** : l'API à terre de **04:56 à 05:52** (migration du lot A en double, doc 31) a retardé de **53 à 67 min** les 24 reprises CDEF31 de 07:00 Paris (nées 05:53, `scheduledAt` NUL, 20 par SMS, 29/29 acquittées à 06:08) et **pas une ligne ne dit le retard** — 🆕 [TRK-084](#trk-084) **gravité 1** (*une API morte n'écrit pas qu'elle est morte ; T51 compte depuis `createdAt` ; le passage de 05:45 n'existe pas ; + 6 RESTORE en double, 1 SMS payé pour rien*). **7 reprises non prouvées à +5 min, 14 notifications poussées, 1 seule ligne** : 🆕 [TRK-085](#trk-085) **gravité 2** — l'anti-flood de `ErrorLogger` (source + niveau + 140 caractères, 60 s) fond des véhicules distincts dont le message ne porte pas la plaque, et perd les autres sans compteur (idem `sms-gateway-status` : 6 refus → 4 lignes). 🆕 [TRK-086](#trk-086) : HM-769-GA vivant sans fix depuis 33,7 h fait crier le recalcul horaire **8 fois en 7 h** — le trajet brut du 31/08 qui déclenche la tranche est hors de la tranche, jamais figé. 🆕 [TRK-088](#trk-088) : `sms-gateway-status` parle pour la première fois (voix de T45, fait = T61). 🆕 [TRK-087](#trk-087) : ⚪ 503 `MANAGER_INTERNAL_URL` à la recette du lot A, clos le jour même. 📏 [TRK-069](#trk-069) : **session Claude Code du poste expirée à 03:21** (401) — ✅ **T34 exercé** (pause 08:50 par la sentinelle, 1 e-mail, 1 ligne, 0 nouvelle `CRITICAL`), mais **0 récit depuis 22 h**, reprise manuelle (T75). ✅ **T29 prouvé** (`deploy.sh --attendre` : 3 355 s et 6 012 s, 0 `interrupted`), ✅ **T28 prouvé** (15/09 = 222/222/192/0/0 au mot près), ✅ T40 · T42 · T45 · T65 · T67 · T69 prouvés. 📏 [TRK-078](#trk-078) : 0 doublon / 12 ; rectification — c'est la pointe **au plafond** (130 pile), pas `absolu`, qui n'a pas d'instant. 🔴 **VPS-016 nº 6 : 36 h 37, `dockerd` 91,7 %** — V33 toujours à faire)* · *Précédent (17/09 03:30) :* *(🟢 **PREMIÈRE NUIT PROBANTE DU CHANTIER COUPE-CIRCUIT** (`87ae29c9` / T69 déployé le 16/09 05:24) : preuve de **21:30 Paris** partie et remise en 6 s, **0 refus d'interlock**, **28 coupes** (4 MH Cars 20:00, 24 CDEF31 22:00) dont 27 acquittées en 0,4–5,4 s et **1 par SMS prouvée de bout en bout** (HM-733-GA, 83 s), 4 reprises MH Cars ≤ 4,1 s — T65 : 5 OK / 2 non exercés. 🆕 [TRK-083](#trk-083) **gravité 2** : le guetteur d'ACK TCP est armé APRÈS deux écritures en base — GR-898-HY a répondu `jt` 0,9 s avant → `SENT_UNCONFIRMED` pour une coupe exécutée ; sur une RESTORE = SMS + `CRITICAL` + push à tort ; jumeaux `tracker-commands` / `tracker-fix-mode`. 🆕 [TRK-082](#trk-082) : la sentinelle « excès sans alerte » juge par `tripId` alors que T30 déduplique par excès — 3 trajets recréés accusés à tort. 📏 [TRK-078](#trk-078) : **2 paires de doublons sur 9** (FM-772-JH — `absolu` sans instant, pointe redécoupée à 79 s, trajets chevauchants). 📏 [TRK-016](#trk-016) / T28 : 15/09 = 222 contre 273 — journée encore dans la fenêtre de recalcul de 26 h ; `collecte.sql` gagne `fenetre_recalcul_close` (J+2) et **100 % recalé < 2 h depuis la création**. 🔴 VPS-016 nº 6 : `docker logs --tail 15 vizyo-auth-api` bloqué depuis le 16/09 12:41 (14 h 48), `dockerd` 92 % — V33. 📏 [TRK-069](#trk-069) : le poste dort la nuit, 2 agents manqués et jamais rattrapés, audit +138 min. ✅ T9 : les 3 déclarations HM-… levées à 08:33 par un humain)* · *Précédent (16/09 01:30) :* *(🟢 **LE CHANTIER COUPE-CIRCUIT EST EN PRODUCTION (`fa9ff1d1` 17:35, `0c9672c9` 18:14 UTC le 15/09), ET SA PREMIÈRE NUIT N'EST PAS PROBANTE : L'INTERLOCK A REFUSÉ LES 25 COUPES DE 22:00.** [TRK-066](#trk-066) : « dernière preuve de remise SMS trop ancienne (> 24 h) » — la dernière remise prouvée date du 14/09 07:00, la preuve manuelle du soir n'a pas été envoyée, la première preuve automatique (T45) tombe à 02:30 UTC ; **0 `CUT`, 0 `RESTORE`, 0 SMS**, 30 plannings restés `IN_WINDOW`. *Le garde-fou marche* — 🆕 **[TRK-081](#trk-081)** : **il le dit toutes les 15 min en `CRITICAL`** (20 lignes, ~36 attendues) et **fait partir un e-mail par heure** (5 reçus) : « à lire, pas à notifier », gravité 3, correctif sur `signalWithheldCut` seul, T68. **Section T65 lue pour la première fois** : ping S21 **OK** (60 s), sentinelle Android 1 épisode expliqué (S21 verrouillé 13:49 → 17:51, T55), interlock rouge par construction, RESTORE et TCP seul non exercés. ✅ **T67** : plus aucun rappel sur les 50 vieilles RESTORE depuis 18:06 (28 étaient dus). 📏 [TRK-016](#trk-016) : le 13/09 retrouvé **86 / 86 / 66 / 20 / 0** une 2ᵉ fois, **mais le 14/09 rend 259 contre 244** sans qu'un trajet soit né — la définition n'était pas versionnée : `collecte.sql` gagne `recalage_journees_closes` (journée civile de Paris sur `endedAt`), série repartie à 88 / 88 / 60 / 28 / 0. 📏 [TRK-078](#trk-078) : mardi = 5 excès, 5 alertes, 0 doublon. ✅ V28 mort : charge 0,55, passage de 00:45 en 3 min.)* · précédemment le **2026-09-15 01:45 UTC** *(🔴🔴 **LE COUPE-CIRCUIT A TOURNÉ HIER SOIR SUR L'ANCIEN CODE, ET LA MISE EN PRODUCTION DE 11:40 N'A PAS EU LIEU.** [TRK-066](#trk-066) : plannings CDEF31 réarmés par le client, **24 `CUT` `SCHEDULER` à 22:00 Paris, toutes acquittées par TCP en 1–5 s**, dont **deux véhicules déclarés « boîtier débranché »** ([TRK-053](#trk-053) : HM-733-GA rallumé à la main à 23:13 — *la déclaration retient les alarmes, pas le planificateur*) ; 22 `RESTORE` du matin à lire à 07:10 Paris. [TRK-077](#trk-077) : **la seconde lecture de la garde (T29) a retenu un vrai déploiement pour la première fois** — images construites à 11:47, passage de 11:45 → 12:44 en cours, aucune recréation, `leadDays` absent du conteneur — **et rien ne journalise un refus** pendant que `origin/main` dit « déployé sur prod » : 🆕 **T66**. 🆕 **[TRK-080](#trk-080)** : la sentinelle nº 9 parle pour la première fois — « tyger.bcn (TOUT coupé) » — sur un réglage écrit **hors application** pour un compte technique (T6) : *elle lit un réglage et en déduit une intention*, faux positif, gravité 4. ✅ [TRK-069](#trk-069) : le test daté est tombé à 01:50 et **les 13 `CRITICAL` d'agents se sont archivées seules à 04:50** — 4 `CRITICAL` restent, aucune neuve. ✅ [TRK-076](#trk-076) → **PROUVÉ PAR L'ÉCHÉANCE**, T27 FAIT. 📏 [TRK-016](#trk-016) : le 13/09 retrouvé **86 / 86 / 66 / 20 / 0**. 📏 [TRK-078](#trk-078) : lundi = 1 excès qualifié, 1 alerte, 0 doublon — détection saine, déduplication non exercée. 🔴 V28 : **44 h 38**, 7 passages > 45 min le 14/09.)* · précédemment le **2026-09-14 01:40 UTC** *(🎯 **PREMIER PASSAGE APRÈS LES HUIT DÉPLOIEMENTS DU 13/09, ET LA BAISSE VIENT DE CORRECTIFS QUI REFERMENT SEULS** — [TRK-074](#trk-074) : les 4 `CRITICAL` du 06/09 se sont archivées d'elles-mêmes à 13:35, après 165 h ; [TRK-062](#trk-062) : les 2 commandes SMS de 298 h portent `SENT_UNCONFIRMED` depuis le premier balayage de 20:30, et `commandes_en_attente` rend **0 ligne** pour la première fois ; T31 tient sur **cinq contrôles sans rechute** sur la condition exacte de `13471c53`. 🆕 **[TRK-079](#trk-079)** — la source `frontend-anon` parle pour la première fois : **deux robots EC2 à agent iPhone falsifié**, deux appels avortés par la fermeture de la page et rapportés en `keepalive` — *un `TypeError: Failed to fetch` qui dit « réseau » quand le fait est « page fermée »* : bruit. 📏 **[TRK-069](#trk-069)** : l'échec `SyntaxError` de `courrier-ia` (17:52) est **muet** au centre d'alerte parce que la clé de refroidissement (agent, motif) a été consommée à 02:50 par une autre cause — test daté à 03:50 UTC. 📏 **[TRK-053](#trk-053)** : les trois « Retour LLD » ont été **renommés** le 13/09 (HM-…-GA) **sans que la déclaration soit levée**. 🔴 **V28 : le client Docker du 13/09 04:34 tient toujours `dockerd` à 101 %, 20 h 47 après.**)* · précédemment le **2026-09-10 01:40 UTC** *(🎯 **LES TROIS TESTS DATÉS DE LA VEILLE SONT FRANCHIS** — [TRK-075](#trk-075) tient sur **33,3 h et 32 passages**, le rattrapage cartographique de [TRK-016](#trk-016) porte **+433 trajets**, et la sentinelle de vitesse de [TRK-064](#trk-064) a livré sa forme neuve **avec un jour d'avance, en se taisant sur la flotte qui n'avait rien à dire**. 🆕 **Le seul défaut neuf est [TRK-077](#trk-077)** : la garde qui doit empêcher de tuer un passage d'automatisation est **présente, correcte, et lue avant une construction plus longue que la fenêtre qu'elle protège** — elle protège de tout sauf du cas le plus probable. ⚠️ **Deux consignes datées de la veille étaient mal calibrées et sont RECTIFIÉES plutôt que déclarées satisfaites** : le « vivier sous horizon 4 → ~5 » supposait un débit constant sur une grandeur en paquets *(reporté au 17/09)*, et la mesure du rattrapage n'était comparable que sur `startedAt` — sur `createdAt` elle rend un dénominateur en hausse de 1 443 en un jour, donc impossible.)* · précédemment le **2026-09-09 01:55 UTC** *(🎯 **UNE PREUVE ÉCRITE D'AVANCE EST TOMBÉE AU MOT PRÈS** — [TRK-073](#trk-073) est **corrigé, déployé et PROUVÉ** : le 08/09 porte **24 passages d'automatisation sur 24, dont exactement 1 marqué `interrupted`**, là où le 06/09 en perdait huit sans laisser de trace. Et [TRK-075](#trk-075) **s'est tu** — 8 passages horaires sans une ligne, après une par passage sans exception. ⚠️ **Sa double condition était invérifiable telle qu'elle avait été écrite la veille : elle est REFORMULÉE, pas déclarée satisfaite.** 🔴 **Le seul chiffre qui ment ce jour est celui de [TRK-016](#trk-016)** : 0,0 % d'échec de recalage, **mais le 07/09 est passé de 85,5 % à 1,2 % pour les mêmes trajets** — le rattrapage réécrit le passé, `trips` n'a pas d'`updatedAt`, **et la série de dix points ne se prolonge pas**. *Une colonne de qualité réécrite rétroactivement et sans horodatage rend toute tendance indécidable.*)* *(historique — 🎯 **LES DEUX FOURNISSEURS IA SONT À SEC EN MÊME TEMPS** — le repli `claude → gpt` livré la veille au titre du chantier C3 a été exercé **six minutes après sa mise en ligne** et n'avait nulle part où aller : 🆕 [TRK-071](#trk-071). *Un mécanisme de secours ne vaut que par la ressource qu'il vise ; livrer une redondance sans provisionner sa cible, c'est livrer une ligne de journal.*)* *(🆕 **[TRK-070](#trk-070) — le correctif de [TRK-061](#trk-061) est contourné par la porte voisine** : l'escalade d'assistance ré-écrit en `ERROR`, **14 ms plus tard**, l'incident que la couche IA venait de classer `DEGRADATION`. La règle de niveau porte sur la **GRAVITÉ de la conversation** et jamais sur la **CAUSE** de l'escalade. Mesuré des deux côtés du déploiement : `ERROR`+`ERROR` à 12:23, `DEGRADATION`+`ERROR` à 17:00 — **le correctif a supprimé la moitié du bruit, pas la totalité**)* *(🆕 **[TRK-072](#trk-072)** — la sentinelle « destinataire saturé » parle pour la première fois : **15 notifications en 24 h dont 14 `OVERSPEED`** sur 2 super-admins, pour un produit calibré sur 2 à 3. *Elle a crié AVANT que le destinataire ne coupe ses notifications — et couper ses notifications lui ferait perdre jusqu'au SOS*)* *(📈 **[TRK-069](#trk-069) A PARLÉ AU PREMIER MATIN SANS POSTE : 0 → 3 occurrences**, trois motifs distincts et aucune redondance — **48 h gagnées** sur un raisonnement en « 2 × cadence ». ⚠️ Les `CRITICAL` passent de 2 à 5 **par l'arrivée d'un capteur**, pas par dégradation)* *(⚠️ **PIÈGE DE FUSEAU** : `git log` est en heure de **Paris**, la base en **UTC** — une ligne de 12:23 UTC suivant un commit de 14:17 Paris (= 12:17 UTC) révèle un **déploiement intermédiaire** que `StartedAt` seul ne montre pas. *Comparer un journal git à une table sans convertir les fuseaux fabrique de fausses impossibilités.*)* *(📏 **[TRK-016](#trk-016) 4ᵉ point : 87,9 %** — la baisse d'hier à 83,3 % était bien une fluctuation, et **la réserve écrite hier vient de s'auto-vérifier**)* · **précédemment, le **2026-09-05 01:40 UTC** *(🎯 **UN DÉPLOIEMENT NON ANNONCÉ, le 04/09 à 17:01:33**, a mis en ligne **six correctifs d'un coup** — les six marqueurs vérifiés un par un sur l'**ARTEFACT SERVI**, et `SENT_UNCONFIRMED` confirmé ABSENT, donc [TRK-062](#trk-062) attend bien sa migration)* *(✅ **[TRK-061](#trk-061) PROUVÉ PAR LA DOUBLE CONDITION** à 00:00:35 : `DEGRADATION`, message qui **nomme l'action**, motif du fournisseur au contexte, et **UNE seule ligne** là où le 03/09 en produisait deux — *le compteur `ERROR` est tombé sans que le total de la famille bouge*)* *(✅ **[TRK-059](#trk-059) PROUVÉ** — les motifs de clôture citent la cible **DEMANDÉE**, et ceux qui suivent un échec **nomment** le défaut au lieu de le masquer)* *(🆕 **[TRK-067](#trk-067) née et close le même jour** — 10 lignes, la source la plus bruyante des 24 h ; **le coût n'était PAS le bruit** : le journal étant fire-and-forget, le recalcul réussissait, mais **aucun recalcul automatique ne laissait de trace**. Double condition vérifiée : **0** ligne depuis le déploiement **ET 30** traces machine écrites)* *(🆕 **[TRK-068](#trk-068)** — `fetch failed` sur `/api/auth/refresh` en `CRITICAL` : **troisième récidive** du message brut de TRK-060 et TRK-066, sur une troisième chaîne. *Aucun appel sortant de ce dépôt n'a de gabarit de message d'échec*)* *(🎯 **[TRK-064](#trk-064) : le sujet a changé** — les alertes de vitesse sont **armées sur 2 sociétés sur 5**, et la chaîne V5 écrit ses **12 premières `OVERSPEED` nées d'un trajet**)* *(🧹 **[TRK-052](#trk-052) : le critère de vérification accusait la MAUVAISE chaîne** — 3 paires désignées, 0 régression ; les alertes nées d'un trajet ne passent jamais par la fenêtre corrigée. *La lecture du code a empêché ce rapport d'annoncer une régression inexistante.*)* *(🔎 **PREMIER CONSTAT DE DISPARITION JAMAIS RENDU** — un humain, en socket locale, 4 alertes de trajet ; **ce n'est pas l'effaceur de [TRK-035](#trk-035)**. *Posé le 21/08 et muet quinze jours, le témoin a rendu au premier effacement réel l'heure, le rôle, l'origine, le PID, la requête et les bornes.*)* · **précédemment, le **2026-09-04 01:40 UTC** *(🆕 **[TRK-063](#trk-063)** — **une plaque avec un point médian fait tomber TOUS les téléchargements du véhicule** : premier `CRITICAL` depuis le 22/08, trouvé **par la recette** 1 min 44 après le redémarrage. `speed-report.service.ts:173` bâtit le nom du fichier sur la PLAQUE et ne retire que les espaces ; Node refuse tout caractère hors Latin-1 dans un en-tête. **2 véhicules sur 44** — `GLA•KC•31`, `KSR•370` — avaient **les 5 exports en 500 depuis toujours**. ⚠️ Le correctif `ab6c9701` est commité **neuf minutes après** la construction de l'image : **écrit, et sans effet**, vérifié sur l'artefact servi)* *(🆕 **[TRK-064](#trk-064)** — **la chaîne d'alerte de vitesse est déployée et activée NULLE PART** : 0 flotte sur 5, 0 véhicule sur 44, pendant que **145 analyses fraîches portent un excès**. La sentinelle censée le voir sort sur `if (flottes.length === 0) return []` — *elle se tait pour exactement la même raison que la chaîne*)* *(🆕 **[TRK-065](#trk-065)** — **première ligne jamais écrite par les sentinelles V6**, 72 s après le démarrage, et elle avait raison : **42 notifications perdues sur 129**, dont **21 pour un compte technique** qui n'aura jamais d'appareil)* *(🔴 **[TRK-061](#trk-061) RÉCIDIVE, 2ᵉ jour et 2ᵉ chemin** — `agenda_agent` est tombé à son tour ; **compte à sec depuis 25 h**, et « Coûts IA » n'a toujours rien vu)* *(🎯 **Les 7 lots déployés cette nuit n'ont RIEN exercé** — 0 analyse de trajet depuis la bascule ; 4 des 6 sentinelles sont muettes **par calendrier**, pas par bonne santé. Le dire avant de juger)* *(✅ **La réserve du 03/09 est LEVÉE** — les 37 h sans alerte étaient bien un parc calme : 4 types écrits le 03/09. *Une réserve honnête se résout d'elle-même au passage suivant.*)* *(🟢 **[TRK-050](#trk-050) : premier signal positif en 10 j** — 5 sessions vues avant le redémarrage, **0 fermée**, 1 902 `ACTIVE` intactes)* · **précédemment, le **2026-09-03 01:20 UTC** *(🆕 **[TRK-061](#trk-061)** — **le compte du fournisseur IA est à sec, et le dispositif dit « appel malformé »** : Anthropic facture l'épuisement d'un compte en **HTTP 400**, la ligne tombe donc dans le cas commenté « vraie faute d'appel ». **Première occurrence en 90 j.** ⚠️ le message de facturation, en anglais, est **servi à l'utilisateur sur son iPhone** ; ⚠️ **un incident, deux lignes** ; 🔑 **l'écran « Coûts IA » est aveugle** — `ok_24h = 291`, `ko_24h = 0` pendant l'échec, car un appel raté n'écrit rien. 🟢 portée étroite : les 290 appels de flotte tournent en `executor = local` et sont indemnes)* *(🆕 **[TRK-062](#trk-062)** — **une commande partie en SMS n'a aucun état terminal** : conséquence du succès de TRK-021, `SENT` depuis 39 h. Le refus de guetter un accusé est JUSTE (réponse réelle à ~4 h) ; **ce qui manque est une borne SUPÉRIEURE**. Jumeau exact de [TRK-007](#trk-007), réintroduit par un chemin neuf)* *(✅ **[TRK-021](#trk-021) RÉPONDU après 17 jours** — 2 commandes SMS-only parties en `channel = SMS`, contre 6 sur 6 en `TCP`+`FAILED` avant)* *(⚠️ **[TRK-050](#trk-050) : l'occasion est VENUE et n'a rien prouvé** — l'API a redémarré le 02/09 à 21:04:58, mais **0 session active dans l'heure précédente**. *Un test qui ne peut pas échouer ne réussit pas.*)* *(♻️ **[TRK-022](#trk-022) REQUALIFIÉ** — répondu par le comportement : 6 intervalles successifs avec un **plancher net à 6,16 h**, signature d'une fenêtre de 6 h)* *(🎯 **Cadence : trois points comparables** — 0/0/0 sous le minimum matériel ; TRK-057 et TRK-008 tiennent. ⚠️ Le total `fix_continuous` baisse de 514 à 491 et **ce n'est pas une amélioration** : la flotte émettrice est passée de 38 à 32)* · **précédemment, le **2026-09-02 01:25 UTC** *(🆕 **[TRK-059](#trk-059)** — **la « cible atteinte » qui suit un échec porte une AUTRE cible** : sur 7 jours, **46 paires « échec puis réussite » en moins de 30 min, et 46 sur 46 ont vu la cible changer**, délai moyen 6,6 min. La cadence réelle est le MÊME nombre des deux côtés — le boîtier n’a pas bougé, c’est la demande qui est descendue jusqu’à lui)* *(🆕 **[TRK-060](#trk-060)** — `system-metrics` rend `EAI_AGAIN` brut ; incident bénin **mesuré** (1 437 points sur 1 440 en 24 h), défaut réel = le message, qui envoie instruire une panne de base inexistante)* *(✅ **Les correctifs du 01/09 tiennent, mesurés à J+1 indépendamment** : [TRK-057](#trk-057) **44 cibles / 44 canoniques** ; [TRK-056](#trk-056) **32 boîtiers sur 32 à mesure fraîche exactement sur leur cible**, les 6 écarts résiduels portant tous une mesure PÉRIMÉE de boîtier hors service ; [TRK-021](#trk-021) 2ᵉ commande SMS-only partie en `channel = SMS`)* *(⚠️ **[TRK-053](#trk-053) et [TRK-052](#trk-052) restent NON EXERCÉS — par absence d’OCCASION, pas par réussite** : une seule alerte écrite depuis le correctif de 09:17, sur un véhicule EN SERVICE, et les 9 boîtiers hors service sont muets. *Un correctif qui fait taire des boîtiers déjà silencieux ne prouve rien.*)* *(🔴 **Trois tests dépassent 7 jours** : [TRK-022](#trk-022) **14 j**, [TRK-032](#trk-032) **11 j**, [TRK-051](#trk-051) **7 j** — à PROVOQUER ou REQUALIFIER, pas à laisser vieillir un passage de plus)* · **précédemment, le **2026-09-01 07:56 UTC** *(🔵 **Le fait du jour n'est pas dans `error_logs`** : le **31/08 entre 07:29 et 09:00 UTC, six véhicules ont perdu leur alimentation externe** ; leur batterie interne est tombée à **0 %** et **les six boîtiers sont muets depuis 18 h** — la flotte émettrice est passée de **38 à 32**. Action TERRAIN, toujours en cours)* *(🆕 **[TRK-052](#trk-052)** — **acquitter une alerte RÉ-ARME l'alarme** : le prédicat de déduplication porte `acknowledgedAt: null`, corrélation **2 doublons sur 2** le 31/08, dont un acquitté **19 s** après sa création. C'est le mécanisme qui ramènerait le déluge de 1 317 alertes de TRK-022)* *(✅ **3 tests datés RÉPONDUS OUI** : [TRK-037](#trk-037) — 22 lignes `DEGRADATION` / **0 `ERROR`** depuis le déploiement ; [TRK-022](#trk-022) volet 1 — **1 317 → 1-2 par jour**, intervalles toujours ≥ 6 h 10 ; [TRK-040](#trk-040) — **exercé six fois, 0 faux positif**, les 6 coupures confirmées par la pente ont fini à 0 % de batterie)* *(🔴 **[TRK-021](#trk-021) : 17 jours sans le moindre essai** — les 8 dernières tentatives SMS-only sont toutes antérieures au correctif et toutes parties en `channel = TCP`. La règle des 7 jours est dépassée de dix)* *(⚠️ **Un filtre qui exige « vivant » rend zéro sur un mort** : `gps_sans_fix` rend **0 ligne** parce que les six véhicules perdus n'émettent plus du tout. Vérifier ce qu'un filtre EXCLUT avant de lire son zéro)* · **précédemment, le 2026-08-26 à 01:15 UTC :** *(🆕 **[TRK-051](#trk-051)** — le statut `ACKNOWLEDGED` n'a jamais voulu dire « acquitté par le boîtier » : **120 sur 7 j, 2 seulement portent une vraie réponse matérielle**. Corollaire : le « métronome de 72 échecs/jour » rapporté depuis dix jours était un **artefact d'étiquetage** — le TOTAL `fix_continuous` est resté plat à 69-79/j pendant que `FAILED` tombait de 72 à 15. `collecte.sql` durci le jour même)* *(✅ **[TRK-046](#trk-046) PROUVÉ par la DOUBLE CONDITION** : 31 coupes exécutées ce soir, **0 refus sur vitesse périmée depuis le 25/08 04:37** — un seul compteur est tombé)* *(⚠️ **3 tests datés sur 5 sans réponse, aucun par échec d'un correctif** : `OFF_SCHEDULE_MOVEMENT` sans occasion, TRK-050 sans redémarrage d'API, **TRK-021 jamais tenté depuis 11 jours**)* · **précédemment, le 2026-08-25 à 20:05 UTC :** *(✅ **[TRK-046](#trk-046) EXERCÉ ET PROUVÉ** à la coupe de 20:00 — preuve directe au journal, 0 refus là où il y en avait 13 la veille à la même heure)* *(🧹 **RÉCONCILIATION DES STATUTS** — 18 en-têtes de fiche étaient restés figés à leur rédaction initiale ; index et manifeste, eux, concordaient. Les trois surfaces sont désormais alignées : **40 corrigées, 5 correctifs proposés, 3 terrain, 2 non corrigées**. Tranché par le CODE DÉPLOYÉ et la MESURE, jamais par une autre fiche)* *(🟢 [TRK-050](#trk-050) CORRIGÉ, TESTÉ ET DÉPLOYÉ — la déconnexion au redéploiement est instruite : le garde existe depuis le 03/08, il n'est branché que sur le chemin HTTP)* · *(déploiement)* *(les 3 PR FUSIONNÉES et DÉPLOYÉES à 09:22 UTC, marqueurs vérifiés sur l'artefact servi ; 🆕 [TRK-049](#trk-049) trouvée en vérifiant le cumul — un cron invisible depuis le 24/08)* · *(après-midi : passe de correction — PR #133/#134/#135 ouvertes pour TRK-046/048/047, statuts 🟠 CORRECTIF PROPOSÉ ; volet volume de TRK-035 instruit : la fenêtre de 3-4 jours vient du logrotate HÔTE, pas du volume)* · *(matin : audit quotidien — contrôle des 7 correctifs du 24/08 ;
...
|---|---|---|---|---|---|
| [TRK-092](#trk-092) | `email` / `sims-sync` / `positions` / `wire-logger` | **Cinq messages de transport bruts pendant l'étranglement du VPS et le reboot** — `Unable to fetch data. The request could not be resolved.` (×2, e-mails `error_rate_alert` renvoyés 10 min après), `WhereverSIM injoignable : fetch failed`, `Invalid prisma.… getaddrinfo EAI_AGAIN tracky-postgres` (×2, reboot V4 16:17) | ⚪ **BRUIT** · **gravité 4** · famille **brut** *(20/09 03:10 → 16:17, VPS-045 puis V4 ; aucune conséquence mesurée ; 4ᵉ et 5ᵉ récidive du motif de [TRK-060](#trk-060) / [TRK-066](#trk-066) / [TRK-068](#trk-068) — la traduction réseau n'existe que dans `metrics-collector.service.ts:32`. Correctif : un gabarit commun pour tout appel sortant)* | 2026-09-20 | 2026-09-20 |
| [TRK-091](#trk-091) | `engine-control-restore` | **Le worker RESTORE ré-émet une commande dont le dispatch en ligne est encore en vol, et écrit « en erreur — intention conservée » sur une remise acquittée** — `Worker RESTORE en erreur — intention conservée pour reprise`, contexte `Unique constraint failed on the fields: ("commandId","attemptNumber")`, `lastError` Prisma brut sur la commande | 🟠 **CORRECTIF PROPOSÉ** · **gravité 3** · famille **course** *(6 commandes le 20/09 — EY-613-MF 03:00 et 5 CDEF31 05:02:59 → 05:05:44 —, 4 lignes (+1 fondue, TRK-085), **les 6 `ACKNOWLEDGED` par TCP 6 à 17 s après leur création**. `createCommand` (:1131) crée `PENDING`, `nextAttemptAt: now`, **sans bail**, et dispatche en ligne ; le worker de 15 s (:2199) prend la commande encore `PENDING` (3–4 s de latence base à 89 % de steal), écrit **une seconde trame `K;`** (:1808, avant la ligne d'attempt :1951), puis échoue sur le numéro `attemptCount + 1` lu en mémoire (:1770). La contrainte (T53) a bloqué le doublon de ligne. Correctif : bail posé à la création, numéro lu en base, ligne d'attempt puis guetteur puis trame (= T71), `P2002` = `warn`, pas `CRITICAL`. 👉 **T78**)* | 2026-09-20 | 2026-09-20 |
| [TRK-090](#trk-090) | `sms-daily-proof` | **La preuve SMS quotidienne est déclarée « cassée » alors que le téléphone l'a reçue 38 s après** — `Preuve SMS quotidienne REFUSEE a la soumission … la passerelle a rejete le message` (`phase: submit`, `error: The operation was aborted due to timeout`) puis `Preuve SMS quotidienne en ECHEC : 1 message(s) refuse(s) sur 1 — la chaine SMS est cassee` (`phase: verify`, **`echo: 0`**) | 🟠 **CORRECTIF PROPOSÉ** · **gravité 2** · famille **mensonger** *(2 fois le 20/09 — 02:30 et 04:30 UTC, VM à 10 % de CPU : le POST au relais dépasse `AbortSignal.timeout(10_000)` (`sms-gateway.service.ts:967`), le sortant est écrit `failed`, **et le corps exact revient en entrant à 02:30:49 (×3) et 04:30:46 (×2)**. `verifyHeartbeat` (`sms-heartbeat.service.ts:413`) ne rapproche l'écho que d'un sortant `accepted` → `failed > 0` → **ECHEC**, 4 `CRITICAL`, e-mail, 2 pushs `preuve-sms` « ECHEC ». Un sortant `failed` n'est pas une remise terminale : à 18:00 l'interlock tenait sur **un SMS de secours payant** (05:02:57) — sans lui, 26 coupes retenues sur une chaîne qui livrait. Correctif : délai client = `queued` (issue inconnue), pas `failed` ; écho rapproché quel que soit le statut ; ligne « REFUSEE » archivée à la remise. ⚠️ Question ouverte côté relais : 3 échos pour 1 preuve, 17 « Resume engine Succeed » pour 3 `resume`. 👉 **T77**)* | 2026-09-20 | 2026-09-20 |
| [TRK-089](#trk-089) | `sms-gateway-watchdog` / `sms-daily-proof` | **La sentinelle du téléphone crie toutes les 16 min, et la preuve remise en retard ne referme jamais son verdict** — nuit du 18 au 19/09 : S21 hors ligne **2 h 22** (02:23:55 → 04:46 UTC), **9 `CRITICAL` watchdog** (une par balayage, 3 e-mails), **0 ligne de retour** ; preuves de 02:30 et 04:30 en file → 2 `ERROR` « INDETERMINEE … l'interlock refusera les coupes de ce soir » — **remises à 04:46:41 / 04:46:53** avec écho, interlock vert, **30 coupes parties le soir** — et rien ne l'écrit : à 07:00 Paris l'écran annonce encore une soirée menacée | 🟠 **CORRECTIF PROPOSÉ** · **gravité 3** · famille **à lire, pas à notifier** *(motif de [TRK-081](#trk-081) sur une 2ᵉ source ; verdict de preuve définitif à +15 min, jamais relu quand le relais pousse `delivered` ; T69 (3) et (4) ont bien poussé. Correctif : 1 `CRITICAL` + rappels `DEGRADATION` horaires + ligne de sortie qui archive ; 1 ligne « preuve finalement remise » qui archive l'INDETERMINEE. 👉 **T76** · 📏 **21/09 — 2ᵉ ÉPISODE, CAUSE SERVEUR** : le 20/09 de 01:53 à 11:46, **8 `CRITICAL`** « Passerelle SMS indisponible : The operation was aborted due to timeout » (`reachable: false`, `androidState: null`) — ce n'est pas le S21 (ping 60 s toute la nuit), c'est l'appel de santé du relais qui expire en 5 s sur une VM à 10 % de CPU (VPS-045) ; l'incident se referme (3 ticks sains) et se rouvre à chaque expiration → **une `CRITICAL` et un push par réouverture** (7 pushs `passerelle-sms`, 3 e-mails, « admin@ 15 notifications dont 6 passerelle-sms »), **0 ligne de sortie** (le retour n'est qu'un `logger.log`). (d) **le motif est brut** — `health.error` recopié tel quel : dire « relais SMS sans réponse en 5 s » et la conséquence. 18 `CRITICAL` actives)* | 2026-09-19 | 2026-09-20 |
| [TRK-088](#trk-088) | `sms-gateway-status` | **La source parle pour la première fois : le relais pousse un `failed`, Tracky l'écrit en `CRITICAL`** — `SMS en échec terminal (failed)`, `RESULT_ERROR_GENERIC_FAILURE` | 🔵 **TERRAIN** *(le fait est T61 — les 2 SIM injoignables ; la forme est TRK-085)* · **gravité 3** *(4 lignes pour 6 échecs le 17/09 05:53 → 06:01 : 3 `resume123456` vers BP-434-RD, 3 vers HD-584-BF, pendant les 24 reprises de l'incident ; trois échecs → verdict « injoignable » → **T62 exercé** (2 lignes `engine-control-tcp-only` à 20:00). Message sans véhicule ni conséquence ; ne pas archiver)* | 2026-09-17 | 2026-09-17 |
| [TRK-087](#trk-087) | `http` | **Variable `MANAGER_INTERNAL_URL` absente du conteneur neuf à la première recette du lot A** — 503 « La création directe dans Vizyo Manager n'est pas configurée sur ce serveur (MANAGER_INTERNAL_URL)… » | ⚪ **BRUIT — close le jour même** · **gravité 4** *(1 occurrence, 17/09 07:11:41, 51 s après le déploiement de `092a740d`, `userAgent: node` = la recette ; message exemplaire — nomme la variable et le geste ; variable présente sur le conteneur de 15:37, recette de 13:43 passée)* | 2026-09-17 | 2026-09-17 |
| [TRK-086](#trk-086) | `TRIP_AUTOMATION` | **Le recalcul horaire crie chaque heure sur un véhicule sans fix depuis > 26 h : le trajet brut qui déclenche la tranche est hors de la tranche, donc jamais figé** — `Recalcul impossible sur <PLAQUE> : aucune position entre <DATE> et <DATE>, alors que des trajets bruts y subsistent…`, une par passage | 🟠 **CORRECTIF PROPOSÉ** · **gravité 3** · famille **à lire, pas à notifier** *(8 occurrences 17/09 18:29 → 18/09 00:45, toutes HM-769-GA — vivant, 878 `no_fix` en 24 h, sans position depuis le 16/09 15:28. 35 trajets bruts des 31/08 et 11/09 ; `dirty` cherché depuis `plancherRattrapage` (60 j) mais tranche bornée à `windowFrom` (ligne 883) → fenêtre vide → alerte ; le gel `fige-sans-positions` cible `startedAt ∈ [fromMs, toMs]` : le trajet du 31/08 n'y est pas, rien n'est figé, rebelote au passage suivant. Candidats : HM-733-GA (65 bruts), HM-779-GA (39). Correctif : sur le chemin horaire, `dirty` depuis `windowFrom − backoff` (le reste est au rattrapage) et se taire quand `lastPositionAt < windowFrom` (déjà dit par `gps-integrity`). Double condition : la ligne part toujours pour un vrai trou encadré. 👉 **T74**)* | 2026-09-17 | 2026-09-18 |
| [TRK-085](#trk-085) | *outillage* / `error-logger` | **L'anti-flood du centre d'alerte fond des véhicules distincts en une ligne, et perd les autres** — `engine-control-restore` « RESTORE non confirmé depuis plus de 60 s » et `sms-gateway-status` « SMS en échec terminal (failed) » : plaque et IMEI dans le contexte, pas dans le message | 🔴 **NON CORRIGÉ** · **gravité 2** · famille **angle mort** *(17/09 05:58 : `alertOverdueRestores()` a trouvé **7** RESTORE non prouvées, posé `alertedAt` sur 7, poussé **14 notifications** `restore-non-prouvee` — **1 ligne** `error_logs` (BP-434-RD) ; 6 SMS refusés → 4 lignes. `ErrorLogger.record()` déduplique sur `source|level|message[0:140]` pendant 60 s et ne reporte le compteur qu'à la prochaine écriture de la même empreinte — jamais venue : **6 perdues sans trace**. Le téléphone en savait plus que l'écran. Correctif : la plaque dans le message des témoins par véhicule ; ne jamais perdre le compteur (`UPDATE` de la ligne écrite). Double condition : un cron qui échoue toutes les 30 s produit toujours une ligne par minute. 👉 **T73** · 📏 **21/09** : « Worker RESTORE en erreur » **5 commandes → 4 lignes** (HD-584-BF fondue dans HD-603-XY, `repeatedSuppressed: 1`), sans plaque ; `http` 05:15 `repeatedSuppressed: 1`)* | 2026-09-17 | 2026-09-20 |
| [TRK-084](#trk-084) | *(angle mort — aucune ligne)* | **Une API à terre n'écrit pas qu'elle est à terre, et le retard d'une reprise n'existe nulle part** — 24 `RESTORE` CDEF31 dues à 05:00 UTC nées à 05:53 (`scheduledAt` NULL), 24 véhicules immobilisés 53 à 67 min après 07:00 Paris, **0 ligne** | 🔴 **NON CORRIGÉ** · **gravité 1** · famille **angle mort** *(incident du 17/09 — doc 31 : migration du lot A en double, API en boucle de redémarrage 04:56:35 → 05:52:37. Le passage d'automatisation de 05:45 **n'existe pas** (23/24) sans ligne ; les 24 reprises naissent à la reprise de l'API, 24 × « Socket TCP absente au premier dispatch » → 20 SMS + 4 TCP, **29/29 acquittées à 06:08** ; T51 compte depuis `createdAt` donc un retard de 53 min acquitté en 38 s est une reprise parfaite ; le propriétaire l'a appris par le client. Le centre d'alerte porte 6 lignes, toutes sur les 2 SIM injoignables. **Et 6 RESTORE en double** (06:02, 06:12, 15:57) pour des véhicules déjà acquittés — 1 SMS payé pour rien ; `relancer-restore.js` (doc 31, 06:03) à lire. Correctif : `scheduledAt` = ouverture de plage, une ligne `CRITICAL` au démarrage « N reprises émises avec M min de retard », un témoin de l'API HORS de l'API (relais / healthcheck → SMS), le tick sauté écrit par le heartbeat. Double condition : les reprises toujours émises au premier tick. 👉 **T72**)* | 2026-09-17 | 2026-09-19 |
| [TRK-083](#trk-083) | *commandes* / `engine-control` | **Le guetteur d'ACK TCP est armé APRÈS deux écritures en base — un boîtier qui répond plus vite que la base est déclaré « non confirmé »** : `SENT_UNCONFIRMED` + `engine_delivery_attempts` `TIMED_OUT` « ACK timeout after 15000ms », alors que `wire_logs` porte le `jt`/`kt` du boîtier dans les secondes qui suivent l'`OUT` — aucune ligne au centre d'alerte | 🟠 **CORRECTIF PROPOSÉ** · **gravité 2** · famille **course** *(1 occurrence mesurée, GR-898-HY le 16/09 20:01:30 — coupe CDEF31 de 22:00 Paris. Chronologie : socket écrite ≈ 20:01:31 (`sessionRegistry.send`, ligne 1808, AVANT toute écriture base) → `beginAttempt` persisté 20:01:33,128 (+2,4 s) → **`jt` du boîtier 20:01:38,339** → `writeSent`/`sentAt` 20:01:39,251 (+6,1 s) → **`waitForAck` armé ≥ 20:01:39,3** (ligne 1985) → `TIMED_OUT` 20:01:54 → `SENT_UNCONFIRMED` 20:40. `AckWaiterService` n'a aucune mémoire des trames arrivées avant l'inscription. Les 27 autres coupes : +5 à +90 ms sur les mêmes écritures, ACK en 0,4–5,4 s. Le véhicule EST coupé (69 positions, vitesse 0, contact coupé jusqu'à 03:23). 🔴 **Sur une RESTORE, la même course planifie le secours SMS** (`catch` ligne 2038) : un SMS payant, une `CRITICAL` `engine-control-restore` (T51) et une notification push (T69) pour une remise en route réussie. **Jumeaux** : `tracker-commands.service.ts:328-360`, `tracker-fix-mode.service.ts:287` — cause plausible d'une part du « 0 `ackedAt` sur 4 823 » de TRK-014. Correctif : armer `waitForAck()` AVANT `sessionRegistry.send()` (l'annuler si `send` rend `false`), ou mémoire de 30 s par IMEI dans l'ack-waiter ; journaliser la latence `beginAttempt → writeSent` > 1 s. Double condition : un boîtier muet doit toujours tomber en `TIMED_OUT`. 👉 **T71** · 📏 **18/09** : **0 `SENT_UNCONFIRMED`** en 24 h — 28 CUT de la nuit 17→18 acquittées en 0,4–5,1 s, écritures base à 5–90 ms ; non exercé, le risque reste entier tant que V33 tient un cœur · 🔴 **21/09 — EXERCÉ 3 FOIS EN 24 H, DONT 1 SANS CHARGE** : (1) EP-047-TY RESTORE 03:03:39 — `kt` à 03:03:44,9, guetteur armé à 03:03:47,3 (+3,9 s de base) → TIMED_OUT → **SMS payé** 03:05:39 → `CRITICAL` « non confirmé » + push → ACK 158 s ; (2) AL-927-QM RESTORE 05:00:48 — `kt` à 05:00:54,907, **5 ms avant le journal de la trame OUT** → TIMED_OUT → ACK tardif 05:01:24 → **SMS payé quand même 05:01:31, 7 s APRÈS l'ACK** (`dispatchSmsAttempt` ne relit pas `ackedAt`) ; (3) **EP-047-TY CUT 18:00:02, steal 1 %** — `jt` 18:00:02,277, trame journalisée 18:00:02,320, `sentAt` 18:00:02,317 (+300 ms) → `SENT_UNCONFIRMED` à 18:40 pour une coupe exécutée (71 positions à 0 km/h). *300 ms de latence base suffisent : la charge n'est pas la condition.* FR-428-DQ : SMS à −0,9 s de l'ACK. Complément à T71 : relire `ackedAt` juste avant `trySmsFallback`, annuler au relais (T41) si l'ACK arrive pendant la soumission)* | 2026-09-17 | 2026-09-20 |
| [TRK-082](#trk-082) | `sentinelles` | **La sentinelle « excès sans alerte » ignore la déduplication par excès (T30)** — `<N> trajets de « <SOCIÉTÉ> » ont un excès qui aurait dû produire une alerte, et n'en a pas. Les alertes de vitesse sont pourtant actives…`, pour des trajets recréés par le recalcul dont l'excès a bien alerté **sur le trajet jumeau** | ⚪ **BRUIT — faux positif · CORRECTIF PROPOSÉ** · **gravité 3** · famille **mensonger** *(1 occurrence, 16/09 06:30:01, mh cars, 3 trajets — **première parole de cette sentinelle pour une société armée**. Les 3 trajets sont de FV-941-LZ le 15/09, tous recréés à :45:00 par l'automatisation APRÈS l'alerte : `f5fcd5f8` (05:10→05:52, créé 06:45) ↔ alerte 05:49 `startAt` 05:22:37 ; `efa359bc` (06:19→06:59, créé 07:45) ↔ 06:47 / 06:32:37 ; `d3566589` (15:21→16:00, créé 16:45) ↔ 15:51 / 15:25:57. `createSpeedingAlert` a retrouvé le doublon par `memeExces` et n'a pas ré-alerté — c'est T30 qui marche ; mais `sentinelles-coherence.service.ts:499-506` juge « alerté » par `alert.tripId = analyse.tripId`. 🔑 T30 a changé la clé d'identité de l'alerte (du trajet à l'excès), l'instrument qui contrôle la chaîne lit encore l'ancienne. Correctif : « alerté » = une alerte `OVERSPEED` du même véhicule dont `payload.startAt`/`endAt` recouvre l'instant (`memeExces`, le paquet partagé) ou dont la fenêtre de trajet chevauche. Double condition : silence sur ces 3 trajets ET la sentinelle parle encore pour un excès sans AUCUNE alerte du véhicule. 👉 **T70**)* | 2026-09-16 | 2026-09-18 |
| [TRK-081](#trk-081) | `engine-control-interlock` | **L'interlock refuse toute la nuit et le dit toutes les 15 min en `CRITICAL`** — `CUT automatique bloquée : capacité de RESTORE non démontrée (<RAISON>) : <N> refus depuis la dernière ligne — véhicules : <PLAQUES>`, une ligne par quart d'heure pour une cause qui ne peut pas changer avant la preuve de 02:30, et un e-mail du veilleur par heure | 🟠 **CORRECTIF PROPOSÉ** · **gravité 3** · famille **à lire, pas à notifier** *(20 occurrences, 15/09 20:00 → 16/09 01:09, première nuit du chantier en production ; **le refus est juste** — dernière remise prouvée 14/09 07:00, preuve manuelle du soir non envoyée — **c'est le rythme et le niveau qui ne le sont pas** : `signalWithheldCut` écrit `CRITICAL` à chaque quart d'heure, le cron ramène les 24 véhicules toutes les 30 min, 5 e-mails « erreurs critiques ». Correctif : 1ʳᵉ ligne `CRITICAL`, rappels `DEGRADATION` horaires, ligne de clôture, réouverture `CRITICAL` si la raison change — **sans toucher à la garde**. T68 · 📏 **17/09** : **25 lignes** au total sur la nuit 15→16 (20:00:00 → 02:24:20, une par quart d'heure ; la 26ᵉ, prévue vers 02:39, n'a pas eu lieu : la preuve de 02:30 a rendu l'interlock vert), **7 e-mails** du veilleur (20:10 → 02:50) ; nuit 16→17 : **0 ligne** — le correctif de forme n'a pas d'occasion tant que l'interlock est vert)* | 2026-09-16 | 2026-09-19 |
| [TRK-080](#trk-080) | `sentinelles` | **La sentinelle nº 9 lit un réglage et en déduit une intention** — `<N> compte(s) ont RÉDUIT leurs notifications … : <EMAIL> (TOUT coupé)`, écrit pour un compte technique dont le réglage a été posé **hors application** (T6) | ⚪ **BRUIT — faux positif d'intention · CORRECTIF PROPOSÉ** · **gravité 4** · famille **faux positif** *(1 occurrence, 14/09 06:30 : première ligne jamais écrite par `notificationsCoupees()`. La ligne `notification_preferences` de tyger.bcn est née le 13/09 à 20:15:02, `pushEnabled = false` ; **aucune mutation HTTP** dans `system_activity_logs` à cette heure, et la seule route qui écrit la table est réservée au titulaire — réglage administratif, décision T6 de la veille. Correctif : `updatedById` + trois phrases, `ERROR` seulement quand le titulaire coupe lui-même)* | 2026-09-14 | 2026-09-14 |
| [TRK-079](#trk-079) | `frontend-anon` | **Deux appels avortés par la fermeture de la page sont rapportés comme des pannes de réseau** — `[demo-mode:charger] TypeError: Failed to fetch` + `[uncaught] TypeError: Failed to fetch dynamically imported module: <CHUNK>`, à la même milliseconde, depuis des robots | ⚪ **BRUIT** · **gravité 4** · famille **brut / faux positif** *(4 lignes le 13/09 à 22:50 et 23:14, deux visiteurs anonymes (`preAuth: true`) depuis `54.221.172.222` et `44.210.103.169` — plages **Amazon EC2 us-east-1** — avec un agent *« iPhone OS 18_7_8 … Safari Version/26.0 »* qui **n'existe pas** (Safari 26 ≠ iOS 18). Le chunk cité est **PRÉSENT** dans `tracky-web` (177 chunks) ; les deux appels échouent à 8 ms d'écart et le rapport, envoyé en `keepalive: true`, arrive quand même : la page a été **fermée**, les requêtes en vol ont été annulées, et `fetch` rejette alors le **même** `TypeError: Failed to fetch` qu'une panne de réseau. Correctif proposé : dans `report-client-error.ts`, ne pas remonter un `Failed to fetch` quand la page se cache (`visibilityState`/`pagehide`), et sur le canal anonyme ne remonter que les erreurs qui ne sont pas de transport — T59 · 📏 **15/09** : **aucune nouvelle ligne** — les 4 du 13/09 restent seules ; T59 (`314e4193`) sur `main`, **non déployé** (prod = `9afdf52a`))* | 2026-09-13 | 2026-09-13 |
| [TRK-078](#trk-078) | *alertes* / `trip-analysis` | **Le recalcul réécrit l'identité du trajet, et l'alerte d'excès de vitesse dédupliquée par `tripId` part deux fois** — 11 doublons sur 55 en 14 j, 2 alertes orphelines (`tripId` NULL) | 🟠 **CORRECTIF DÉPLOYÉ le 2026-09-13 à 11:30 (`229b7861`, T30), NON PROUVÉ** *(marqueurs `memeExcesDejaAlerte` et `rattacherAuTrajet` vérifiés le 14/09 dans `dist/alerts/alerts.service.js` servi. **0 doublon ET 0 excès** depuis le déploiement — un dimanche : indécidable ; les 2 orphelines n'ont pas bougé. Verdict au premier jour ouvré : ~3 excès distincts et 0 groupe en double)* · **gravité 2** · famille **faux positif** *(11 doublons sur 55 `OVERSPEED` nées de l'analyse de trajet entre le 30/08 et le 13/09 — même véhicule, même `payload.startAt` **à la seconde**, deux `tripId` différents. Le recalcul supprime et recrée les trajets (150 à 190 `recompute` créés par jour) : `Alert.trip` est `onDelete: SetNull`, la garde `findFirst({ tripId })` ne retrouve rien, et l'analyse du nouveau trajet ré-alerte. Il produit aussi des trajets qui se **chevauchent**. Vérifié sur l'artefact servi : `tripId: trip.id` ×3. Correctif : dédupliquer sur (véhicule, `startAt`) ; faire survivre l'id au recalcul — prérequis de T28 · 📏 **15/09, lundi** : **187 analyses, 1 seule qualifiée** (GR-270-HZ, 141 km/h > plafond 130 ; mh cars : 0 segment ≥ +40, 0 pointe > 130) → **1 alerte, 0 doublon, 0 orpheline** depuis le correctif. Le « ~3 » attendu extrapolait les 8/jour de la semaine passée, *dont 2 paires de doublons le 11/09*. **Détection saine ; déduplication toujours non exercée** (le trajet alerté n'a pas été redécoupé) · 🔴 **17/09 — LA DÉDUPLICATION A ÉTÉ EXERCÉE, ET ELLE A LAISSÉ PASSER 2 PAIRES SUR 9** (16/09, FM-772-JH, 5 destinataires prévenus deux fois) : (a) 05:51:17 / 07:56:15, 130,3 km/h, trajets `2b1822f6` (04:53→05:34) et `3df5312f` (05:22→07:24, créé 07:50) **chevauchants de 12 min** — motif `absolu` → **`decision.startAt` NUL** → `memeExcesDejaAlerte` rend `null` dès sa première ligne, seule la déduplication par trajet reste ; (b) 15:05:19 / 15:50:12, 140,6 km/h, `d7e77a9f` (12:34→14:34) et `a348005e` (14:07→14:43, **créé 15:45 par le recalcul**), `startAt` 14:06:51 puis 14:08:10 — **79 s > tolérance 30 s**, `endAt = startAt` (fenêtre réduite à un point). Et l'alerte FV-941-LZ du 15/09 08:49 « à `startAt` nul » était de la même famille. Trois défauts composés : trajets chevauchants toujours là, `absolu` sans instant, pointe = point. Compléments à T30 : instant pour `absolu` (position de vitesse max), même vitesse max + trajets chevauchants = même excès, et `recompute()` doit supprimer les trajets qui chevauchent sa fenêtre. Série : 14/09 0 (dimanche) · 15/09 0 mesuré / 1 probable · 16/09 **2 paires sur 9** · **17/09 0 / 12**. T30 reste DÉPLOYÉ, **preuve négative** · 📏 **18/09 — RECTIFICATION** : les 12 `OVERSPEED` du 17/09 (EP-047-TY ×2, EZ-259-DB ×4, FV-941-LZ ×6) portent **toutes** un `startAt`, dont **7 `absolu`** (130–144 km/h, `startAt = endAt`) — « `absolu` → `startAt` NUL » était trop large : les deux FM-772-JH du 16/09 sans instant étaient à **130 km/h pile** (130,3 arrondi, `overKmh` 0) — c'est **la pointe au plafond** qui n'a pas d'instant. Le complément (1) se précise : donner un instant à la pointe quand elle est au plafond. 0 paire (véhicule, vitesse max, trajets chevauchants) le 17/09)* | 2026-09-13 | 2026-09-18 |
| [TRK-077](#trk-077) | `TRIP_AUTOMATION` *(defaut d'outillage)* | **La garde du deploiement est lue AVANT une construction plus longue que la fenetre qu'elle protege** — un passage d'automatisation tue malgre un garde-fou present et correct | 🟠 **CORRECTIF PROPOSÉ** · **gravité 2** · famille **faux positif de garde** *(2 occurrences : 08/09 05:45 et 09/09 17:45. `deploy.sh` lit `trip_automation_runs` **une seule fois, au §1**, puis enchaîne `git pull` et `docker compose up -d --build` — or **la construction ne tue personne, seule la recréation du conteneur le fait**, plusieurs minutes plus tard. Chronologie mesurée le 09/09 : garde franchie vers 17:43 **à juste titre**, passage parti à **17:45:00.145**, image construite à **17:46:09**, `CRITICAL` écrite à **17:46:43.678**. 🔑 **La garde protège de tout sauf du cas le plus probable** : le déploiement lancé juste avant l'heure ronde. Correctif : relire la garde **juste avant `up -d`**, et/ou refuser de partir dans la fenêtre **HH:40 → HH:45**. ⚠️ **Double condition de vérification** : le refus doit tomber, **et les lignes « Passage d'automatisation interrompu » doivent rester possibles** — sinon on a désarmé le témoin au lieu de protéger le passage · 🎯 **15/09 — LA SECONDE LECTURE DE LA GARDE A RETENU UN VRAI DÉPLOIEMENT, SANS LAISSER DE TRACE.** Le 14/09 à 11:40, `deploy.sh` a posé `avant-20260914-1140-9afdf52a`, tiré `feat/rdv-installation-v2` (`dcfeb9a5`), construit jusqu'à **11:47:34** — et le passage de **11:45 → 12:44 (59 min)** tournait : **aucune recréation** (`journal.jsonl` muet depuis 08:20, conteneur = image `avant-…-1140`, `leadDays` absent du `dist` servi). Pendant ce temps `origin/main` porte `02b8a6cf` « correctif **déployé sur prod** ». *Le garde-fou a marché ; le refus ne s'écrit nulle part.* 🆕 **T66** : journaliser refus et abandons, et une ligne `DEGRADATION` de la sentinelle « déploiement ». 📏 Et 7 passages > 45 min le 14/09 (3, 3, 0 les jours d'avant) sous V28 : la garde n'a de fenêtre qu'entre :35 et :42 · ✅ **18/09 — T29 PROUVÉ** : le 17/09, `deploy.sh --attendre` a recréé `1ba0cc25` à **13:37:04** (3 355 s d'attente) et `1d1521b2` à **15:37:05** (6 012 s), chaque fois **une seconde après la fin du passage en cours** (12:45 → 13:36, 14:45 → 15:37) ; `trip_automation_runs` 17/09 : 23 passages `done`, **0 `interrupted`** ; le journal porte `sante: healthy`. T66 (refus écrit) reste ouvert)* | 2026-09-10 | 2026-09-17 |
| [TRK-076](#trk-076) | `frontend` | **La carte ne survivait pas a une perte de contexte WebGL** — `[uncaught] TypeError: Cannot read properties of null (reading 'getSource')` | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ PAR L'ÉCHÉANCE le 2026-09-15** (`09d04e2b`, déployé le 08/09 01:01:57, **T27 FAIT**) · **gravité 2** · famille **brut** *(✅ **15/09** : **0 ligne `getSource` depuis le 07/09 13:04 — 180 h, dont 168 h après le déploiement**, et le compte qui l'avait produite (`standard@cdef31.org`) est revenu 5 jours sur 6 (2, 2, 9, 7, 10 requêtes) sans une ligne `frontend`. *Ce que ça ne prouve pas : qu'une perte de contexte ait été rattrapée — elle ne se provoque pas en lecture seule.* · 2 occurrences, 07/09 13:01 et 13:04, `standard@cdef31.org`, page `/map`. Le navigateur peut retirer le contexte WebGL à tout moment ; MapLibre 5.24 fait alors `this.style.destroy(); this.style = null` — **l'objet `Map` reste vivant, donc les DIX-NEUF gardes `if (!this.map) return` passent toutes**, mais `map.getSource(...)` lit `this.style.getSource(...)` et lève. 🔑 **La garde testait la mauvaise chose** : elle demandait « la carte existe-t-elle ? » quand la question était « son style existe-t-il encore ? » — *une garde qui passe toujours ne garde rien*. Correctif écrit par une session parallèle : écoute de `webglcontextlost` + `preventDefault()` **obligatoire** (sans lui le navigateur ne tente JAMAIS la restauration), garde `carteUtilisable()` sur chaque `getSource`, bandeau explicite, reprise sur `webglcontextrestored`. **Vérifié sur l'ARTEFACT SERVI** : `webglcontextlost` et `carteUtilisable` présents dans `chunk-3BYQORV7.js`. ⚠️ **Déployé n'est pas prouvé** — 26 min de recul à la collecte. ✅ **Au 09/09 : 0 ligne `getSource` sur 48 h.** La barre que la fiche se donne est de **sept jours** — **échéance au 15/09**)* | 2026-09-07 | 2026-09-15 |
| [TRK-075](#trk-075) | `trip-analysis` | **Le rejeu d'analyse n'a pas d'etat terminal, et il crie depuis l'etage qui ne decide rien** — `Analyse impossible : les positions de ce trajet ne sont plus disponibles…` | 🟢 **CORRIGÉ ET DÉPLOYÉ le 2026-09-08 à 17:12:05** (`dc35f1a3`) · **gravité 1** · famille **circulaire** *(✅ **LE TRAJET S'EST TU** : dernière ligne le **08/09 15:55:05**, puis **8 passages horaires consécutifs sans aucune ligne** `stage: 'compute'` (17:45 → 00:45, tous `done`). Auparavant : **une par passage sans exception depuis le 07/09 03:45**, **27 au total**. Correctif : une classe dédiée `PositionsIntrouvablesException` (toujours un 422) que `analyze()` **n'archive plus** et que les **trois** chemins reconnaissent pour figer — `fige-retention` sous l'horizon (muet) et `fige-sans-positions` au-dessus (dit **UNE** fois, le gel garantissant l'unicité). **Vérifié sur l'ARTEFACT SERVI** : `PositionsIntrouvables` dans `dist/common/` et ×2 dans `trip-analysis.service.js`, `fige-retention` ×5 / `fige-sans-positions` ×5, `horizonRetention` ×7. ⚠️ **LA SECONDE MOITIÉ DE LA DOUBLE CONDITION ÉTAIT INVÉRIFIABLE TELLE QU'ÉCRITE, et elle est reformulée** : « les candidats tombent de 17 à 14 » suppose que le correctif retire des lignes — il n'en retire aucune, il **exclut** les candidats sous l'horizon *au moment de la sélection*. Une lecture voit donc le **vivier**, qui **grossit** : **17 → 20**, dont **3 → 4** sous l'horizon. *C'est la fuite lente annoncée, à sa vitesse annoncée : +3 candidats et +1 immortel par jour.* Le rejeu **n'est pas éteint** : les 8 passages depuis la bascule ont analysé 2 à 8 trajets chacun, et **30 analyses** portent un `computedAt` postérieur au déploiement. 🗓️ **Test qui tranche, au 10/09** : **24 h pleines sans ligne `stage: 'compute'`** pendant que le vivier sous horizon passe de **4 à ~5** — *si les lignes reviennent, le gel ne tient pas ; si le vivier sous horizon cesse de croître, on a purgé au lieu de borner*. **Historique du diagnostic** : 15 occurrences en 21 h, du 07/09 03:45 au 08/09 00:50, **toutes le MÊME trajet** `b644fe50` — 08/07, 3 186 m, **61,4 j**, positions **0**, la plus ancienne position de toute la base à **60,9 j**, `POSITIONS_RETENTION_DAYS=60` lu sur le conteneur servi. **DEUX défauts qui se composent.** (a) `TripAnalysisService.analyze()` enregistre au centre d'alerte dans son PROPRE `catch` (`trip-analysis.service.ts:92-101`, marqueur `stage: 'compute'`) **puis re-lève** — or les TROIS appelants décident ensuite, et **deux d'entre eux portent un commentaire promettant explicitement de se taire** (`:1370` « on n'alerte pas », `:1413` « un échec ne remonte PAS au centre d'alerte ») ; le troisième fige et annonce « le figeage EST la trace » (`:939`). 🔑 **Trois commentaires promettent un silence que leur couche n'a pas le pouvoir d'accorder** — la preuve tient dans le contexte, qui porte `stage: 'compute'` et non `phase: 'analyze'`. (b) `rejouerAnalysesIncompletes` (`:1347-1355`) **n'a pas le plancher `horizonRetention()` que sa jumelle `reprendreAnalysesAnciennes` possède** (`:1441`) : un candidat dont les positions sont purgées ne peut plus jamais améliorer sa couverture, donc il reste candidat **pour toujours** — 17 candidats dont **3 sous l'horizon**, plafond 25, donc tous tentés à chaque passage. 🔑 **C'est [TRK-062](#trk-062) — une commande sans état terminal — transposé à une file de calcul.** ⚠️ Le refus d'écrire une analyse vide est JUSTE (garde du 21/08) : le défaut n'est pas de refuser, c'est de refuser 15 fois par jour depuis une couche qui n'a pas le droit d'en juger. ⚠️ **Fuite LENTE** : le front de purge avance d'un jour par jour, de nouveaux candidats immortels naissent chaque jour)* | 2026-09-07 | 2026-09-08 |
| [TRK-074](#trk-074) | `scheduled-task-heartbeat` | **Le temoin des taches planifiees ne se referme jamais** — 4 `CRITICAL` restent ouvertes apres le retour de la tache, alors que la sentinelle voisine archive les siennes toute seule | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-13 à 13:35:00** (`171857fc`, T25) *(les 4 `CRITICAL` du 06/09 se sont archivées **seules** deux minutes après le déploiement de 13:33, note « Tâche repassée le 13/09/2026 14:55 (résolution automatique) », après **165 h** ; `resolvedAt` ×2 dans `dist/observability/scheduled-task-heartbeat.service.js` servi ; 0 ligne active au 14/09. ⚠️ Seconde moitié de la double condition — une tâche réellement à l'arrêt doit CONTINUER d'en produire — garantie par la borne `createdAt < lastRunAt` et 7 tests, non exercée en production : 24/24 passages `done` chaque jour depuis)* · **gravité 2** · famille **à lire, pas à notifier** *(mesuré le 07/09 : les 4 lignes du 06/09 (17:35 → 20:35) sont toujours `ACTIVE` alors que la condition est close depuis **20:45**. **Le bon comportement existe dans le même dépôt** : `background-tasks/agents-locaux-sentinelle.service.ts:266-272` pose `resolvedAt` + « Agent repassé le … (résolution automatique) » — exercé **4 fois sur 4** le 06/09, zéro geste humain. `observability/scheduled-task-heartbeat.service.ts` n'a **aucune** notion de résolution. 🔑 **L'instrument le plus récent a le bon comportement, le plus ancien ne l'a jamais eu** — un témoin qui ne se referme pas transforme chaque incident transitoire en dette permanente, et c'est ce qui pousse à vouloir « vider l'écran ». ⚠️ **double condition** : après correctif les lignes doivent s'archiver au retour de la tâche ET une tâche réellement arrêtée doit continuer d'en produire ; ⚠️ **filtrer sur le NOM DE TÂCHE structuré, jamais sur le texte du message** — piège documenté par la sentinelle voisine (`:254`). 🔴 **Au 09/09, TOUJOURS non déployée — 3ᵉ vérification négative** : « résolution automatique » **absente** de `dist/observability/scheduled-task-heartbeat.service.js` sur l'image de 17:11:52. Les 4 `CRITICAL` du 06/09 sont actives depuis **4 jours** pendant que **sa jumelle a encore archivé toute seule** le 08/09 à 16:50. *L'écart entre les deux instruments se creuse d'un jour par jour, et c'est ce qui finit par faire dire « videz l'écran ».*)* | 2026-09-06 | 2026-09-06 |
| [TRK-073](#trk-073) | `trip-automation` | **L'historique de l'automatisation ne peut consigner que les passages qui vont au bout** — 8 passages sur 24 perdus le 06/09 **alors qu'ils ont tourné**, et le témoin de vie en conclut « à l'arrêt » | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-08 à 17:12:05** (`dae97b03` + `dc35f1a3`) · **gravité 1** · famille **mensonger** *(🎯 **LA PREUVE ÉCRITE D'AVANCE EST TOMBÉE AU MOT PRÈS.** La consigne du 08/09 disait : « 24 lignes, dont une ou plusieurs MARQUÉES INTERROMPUES — et si le compte monte à 24 sans qu'aucune ne soit marquée, on a maquillé le carnet ». Mesuré le 09/09 : le **08/09 porte 24 passages sur 24, dont exactement 1 `interrupted`** — celui de **05:45:00**, tué en vol par le déploiement de 05:45. Série : 05/09 **23** · 06/09 **16** · 07/09 **17** · 08/09 **24**. Correctif : la ligne naît avec le passage (`status = 'running'`, migration `20260908053000`), se complète à la clôture (`done` / `failed`), et une ligne restée `running` au démarrage de l'API devient `interrupted` + `CRITICAL`. **Vérifié sur l'ARTEFACT SERVI** : `running` ×7, `interrupted` ×2 dans `dist/trip-analysis/trip-automation.service.js`. 🆕 **Signature du témoin neuf** : `TRIP_AUTOMATION` / `CRITICAL` / « Passage d'automatisation interrompu : commencé le <DATE> (planifié), jamais terminé — l'API a redémarré <DURÉE> plus tard. » (contexte `phase: 'interrompu'`, `runId`, `origin`, `minutes`) — **c'est la voix du correctif, pas un défaut**. ⚠️ **Sa toute première ligne dit « 0 min » : formulation déjà corrigée six minutes plus tard** (`3d6834b8`), l'artefact servi porte « moins d'une minute » — *un fossile, pas une régression*. 🔴 **Depuis `f988c74e`, une `CRITICAL` suffit à envoyer un e-mail** : un déploiement pendant un passage en enverrait un à chaque fois — **le garde-fou existe et est en place sur le VPS**, `deploy.sh` refuse de partir quand une ligne `running` est ouverte (`fd87ca46`, vérifié dans `/opt/vizyo-tracky`, arbre propre). ⚠️ **`trip_automation_runs` ne garde que 100 lignes** : le 04/09 valait 22 le 06/09 et vaut 19 ce jour — **la journée la plus ancienne s'érode par le bas**, ne pas la lire comme une baisse. ⚠️ **L'audit du 08/09 cherchait `EN_COURS` et le trouvait absent** : le correctif a livré la même idée sous un autre nom — *chercher le mot d'une spécification plutôt que le comportement qu'elle décrit fait manquer un correctif présent*. **Historique du diagnostic** : mesuré le 07/09. `trip_automation_runs` : **16 lignes sur 24** le 06/09, trou de 12:45 à 20:45 + 10:45. **Mais 7 des 8 créneaux portent un `trips_recompute` à `:45:00` d'acteur `system-trip-automation`** — le passage a démarré et fait du travail réel (13:45 : *9 trajets supprimés, 3 recréés*). Deux hypothèses ÉCARTÉES PAR LA MESURE : la garde anti double-run de [TRK-043](#trk-043) laisse une trace et n'en a produit **qu'une en 7 jours** (04/09) ; un échec écrirait un `CRITICAL` (`trip-automation.service.ts:496-498`) et **aucune ligne `TRIP_AUTOMATION` n'existe le 06/09**. Reste : **interrompus**. Cause racine : `persistRun()` et `recordRun()` sont appelés **ligne 470-471, sur le seul chemin heureux** ; le `catch` n'écrit qu'au centre d'alerte. 🔑 **La table ne peut donc contenir que des succès : un passage interrompu y est indiscernable d'un passage qui n'a jamais eu lieu.** Le témoin `scheduled-task-heartbeat` juge le silence depuis `lastRunAt`, écrit à la CLÔTURE — **il ne ment pas, il lit fidèlement une jauge qui ment**. ⚠️ **ne pas corriger le témoin** : le défaut est en amont, dans le point de mesure — même leçon que TRK-043)* | 2026-09-06 | 2026-09-08 |
| [TRK-072](#trk-072) | `sentinelles` | **La chaîne de vitesse fraîchement armée sature ses destinataires** — `<EMAIL> a reçu <N> notifications en 24 h, dont <N> de type <TYPE>…` | 🔵 **TERRAIN** *(décision produit)* · **gravité 2** · famille **à lire, pas à notifier** *(2 occurrences, 05/09 06:30. Le seuil « destinataire saturé » des sentinelles V6 parle pour la 1ʳᵉ fois : **15 notifications en 24 h dont 14 `OVERSPEED`** sur deux SUPER_ADMIN, pour un produit calibré sur 2 à 3 par jour. **Ce n'est pas un défaut** : c'est l'effet mesuré de l'armement des alertes de vitesse sur 2 sociétés le 04/09. Le risque annoncé est réel — qui coupe ses notifications ne reçoit plus rien, **pas même un SOS**. Deux leviers, à trancher par un humain : relever le seuil `OVERSPEED`, ou restreindre ses destinataires. ⚠️ Vérification en DOUBLE CONDITION : la sentinelle doit se taire **et** le compte d'`OVERSPEED` rester non nul · 📏 **18/09** : 17/09 06:30, **23** (admin@) et **22** (rougie31@) notifications en 24 h dont **7 `agent-local-absent`** chacun — les pushs de T69/T31 pour le poste s'ajoutent aux 22 `OVERSPEED` ; le socle prévient bien, c'est le poste qui a crié sept fois pour une cause (session expirée, TRK-069) avant que T34 ne le mette en pause)* | 2026-09-06 | 2026-09-18 |
| [TRK-071](#trk-071) | `AI_ROUTER` | **Le repli IA est né inerte : le SECOND compte est à sec aussi** — `Repli IA en échec : claude → gpt (provider_unfunded) — …` | 🔵 **TERRAIN** *(action humaine : recharger)* · **gravité 1** · famille **terrain** *(📏 **18/09 : 361 h, 16ᵉ jour** — 297 appels CLI locale `ok` en 48 h, dernier le 16/09 22:04 (la CLI du poste est morte depuis : TRK-069) · 📏 **17/09 : 339 h, 15ᵉ jour** — dernier `ok` du fournisseur `claude` le 05/09 16:03:29, 0 tentative API en 48 h, 500 appels CLI locale réussis · 📏 **13/09 : le TROISIÈME canal — la CLI du poste, `executor = local` — s'est révélé plafonné à son tour** : 80 h sans aucun canal IA ouvert (cf. TRK-069). Anthropic à sec depuis le 03/09 00:13 (**250 h**), dernier appel API réussi le 03/09 00:01:02. 1 occurrence, 05/09 12:23:59. Le repli `claude → gpt` livré le jour même (chantier C3 point 1) a été exercé **six minutes après sa mise en ligne** et n'avait nulle part où aller : Anthropic à sec depuis le 03/09 00:13, OpenAI constaté vide. **Ce n'est PAS un défaut de code** — le routeur bascule, échoue, l'écrit, le date et le classe correctement en `DEGRADATION`. 🔑 **Un mécanisme de secours ne vaut que par la ressource qu'il vise** : livrer une redondance sans provisionner sa cible, c'est livrer une ligne de journal. Action : recharger **au moins un** des deux comptes)* | 2026-09-06 | 2026-09-20 |
| [TRK-070](#trk-070) | `ASSISTANCE` | **L'escalade d'assistance ré-écrit en `ERROR` un incident déjà classé `DEGRADATION`** — `Assistance à reprendre — <EMAIL> : <MOTIF>` | 🟠 **CORRECTIF DÉPLOYÉ le 2026-09-07 à 00:58:58 (`2112e9ae`), NON EXERCÉ** · **gravité 2** · famille **circulaire** *(2 occurrences. Un compte IA à sec produit DEUX lignes à **14 ms** d'intervalle : la 1ʳᵉ en `DEGRADATION` (correctif C3 point 5 / TRK-061), la 2ᵈᵉ en `ERROR` — qui la recompte comme un défaut. Cause : `assistance-ai.service.ts:153-155` trace correctement PUIS escalade, et `signalerReprise` décide son niveau sur la **GRAVITÉ de la conversation**, jamais sur la **CAUSE** de l'escalade — elle ne peut donc pas distinguer « un utilisateur a besoin d'un humain » de « l'IA était en panne ». Mesuré des deux côtés du déploiement : `ERROR`+`ERROR` à 12:23, `DEGRADATION`+`ERROR` à 17:00 — **le correctif a supprimé la moitié du bruit**. Motif de TRK-004 et TRK-061 rejoué sur une **4ᵉ** chaîne)* | 2026-09-06 | 2026-09-06 |
| [TRK-069](#trk-069) | `agents-locaux` | **Un agent du poste n'a pas tourné, a échoué, ou n'a jamais été vu** — `Passage manqué : <AGENT> attendu le <DATE> à <HH:MM> (Paris)…`, `Dernier passage en échec : <AGENT>…`, `Agent du poste jamais journalisé : <AGENT>` | 🔵 **TERRAIN** · **gravité 2** · famille **angle mort** · **40 occurrences** *(📏 **14/09 — T31 tient, et deux défauts d'outillage** : (1) `a8f9575e` + `13471c53` en ligne — la cause « plafond » a été rouverte à 18:50 sur l'échec ANCIEN de `agent-recit-trajet` (le cas exact du second commit, déployé à 20:02), puis **cinq contrôles (20:50 → 00:50) sans rechute** sur la même condition ; 12 lignes archivées seules par le retour des agents ; **13 `CRITICAL`** restent ouvertes en attendant le premier passage réussi de `agent-recit-trajet` et `courrier-ia`. (2) 🆕 variante **« CLI hors abonnement : « claude auth status » en échec : délai dépassé »** (20:50, refermée 22:50) — un délai de 30 s classé refus par la porte de T34 ; **corrigé sur le poste** par `8f1a6c3e`. (3) 🔴 **l'échec `SyntaxError: Unexpected non-whitespace character after JSON` de `courrier-ia` (17:52, `succes = false`) est MUET au centre d'alerte** : la clé de refroidissement (agent, motif) a été consommée à 02:50 par la ligne « weekly limit », 24 h ; un échec d'une AUTRE cause sous la même clé n'est pas écrit — T58 : hachage de la cause dans la clé, et lecture du premier objet JSON équilibré dans `outils/agent-courrier-ia.cjs:239`. Test daté : une `CRITICAL` courrier-ia SyntaxError au contrôle de 03:50 UTC le 14/09.)* *(📏 **13/09 : 25 lignes en trois jours pour UNE cause** — `echec de la CLI : You've hit your weekly limit · resets Sep 13, 12pm (Europe/Paris)`, le **plafond hebdomadaire de l'abonnement Claude Code du poste**, du 10/09 04:00 au 13/09 12:00 Paris (80 h). 36 passages en échec, 0 succès pour `rattrapage-recits`, `courrier-ia`, `agent-recit-trajet` ; les deux agents sans modèle ont tourné (11/11, 2/2). 6 lignes refermées seules. Reprise mesurée **12 min après la remise à zéro**. Le niveau `CRITICAL` pour une cause commune est à rediscuter — T31, T32. Instrument né du PS du chantier C3 le 2026-09-05 avec **0 occurrence** ; il a parlé au **premier matin sans poste**, le 06/09, avec trois motifs distincts et aucune redondance : `agent-recit-trajet` en échec le 05/09 03:15 « passage interrompu avant la fin » puis manqué le 06/09 03:15, `rattrapage-recits` manqué à 22:00 après un dernier passage réussi à 20:00. **Le poste a cessé de travailler dans la soirée du 05/09.** Un raisonnement en « 2 × cadence » n'aurait rien dit avant le 07/09 : **48 h gagnées**. ⚠️ Il fait passer les `CRITICAL` actives de 2 à 5 — c'est un capteur qui s'allume, pas la plateforme qui se dégrade. L'action est matérielle : allumer le poste, vérifier le Planificateur, lire le motif d'échec ; la ligne s'archive seule au premier passage réussi · ✅ **15/09** : le test daté est **tombé** — `CRITICAL` « courrier-ia … SyntaxError » à **01:50** *(deux heures avant l'heure prédite : l'ancre du refroidissement était 01:50, pas 02:50 — même mécanisme)*, refermée à 04:50 par le passage de 04:30 (« 2 travaux livrés », le rapport d'activité en 3ᵉ tentative est passé) ; **les 13 `CRITICAL` archivées seules à 04:50:00** ; 22 / 22 passages réussis le 14/09 ; T58 (`1539674c`) sur `main`, **non déployé** · 📏 **17/09 — LE POSTE DORT LA NUIT** : 16/09 ≈ 02:05 → 05:55 Paris et 17/09 ≈ 00:05 → 05:15 Paris (`rattrapage-recits` toutes les 2 h : 04:00 du 16/09, 02:00 et 04:00 du 17/09 manqués ; cet audit planifié à 03:00 parti à **05:18**). `agent-recit-trajet` (03:15) et `agent-qualite-gps` (05:00) **manqués le 16/09 et JAMAIS rattrapés dans la journée** — derniers passages le 15/09 01:15 et 03:00 UTC ; 6 `CRITICAL` nées en 24 h, 2 refermées seules (courrier-ia, limites-vitesse), **4 ouvertes**, **5 e-mails** « agents-locaux » ; le jour : 15 passages, 15 réussis, 24/24 récits. Deux gestes côté poste : V6 (`WakeToRun`) et « exécuter dès que possible après un démarrage manqué » sur les deux agents quotidiens · 🔴 **18/09 — CAUSE NEUVE : LA SESSION CLAUDE CODE DU POSTE A EXPIRÉ** (`Failed to authenticate. API Error: 401 OAuth access token has expired`) le 17/09 à **03:21 UTC** — `agent-recit-trajet`, `rattrapage-recits` (04:00, 06:00, 08:00), `courrier-ia` (04:30) en échec ; 3 `CRITICAL` (03:50 ×2, 04:50). ✅ **T34 EXERCÉ SUR UN VRAI CAS** : à **08:50** la sentinelle pose la pause `echecs-consecutifs` (`pauses_agents_locaux`, motif = le 401), **un** e-mail `DELIVERED` « Agents du poste en pause — cinq heures d'échecs d'affilée », **une** `DEGRADATION` « cause commune … reprise MANUELLE », et les 9 passages suivants sortent en 1 s « suspendu » **sans nouvelle `CRITICAL`** ; `agent-limites-vitesse` (5/5) et `agent-qualite-gps` (1/1, ligne du 16/09 refermée seule à 03:50) tournent. **Coût : 0 récit de trajet depuis le 16/09 22:00** (22 h). Effet de bord : 14 pushs `agent-local-absent` en 24 h → la sentinelle « saturé » désigne ce type (TRK-072). Geste : `claude auth login` sur le poste puis « Reprendre maintenant » — 👉 **T75** · 📏 **21/09 : pause 4 j 16 h, 99 h sans récit, 10ᵉ `CRITICAL`** (20/09 03:50 « manqué … en pause ») + 2 pushs — la vérification quotidienne ignore toujours la pause (reste de T58) ; 0 appel IA en 72 h)* | 2026-09-05 | 2026-09-20 |
| [TRK-068](#trk-068) | `http` | **`fetch failed` sur le rafraîchissement de jeton, et c'est un `CRITICAL`** — l'appel à Vizyo Auth n'a ni `try/catch` ni délai d'expiration, le rejet de transport remonte nu et NestJS en fait un 500 | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-12 à 00:00:23** *(🎯 **EXERCÉE** : `http \| ERROR \| Vizyo Auth est injoignable : l'appel POST /v1/auth/refresh n'a pas pu aboutir. La session de l'utilisateur ne peut pas etre verifiee : il va etre deconnecte. Motif technique : aucune reponse en 8 s.`, `statusCode: 503` — **les quatre conditions écrites le 06/09 au mot près**, et `http CRITICAL` reste à 2 : pas de jumelle. ⚠️ 1 seul point à minuit, `logrotate.timer` à 00:00:03 sur l'hôte — trois points ou rien)* · **gravité 2** · famille **brut** *(ancien statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-07 à 00:58:58 (`c80632ba`), NON EXERCÉ. 1 occurrence, 04/09 12:57:05, depuis un iPhone. Trois défauts dans la même ligne : le **message brut** ne nomme ni la dépendance ni la conséquence ; le **500 est faux** — une dépendance injoignable est un 503, et le client ne peut pas distinguer « réessaie » de « ta session est morte » ; le niveau **`CRITICAL`** est disproportionné pour une panne tierce sur un seul rafraîchissement. 🔑 **TROISIÈME récidive du motif de [TRK-060](#trk-060) et [TRK-066](#trk-066), sur une troisième chaîne** — aucun appel sortant de ce dépôt n'a de gabarit de message d'échec. ⚠️ Jumeau à traiter : `verifyLoginCode()`, même angle mort · 📏 **21/09 — 8 lignes 05:10 → 06:58** (VPS-045) : `/refresh` ×1, **`/login` ×7** (3 adresses dont le poste, +1 fondue) — **personne n'a pu se connecter pendant 1 h 48**, e-mail `password_reset` à 06:56 pour la dernière adresse ; **3ᵉ jour, le message tient** ; ⚠️ variante `/login` : « il va être déconnecté » est faux (pas de session) — dire « connexion impossible, réessayer »)* | 2026-09-04 | 2026-09-20 |
...
| [TRK-066](#trk-066) | `sms-gateway` / `engine-control` | **Le coupe-circuit a échoué sur ses DEUX voies, et le dernier recours n'a pas dit lequel** — `The operation was aborted due to timeout` | 🟠 **CORRECTIF DU MESSAGE DÉPLOYÉ le 2026-09-04 à 17:01, NON EXERCÉ** *(marqueur `decrireEchecRelaisSms` vérifié le 05/09 dans `dist/sms/sms-gateway.service.js` — l'artefact SERVI, pas la fiche ; ancien libellé : « ÉCRIT ET COMMITÉ, NON DÉPLOYÉ »)* · **gravité 1** · famille **brut** *(**PREMIÈRE ligne `sms-gateway` de toute l'histoire conservée** — le référentiel notait « 0 depuis toujours » pour cette source, et ce zéro n'était pas une bonne nouvelle : c'était un canal qui ne s'était jamais plaint. Le 04/09 à 03:00:10, `FG-669-DQ` (`864035053277662`) est **hors ligne depuis 8 h** ; une commande moteur part, le TCP est impossible, **le repli SMS est donc la DERNIÈRE voie** — et le relais `vizyo-texto` n'a pas répondu dans les 10 s accordées (`sms-gateway.service.ts:609`, `AbortSignal.timeout(10_000)`). **Le véhicule n'a PAS été immobilisé.** ⚠️ Le message écrit au centre d'alerte était `The operation was aborted due to timeout` : sept mots qui ne nomment ni la dépendance, ni la conséquence, ni ce qui survit — **le défaut de [TRK-060](#trk-060), sur une chaîne bien plus grave**. La ligne jumelle de `engine-control`, elle, nomme correctement la conséquence. 🔵 **Trois questions restent HUMAINES et ne sont pas touchées** : le délai de 10 s sur un dernier recours, **l'absence de tout réessai**, et le niveau `ERROR` porté par une immobilisation qui n'a pas eu lieu. Le §8 interdit de modifier une garde de coupe-circuit sans décision humaine — *on corrige le cri, jamais le garde-fou*. ⚠️ **UNE seule occurrence** : fait mesuré, pas une tendance · 🔴🔴 **15/09 — LE COUPE-CIRCUIT A TOURNÉ SUR L'ANCIEN CODE** : plannings CDEF31 réarmés par le client (30/30), **24 `CUT` `SCHEDULER` le 14/09 à 20:00 UTC, toutes `ACKNOWLEDGED` / TCP en 1–5 s** (dont HD-584-BF et BP-434-RD, dont deux véhicules déclarés débranchés) ; HM-769-GA différé « hors champ GPS » (TRK-046) ; **2 `RESTORE` manuelles à 21:13 / 21:14** (HM-733-GA, GS-187-NY) ; **22 `RESTORE` du matin à lire à 07:10 Paris**, sur le même code. Le chantier #138 (T40 → T62) est sur `main`, **pas en production** (45 commits d'écart) ; la section T65 ne s'applique pas — ses colonnes n'existent pas en prod · 🟢 **18/09 — DEUXIÈME NUIT PROBANTE (17→18)** : preuve de 21:30 Paris `delivered` en 5 s, 0 refus d'interlock, **28 coupes** (4 MH Cars 18:00 UTC, 24 CDEF31 20:00–20:06), **28 acquittées en 0,4–5,1 s** dont **EY-613-MF par SMS en 5,1 s** (socket manquante 7 s, `stop123456` `delivered` +4 s, « Stop engine Succeed » +5 s), 0 `SENT_UNCONFIRMED` ; T62 et T69 (2) exercés ; 2 RESTORE manuelles (GR-294-VW 21:27, HM-733-GA 21:30 — 3ᵉ nuit sur 3). **Le matin du 17 : l'API à terre 04:56 → 05:52 a retardé de 53 à 67 min les 24 reprises CDEF31** (nées 05:53, 20 par SMS, 29/29 acquittées à 06:08) — [TRK-084](#trk-084) ; 7 non prouvées à +5 min → 1 ligne — [TRK-085](#trk-085). T65 : 6 OK / 0 non exercé — second passage OK · 🟢 **21/09 — NUIT 5 PROBANTE SOUS VPS-045** : 30 coupes / 30 (4 MH Cars 18:00, 26 CDEF31 20:00–20:08), 29 ACK TCP 0,3–5,0 s + **1 `SENT_UNCONFIRMED` exécutée** (EP-047-TY, TRK-083), 0 refus ; 31 reprises / 31 le matin sur une VM à 10 % de CPU — **2,6 à 220 s**, **5 SMS de secours `delivered` dont 2 pour rien**, 3 fausses `CRITICAL` « non confirmé » + 4 (TRK-091) ; **HM-733-GA pas rallumé à la main pour la 1ʳᵉ fois en 6 nuits**. ⚠️ Les 2 lignes `sms-gateway` du 20/09 02:30 / 04:30 (« SMS non remis au relais … n'est pas parti ») sont exemplaires de forme et **fausses sur le fait** — le message est parti : [TRK-090](#trk-090))* | 2026-09-04 | 2026-09-20 |
...
| [TRK-064](#trk-064) | *(angle mort — aucune ligne)* | **La chaîne d'alerte de vitesse est déployée, et activée nulle part** — et la sentinelle qui devait le voir se tait pour la même raison | 🟠 **CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`bacc9b44`), ET LE SUJET A CHANGÉ** *(marqueur `sentinelle-chaine-vitesse-jamais-armee` vérifié le 05/09 sur l'artefact SERVI. 🎯 **`speedAlertEnabled` vaut désormais `true` sur 2 sociétés sur 5** — contre 0 sur 5 le 04/09 : un humain a tranché la décision produit. **12 `OVERSPEED` le 04/09, 12 sur 12 nées d'un TRAJET**, là où les 8 de la semaine précédente venaient toutes du chemin historique du boîtier — **la chaîne V5 écrit pour la première fois**. Le silence de la sentinelle nº 1 est donc désormais LÉGITIME : sa condition n'est plus vraie. Ancien libellé : « ÉCRIT ET COMMITÉ, NON DÉPLOYÉ »)* · **gravité 1** · famille **à lire, pas à notifier** *(lot V5 en ligne depuis le 04/09 01:03. Mesure : **0 flotte sur 5** et **0 véhicule sur 44** avec `speedAlertEnabled`, **0 seuil renseigné**, `speedAlertUpdatedAt` NULL partout — pendant que **150 analyses portent un excès sur 24 h, dont 145 fraîches**. La sentinelle nº 1 `excesSansAlerte` sort à `sentinelles-coherence.service.ts:261` sur `if (flottes.length === 0) return []` : **elle ne peut pas parler**, et rend le MÊME silence qu'une chaîne en parfait état. ⚠️ **Ce n'est pas un défaut du code** — l'opt-in est un choix produit défendable ; le défaut est que **rien ne dit que le réglage est à zéro partout**. 🔑 Les 8 `OVERSPEED` de la semaine sont toutes sur `FG-669-DQ` et **aucune n'est rattachée à un trajet** : elles viennent du chemin historique, pas de V5 — *le compteur `OVERSPEED` n'a jamais mesuré cette chaîne*)* | 2026-09-04 | 2026-09-04 |
| [TRK-065](#trk-065) | `sentinelles` | **42 notifications non remises faute d'appareil abonné, dont 21 pour un compte technique** | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-11 à 06:30:03** *(🎯 **EXERCÉE** : « **53** notifications n'ont pas pu être remises cette semaine faute d'appareil abonné, sur **1 compte actif** : tyger.bcn@gmail.com (53) », contexte **`comptesTechniquesEcartes: 1`**, `system@tracky.local` **absent**. ⚠️ Le « 42 → ~21 » supposait un numérateur constant : mesuré en base, **21 + 21** la semaine du 28/08→04/09, **53 + 53** celle du 04/09→11/09 — le numérateur a été ×2,5 par la tempête `agents-locaux`, et sans le correctif la ligne aurait dit **106**. **C'est la forme qui prouve, pas le nombre.** Prévenir le titulaire reste T6)* *(ancien statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`68034a1d`), NON EXERCÉ — marqueur `comptesTechniquesEcartes` vérifié le 05/09 dans `dist/observability/sentinelles-coherence.service.js`. Refroidissement **hebdomadaire** : la prochaine ligne est attendue vers le **11/09**, et elle doit tomber de 42 à ~21 sans citer `system@tracky.local`. Ancien libellé : « ÉCRIT ET COMMITÉ, NON DÉPLOYÉ »)* · **gravité 3** *(**première ligne jamais écrite par les sentinelles du lot V6**, 72 s après le démarrage de l'API — l'instrument a parlé au premier passage et il avait raison. Mesure indépendante sur 7 j : `SENT` 66, `SUPPRESSED/no_device` **42**, `SUPPRESSED/default_type_muted` 21 → **une notification sur trois n'atteint personne**. Les 42 se partagent également entre `system@tracky.local` (21), compte **technique** qui n'aura JAMAIS d'appareil, et `tyger.bcn@gmail.com` (21), humain qui se croit prévenu. ⚠️ **Sans sortir le compte technique de la liste, cette sentinelle criera chaque semaine avec un chiffre à moitié structurel** — c'est ainsi qu'un instrument neuf devient du bruit en trois passages)* | 2026-09-04 | 2026-09-18 |
| [TRK-061](#trk-061) | `AI_OPTIMIZER` / `http` | **Le compte du fournisseur IA est à sec, et le dispositif dit « appel malformé »** — `Your credit balance is too low to access the Anthropic API`, classé `kind: http` = « vraie faute d'appel » | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-05 à 00:00:35** *(volet CODE. La ligne du 05/09 porte `level = DEGRADATION`, nomme l'action — « recharger le compte » —, ne sert plus le texte de facturation à l'utilisateur, garde `motifFournisseur` au contexte, et elle est **SEULE** là où l'incident du 03/09 en produisait deux. **Double condition franchie : le compteur `ERROR` est tombé sans que le total de la famille bouge.** ⚠️ **Volet COMPTE toujours 🤝 HUMAIN — à sec depuis le 03/09 00:13.** Ancien libellé : « ÉCRIT ET COMMITÉ, NON DÉPLOYÉ »)* · **gravité 1** · famille **mensonger** *(**première occurrence en 90 j de rétention**, 03/09 00:13:23, DEUX lignes pour UN appel — `AI_OPTIMIZER` à `.379`, `http` à `.396`. Anthropic facture l'épuisement d'un compte en **HTTP 400 `invalid_request_error`** ; `TRANSIENT_400_PATTERNS` ne connaît que `grammar compilation timed out` et `overloaded`, la ligne tombe donc dans le cas par défaut commenté « Vraie faute d'appel ». Ce n'est ni une faute d'appel ni un aléa passager : c'est une panne de COMPTE, qui se reproduira à l'identique à chaque appel facturé et dont l'action correctrice n'est pas dans le code. ⚠️ **Le message de facturation du fournisseur est servi à l'utilisateur final** — `page: /agenda`, `userAgent: iPhone OS 18_7` : `AiServiceError` hérite de `ServiceUnavailableException`, son message EST le corps de la réponse HTTP, et `describeProviderError` avait été écrit « pour que le CENTRE D'ALERTE porte la cause ». Une seule chaîne, deux publics. ⚠️ **L'écran « Coûts IA » est aveugle** : un appel qui échoue n'écrit aucune ligne dans `ai_usage_logs` — mesuré `ok_24h = 291`, `ko_24h = 0` pendant que l'appel échouait. 🟢 **Portée mesurée et étroite** : les 290 appels de flotte du jour tournent en `executor = local` (agent sur le poste, 0,00 $) et sont INDEMNES ; seuls `agenda_agent` et l'optimiseur de placement passent par `api`)* | 2026-09-03 | 2026-09-03 |
| [TRK-062](#trk-062) | *commandes* | **Une commande partie en SMS n'a aucun état terminal** — `SENT` pour toujours, sans borne supérieure | 🟢 **CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-13 à 20:30:00** (`66d286f5`, migration `20260913200000`, T5) *(au **premier balayage** après le déploiement de 20:25, les 2 commandes SMS du 01/09 (`shock_on` 0592bca9, `shock_off` 2e05d62b, BP-434-RD) portent `SENT_UNCONFIRMED` et `expiredAt = 20:30:00`, après **298,3 h et 294,9 h** ; `cloturerCommandesSmsSansReponse` et `SENT_UNCONFIRMED` vérifiés le 14/09 dans `dist/tracker-commands/` servi ; `commandes_en_attente` rend **0 ligne** — première collecte sans aucun résident. ⚠️ Moitié non exercée : une commande SMS **neuve** doit rester « envoyée » 4 h (`TRACKER_COMMAND_SMS_EXPIRY_MIN = 240`) puis basculer, jamais avant — aucune envoyée depuis)* · **gravité 2** · famille **à lire, pas à notifier** *(conséquence directe du correctif [TRK-021](#trk-021), qui lui est PROUVÉ : les 2 commandes SMS-only du 01/09 sont parties en `channel = SMS` contre 6 sur 6 en `TCP`+`FAILED` avant. Mais le compteur qui tombe a un voisin qui monte — elles ne sont plus `FAILED`, elles sont `SENT` depuis **39 h** et **36 h**. Le choix de ne pas guetter d'accusé est délibéré et bien argumenté — réponse réelle mesurée à **presque 4 h** le 19/08, un guetteur de 15 s fabriquerait un faux échec. **Ce qui manque n'est pas un guetteur, c'est une borne supérieure** : entre 15 s et jamais, le dépôt possède déjà sa référence mesurée. Coût concret : sur les 5 commandes en attente > 10 min, **2 sont des résidents permanents** — le compteur cesse de mesurer un retard pour mesurer une accumulation. ⚠️ **Jumeau exact de [TRK-007](#trk-007)**, « commandes bloquées en `SENT` à vie », corrigé sur le chemin TCP : il n'est pas revenu, un chemin neuf l'a réintroduit sans croiser sa correction)* | 2026-09-03 | 2026-09-20 |
| [TRK-059](#trk-059) | *commandes* | **La « cible atteinte » qui suit un échec porte une AUTRE cible** — le boîtier n’a pas rejoint la cible, c’est la cible qui est descendue jusqu’à lui | 🟢 **CORRIGÉ ET PROUVÉ EN PRODUCTION le 2026-09-05** *(les commandes du 04/09 citent la cible **DEMANDÉE** — « cadence réelle 20 s pour 20 s demandés » à 00:55, « 99 s pour 20 s demandés » à 00:58 — et celles qui suivent un échec NOMMENT le défaut au lieu de le masquer : « **Cible RÉVISÉE 20 s → 99 s après l'échec précédent : la cible demandée a CHANGÉ entre les deux commandes, cette concordance ne prouve pas que le boîtier a suivi une consigne** ». Ancien libellé : « DÉPLOYÉ EN PRODUCTION le 02/09 à 08:03, NON EXERCÉ »)* (`main` @ `24c03b5d`, marqueur `Cible RÉVISÉE` vérifié sur l’artefact SERVI avec son témoin de contrôle ; repli `tracky-api:avant-trk059`) · **gravité 2** · famille **mensonger** *(mesuré le 02/09 sur 7 j : **46 paires « échec puis cible atteinte » séparées de moins de 30 min, et 46 sur 46 portent une cible DIFFÉRENTE** ; délai moyen **6,6 min**. Sur HD-964-XY, GR-898-HY, EZ-259-DB et EY-613-MF, la cadence réelle est le MÊME nombre — 99 s — dans la ligne d’échec et dans celle de réussite. Cause : `desiredIntervalFor` recale la cible quand le véhicule s’arrête (20 s → 99 s), et la clôture par échéance de [TRK-051](#trk-051) compare la mesure à la NOUVELLE cible. Chaque ligne est vraie prise seule ; c’est leur succession qui ment. ⚠️ Ne contredit PAS [TRK-057](#trk-057) : les 44 cibles sont canoniques, le réglage est juste — c’est le récit qu’on en fait qui est faux)*  Correctif : la clôture nomme la RÉVISION de cible au lieu d’affirmer une convergence, et refuse la conclusion sans prétendre à la place du lecteur que le boîtier n’a rien fait — la cadence de l’échec précédent n’est portée par aucune colonne. Statut ACKNOWLEDGED CONSERVÉ (double condition) : sans la clôture les commandes revivraient en `SENT`. 9 tests neufs dont 3 vérifiés EN ÉCHEC sur l’ancien code ; 188 suites / 2 801 tests verts.)* | 2026-09-02 | 2026-09-02 |
| [TRK-060](#trk-060) | `system-metrics` | **La collecte de métriques rend l’erreur de transport BRUTE** — `getaddrinfo EAI_AGAIN tracky-postgres`, sans dire ni ce qui a échoué, ni la conséquence, ni qu’elle est sans gravité | 🟠 **CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`3c36cce0`), NON EXERCÉ** *(marqueur « purge des mesures » vérifié le 05/09 dans `dist/system-metrics/metrics-collector.service.js`. Aucune nouvelle ligne `system-metrics` depuis le 02/09 — le correctif attend une occasion. Ancien libellé : « ÉCRIT ET COMMITÉ, NON DÉPLOYÉ »)* · **gravité 3** · famille **brut** *(une seule ligne, la seule de son espèce en 90 j de rétention. **Conséquence mesurée : 1 437 points de métrique sur les 1 440 attendus en 24 h** — le collecteur `@Interval(60_000)` attrape, enregistre et continue. L’incident est bénin ; le défaut est le message, qui envoie instruire une panne de base qui n’a jamais eu lieu. Le même jour, `trip-analysis` écrit une dégradation exemplaire qui nomme dépendance, conséquence et ce qui survit — le savoir-faire existe dans ce dépôt, il n’est pas appliqué ici. ⚠️ Le correctif doit BORNER : `CRITICAL` au-delà de 5 échecs consécutifs, sinon on remplace un cri par un silence)* | 2026-09-02 | 2026-09-02 |
...
| [TRK-053](#trk-053) | *alertes* | **« Boîtier débranché » ne fait pas taire les alarmes du boîtier** *(📏 17/09 : les 3 déclarations HM-… levées par un humain le 16/09 08:33 — `alertes_depuis_declaration` **7 → 3** par retrait de lignes, pas par disparition d'alertes ; la série repart de 3 ; HM-769-GA alerté `GPS_LOST` 2 min après : la chaîne est revenue)* — `outOfServiceReason` est honoré par tous les détecteurs SAUF le chemin des alarmes, alors que la fiche véhicule promet « alertes suspendues pour ce véhicule » | 🟠 **CORRECTIF DÉPLOYÉ le 2026-09-01 à 09:17, NON EXERCÉ** · **gravité 1** · famille **faux positif** *(mesuré le 01/09 : **7 des 8 alertes `LOW_BATTERY` du 31/08 ont été écrites APRÈS** la déclaration `TRACKER_UNPLUGGED` posée entre 11:36 et 11:39 sur six véhicules rendus en fin de LLD. Le correctif est une garde de DEUX LIGNES : `tracker.vehicle` est déjà chargé entier dans `createFromCobanFrame`, et `power-cut-recheck` fait déjà `include: vehicle`. Aucune requête a ajouter · 🔴 **15/09 — L'OCCASION EST VENUE ENTIÈRE** : `alertes_depuis_declaration` **7, 10ᵉ point** *(les alarmes se taisent bien)* — **mais HM-733-GA et HM-779-GA, déclarés « Retour de LLD », ont été COUPÉS par le planificateur le 14/09 à 22:00 Paris (plannings réarmés par le client), et HM-733-GA rallumé à la main à 23:13**. La déclaration retient les alarmes, **pas l'automatisation horaire**. T9 : lever les trois déclarations ; question produit : une déclaration hors service doit-elle suspendre le planning ?)* | 2026-09-01 | 2026-09-19 |
...
| [TRK-047](#trk-047) | `TRIP_AUTOMATION` | **Le seuil anti-faux-positif est calibré sur la cadence d'ÉMISSION, la grandeur qu'il protège est celle des positions STOCKÉES** | 🟢 **CORRIGÉ, FUSIONNÉ ET DÉPLOYÉ le 25/08** (PR #135) · 📏 **2 occurrences APRÈS correctif, et ce ne sont pas des faux positifs** *(29/08 22:53 GLA•KC•31 — jamais lue, tombée dans les cinq jours sans rapport ; **11/09 09:31 GS-187-NY** : aucune position par horodatage entre 07:11:35 et 09:00:28, le boîtier a rejoué un tampon de deux heures puis n'a rendu que des trames `L` — un trou de 1 h 49 avec des voisins à 20 s dépasse largement 3 × la médiane, *fail-open vers le signal comme écrit*. ⚠️ **Question ouverte** : d'où venait le trajet brut `08:31:12 → 08:35:00`, né sans aucune position ? Il n'existe plus. **Deux points sur une fiche close : à trois, on rouvre.** Ancien commentaire : marqueur servi `trouNormalAuRegimeDeStockage` ×2, aucune ligne `recompute:no-positions` depuis la bascule — mais la fiche ne produisait qu'UNE ligne en 3 jours : l'absence n'est pas encore une preuve. 🗓️ **Test daté à 7 jours** : aucune ligne dont la tranche tombe entièrement dans une plage à contact coupé)* · ancien statut : *(🟠 CORRECTIF PROPOSÉ — PR #135 *(`trouNormalAuRegimeDeStockage` : l'espacement MÉDIAN des positions voisines est MESURÉ (6 de part et d'autre) et le trou ne crie que s'il dépasse 3 × cette médiane ; fail-open VERS LE SIGNAL ; le fait reste compté et la tranche figée ; `STOPPED_THROTTLE_MS` exporté comme LA constante de calibrage)* · ancien statut : *(🔴 NON CORRIGÉ · GRAVITÉ 3 — nouvelle ; 1 ligne le 24/08 08:22:26, GS-878-NX, tranche 07:31:13 → 07:35:00. `FENETRE_MIN_ALERTE_MS = 60_000`, commenté « 60 s = trois fois la cadence » — mais la cadence visée est celle des trames (20 s), alors que la tranche est jugée sur les positions ÉCRITES. Mesuré ce matin-là sur ce véhicule : **11 positions à 06:00, 11 à 07:00, 99 à 08:00**, soit **~5 min d'espacement à l'arrêt** — cinq fois le seuil. Sur 24 h : **178 610 `SKIPPED_THROTTLE` pour 27 787 `INSERTED`**, 87 % des trames volontairement non stockées. ⚠️ **ne pas supprimer l'alerte** — sa branche « anomalie » a une vraie valeur ; c'est le SEUIL qui est faux. ⚠️ ne se répétera pas sur cette tranche : le code fige les trajets juste après avoir alerté)* | 2026-08-25 | 2026-08-25 |
| [TRK-045](#trk-045) | *commandes / débit* | **La commande de cadence arrive enfin — et le boîtier fait l'inverse** : × 2,9 de trames sur toute la flotte, 23 boîtiers à 4–6 s, pour **moins** de positions stockées | 🟢 **CORRIGÉ ET VÉRIFIÉ EN PRODUCTION le 2026-08-25** *(déployé le 24/08 à 06:37 et 07:39. **Les trois mesures qui tranchent, prises à 01:11 UTC** : débit **4 206–4 781 trames/h** la nuit (pic 5 640 à 12:00) contre **19 794/h** au plus fort — et **sous** la référence d'avant l'incident (6 826/h) ; **ZÉRO** trame `,C,NNm` émise après 07:39, la dernière `,C,05m` datant du **24/08 06:30:03**, avant le déploiement ; `HARD_CAP_S = 99` présent dans le `dist/` **servi**, 18 trames `,C,99s` émises. Positions stockées **27 787/24 h**, au-dessus de la référence de 25 713. ⚠️ **le critère « boîtiers à ≤ 6 s » a rendu 1, mais pour la mauvaise raison** : c'est un vestige non rafraîchi, cf. [TRK-048](#trk-048) — ne pas le recompter comme un émetteur rapide)* · ancien statut : *(🔴 NON CORRIGÉ · GRAVITÉ 1 · conséquence directe et non anticipée du correctif [TRK-012](#trk-012). **Débit : 6 826 → 19 794 trames/h**, rampe **monotone** commençant à l'heure exacte du déploiement, chaque boîtier basculant après SA première trame `,C,`. **23 des 32** boîtiers ayant reçu une trame émettent à ≤ 10 s, contre **1 sur 6** parmi ceux qui n'en ont pas reçu. Mesuré au centième sur HD-603-XY : **5,00 s** pour une cible de 20 s. La forme **minutes** échoue **8 fois sur 8** (`,C,05m;` → 4–6 s) ; la forme secondes est mitigée (9 honorent, 15 s'effondrent) — piste sérieuse, **pas** une explication complète. Coût : × 2,9 de données SIM sur 43 cartes et d'écritures `wire_logs` sur un VPS à 2 cœurs, pour des positions stockées **en baisse** (25 713 → 20 225). 🔑 **La plateforme allait mieux quand ses commandes étaient ignorées.** ⚠️ **ne pas juger au compteur FAILING** — il dépend de l'heure de la mesure (garde V1.19 : émettre vite EN MOUVEMENT est exonéré) ; les grandeurs stables sont le **débit/heure** et le **nombre de boîtiers à ≤ 10 s**. ⚠️ **ces boîtiers ne se réparent pas seuls** : `AUTO_ALIGN_FLOOR_S` = 20 s refuse d'accepter 5 s, et `requestChange` cesse d'émettre vers un boîtier FAILING)* | 2026-08-24 | 2026-08-24 |
...
| [TRK-037](#trk-037) | `trip-analysis` | **Overpass (OpenStreetMap) injoignable** — les excès de vitesse ne sont plus affirmés, et l'analyse est rendue **sans mention de la lacune** | 🔵 TERRAIN / dépendance tierce *(nouvelle ; 6 occurrences le 20/08, HTTP 500 ×4 / 502 ×2, sur le miroir **public et gratuit** `overpass.kumi.systems`. Le code est soigné — cache, lots, plafond, backoff, et `trouvee === false` non mémorisé. **Ce n'est pas un défaut de fabrication : c'est une dépendance sans repli.** ⚠️ **sa date de première apparition est INCONNAISSABLE** — la plus ancienne ligne survivante de la table **est** l'une d'elles, cf. [TRK-035](#trk-035))* | 2026-08-21 | 2026-08-22 · 🟢 **26/08 — DÉPLOYÉ à 05:55 : LE BRUIT NE COMPTE PLUS COMME UN DÉFAUT** *(niveau `DEGRADATION` : la ligne reste écrite, consultable et rendue à part, mais elle sort du compte des erreurs à traiter — **14 des 18 lignes actives** du 26/08 étaient de cette espèce. Aucune migration. ⚠️ Les 15 lignes DÉJÀ en base restent `ERROR` : le correctif vaut pour les lignes à venir, il ne réécrit pas l'historique)* | 2026-08-21 | 2026-09-19 |
...
| [TRK-026](#trk-026) | `sms-heartbeat` | La sonde chargée d'annoncer la panne du canal de secours **ne pouvait pas rendre « en panne »** | 🟢 **RÉSOLU le 24/08** — les trois maillons posés · 🔵 **4ᵉ MAILLON TOUJOURS NON PROUVÉ le 25/08** *(⚠️ statut d'index périmé rectifié. Le premier verdict réel est tombé le **24/08 07:20** et il dit `INDETERMINE` — **c'est le résultat ATTENDU, pas un échec**. Le maillon manquant est *qu'un webhook ABONNÉ soit un webhook REÇU*, et il reste sans matière : **aucun SMS sortant depuis le 24/08 07:00**, passerelle à **365 `queued`**, côté Tracky **363**. ⚠️ **`queued` sur 0 message envoyé n'est pas un échec du correctif** — ne pas rouvrir la fiche sur une absence de matière ; reporter au premier SMS réellement émis)* | 2026-08-17 | 2026-08-25 |
...
| [TRK-018](#trk-018) | *coupe-circuit* | Repli SMS : commandes moteur `SENT`, **0 confirmée**, aucun accusé de remise jamais écrit | 🟠 **LES QUATRE CORRECTIFS SONT ÉCRITS** — 1 à 3 **déployés et vérifiés le 25/08**, **nº 4 (l'écran) DÉPLOYÉ le 26/08 à 05:57** *(✅ **test daté RÉPONDU le 26/08, double condition satisfaite** : `SENT` 313 → **0** et `SENT>24 h` 307 → **0**, SANS que les coupures demandées baissent — 40 le 25/08, 73 le 24/08. Les 316 lignes portent désormais `SENT_UNCONFIRMED` — « nul ne sait » — au lieu de pourrir en « envoyé ». Rythme en baisse : 10 · 4 · 6 · 9 · 7 · 6 · 6 · 6 · **2** non confirmées/jour. 🟢 **Écran `/admin/immobilisations`** : cloisonné fail-closed, `FAILED` exclu, LECTURE SEULE, 10 tests neufs)* | 2026-08-11 | 2026-08-26 · 🟠 **MAIS LA VÉRIFICATION PRESCRITE PAR LA FICHE RESTE NON SATISFAITE** *(elle exige qu'« au moins un message porte un état postérieur à `queued` » — la passerelle n'en a jamais écrit un seul. Les quatre correctifs sont livrés ; la chaîne SMS reste **non prouvée**. C'est pourquoi la fiche NE se ferme pas)* | 2026-08-11 | 2026-08-26 |
...
| [TRK-016](#trk-016) | *trajets* | Recalage cartographique en échec sur 9 trajets sur 10 | 🔴 NON CORRIGÉ *(✅ **18/09 — LE TEST DATÉ EST FRANCHI AU MOT PRÈS** : 15/09 = **222 / 222 / 192 / 0 / 0** (prédit la veille), 14/09 = 250 **3/3**, 16/09 **figé** (`O`) à **216** — 212 à fenêtre ouverte, +4 créés avant J+2 comme la définition le prévoit ; **100 % recalé < 2 h depuis la création** sur les trois journées (688/688) — **T28 prouvé**)* *(📏 **17/09 — LA JAUGE EST FIXÉE, ET ELLE DIT 100 %** : `recalage_journees_closes` gagne `fenetre_recalcul_close` (une journée civile de Paris J reste dans la fenêtre `lookbackHours` = 26 h du recalcul jusqu'à **J+2 00:00 UTC** — c'est pourquoi le 15/09 rendait 273 le 16/09 et 222 le 17/09 : 71 trajets supprimés, 20 recréés dans la journée ; le 14/09, déjà sorti, rend 250 deux fois) et `cloture_moins_2h_depuis_creation` (délai depuis `greatest(endedAt, createdAt)` : un trajet recréé signé `cloture` porte un délai de 1 586 min depuis sa fin, pas depuis sa création) → **250/250, 222/222, 212/212 recalés dans les deux heures suivant la création**. Le flux neuf est réparé depuis le 08/09 ; ce qui bougeait, c'était la mesure. Rattrapage 1 049 traces, 5 185 restants · **91,9 %** le 22/08 (204/222). Série ouvrée : 90,2 · 88,7 · 91,3 · 87,0 · 89,3 · 91,1 · **91,9** — le creux à 87,0 ne s'est pas confirmé. ✅ **Définition contrôlée le 22/08** : sur les trajets *démarrés* dans les 24 h (198), le taux est **92,4 %** — le recalcul de masse de [TRK-034](#trk-034) gonfle le dénominateur mais **ne fausse pas l'instrument**. 🔴 **2026-09-09 — LE FLUX NEUF EST RÉPARÉ ET L'INSTRUMENT, LUI, A CESSÉ DE MESURER.** La fenêtre 24 h rend **0,0 %** d'échec (186 trajets, 0 sans recalage, témoin impossible posé : longueur **minimale 265** caractères, aucun vide) contre 85,5 % la veille — **mais le 07/09 lui-même est passé de 85,5 % à 1,2 % pour LES MÊMES trajets**, recalés **après leur clôture** par le rattrapage `recalerAnciensTraces` ou le recalage à la demande du rejeu. *Un taux sur `polylineMatched IS NULL` en fenêtre glissante mélange désormais ce que le recalage fait à la clôture et ce que le rattrapage fait rétroactivement : la série de dix points **ne se prolonge pas** par ce 0,0 %.* 🔴 **Et `trips` n'a pas d'`updatedAt`** — une colonne de qualité réécrite rétroactivement et **sans horodatage** rend toute tendance indécidable. **Statut MAINTENU 🔴** : il reste **8 882 trajets d'historique** non recalés (1 150 sur 10 032 déjà faits) et la mesure qui prononcerait la clôture est cassée. 👉 tâche neuve **T28** · 📏 **15/09** : la journée du 13/09 est **retrouvée à l'identique — 86 / 86 / 66 / 20 / 0** (re-mesure 1 sur 2, T28) ; le **14/09 = 244 / 244 / 233 / 0 / 0**, première journée sans « origine inconnue », délai moyen 42 min, max 197 *(passages de 50–59 min)* ; rattrapage **435 traces** (+255 = 17 × 15), **6 139 restants** sur 2–60 j)* | 2026-08-09 | 2026-09-15 |
| [TRK-015](#trk-015) | *ingestion* | Positions réelles écartées par le garde-fou anti-téléportation | 🟢 **CORRIGÉ ET DÉPLOYÉ le 24/08** (PR #124) · **DOUBLE CONDITION VÉRIFIÉE le 25/08** *(⚠️ statut d'index périmé rectifié — il portait encore « NON CORRIGÉ » alors que la fiche et l'artefact disent le contraire depuis le 24/08. Marqueur `RECOVERED_BUFFER` présent dans le `dist/` servi. **Les deux compteurs vivent, et c'est ce qui compte** : `RECOVERED_BUFFER` **461** — on récupère — ET `SKIPPED_REPLAY` **2 789** — on écarte toujours les vrais fantômes. *Si les deux étaient tombés ensemble, on aurait supprimé la fonctionnalité et non le défaut.* ⚠️ ne pas juger la valeur du correctif au volume quotidien : elle est dans les **rafales** de coupure réseau, pas dans le flux)* · ancien statut : *(🔴 NON CORRIGÉ — **test daté RÉPONDU** : rejets 5497 → **2465**, le 15/08 était UNE JOURNÉE. La baisse d'insertions s'explique par le **week-end** (73 trajets dimanche vs 195 vendredi), pas par le garde-fou. 317 rejets = rejeu de tampon de HD-779-MA)* | 2026-08-08 | 2026-08-22 |
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 3** · famille **angle mort** · 2026-08-23 »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · ~72/jour · 507 sur 7 jours · **3564+ au total** · découvert 2026-08-03 · **en extension »)*
...
**Statut : 🟢 CORRIGÉ ET DÉPLOYÉ le 2026-08-23** (PR #110) · **preuve terrain acquise le 24/08** ·
découvert 2026-08-05

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — cet en-tête affichait encore « 🔴 NON CORRIGÉ », **figé au 10/08**.
> Vérifié le 25/08 par le CODE DÉPLOYÉ : le commit de la PR #110 est un ancêtre de `HEAD`, donc en
> production. Le transport est réparé — les trames sortantes portent `**,imei:…,C,05m;` et, pour la
> première fois en quatre mois, les boîtiers changent de cadence après réception. ⚠️ Cet effet a
> produit [TRK-045](#trk-045), corrigé et vérifié le 25/08 (débit revenu **sous** la référence
> d'avant l'incident). *Le corps de cette fiche n'avait jamais été mis à jour par la campagne du
> 23/08 : c'est la source la plus périmée des trois.*
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ le 2026-08-23 (PR #111) ET EXERCÉ** · découvert 2026-08-06

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — en-tête figé au 10/08. PR #111 vérifiée ancêtre de `HEAD`.
> **Exercé et juste** : le 24/08, 5 clôtures `ACKNOWLEDGED` « Cible atteinte », dont **17 s pour
> 20 s demandés** — exactement le cas que la bande ±20 % devait sauver. Mesure du 25/08 : depuis le
> correctif, **115 acquittements** contre 93 échecs. La clôture COMPARE désormais avant d'affirmer.
...
> ⚠️ **Statut MAINTENU au 2026-09-09, et il faut dire pourquoi.** Le **flux neuf est réparé** — 0 %
> d'échec sur les trajets clôturés depuis le 08/09 — mais **la fiche n'est pas close** : il reste
> **8 882 trajets d'historique** non recalés, et surtout **la mesure qui prononcerait la clôture ne
> mesure plus ce qu'elle mesurait** *(section datée ci-dessous)*. Le vocabulaire des statuts n'a pas
> de case « réparé à l'avant, pas à l'arrière » ; **entre les deux, on garde le plus prudent**.

> ### Une fonctionnalité qui échoue neuf fois sur dix depuis quatre mois n'est pas dégradée, elle est absente.

---

### 🔴 2026-09-09 — LA MESURE A CESSÉ DE MESURER CE QU'ELLE MESURAIT

**Le chiffre brut de ce jour induit en erreur, et c'est le seul point du passage où il faut refuser
la bonne nouvelle telle qu'elle se présente.**
...
265** caractères, moyenne **20 188**, maximum **79 967**. *Ce sont de vraies géométries : un 0 %
obtenu par une colonne remplie de chaînes vides aurait exactement la même tête.*
...
Ils ont été recalés **après leur clôture** — par le rattrapage `recalerAnciensTraces` (15 par passage,
déployé à 17:12), par le recalage à la demande du rejeu (`c2afb01f`), ou par les deux.

> 🔑 **Un taux calculé sur `polylineMatched IS NULL` dans une fenêtre glissante mélange désormais
> deux choses** — ce que le recalage fait **à la clôture** et ce que le rattrapage fait
> **rétroactivement**. La série de dix points (91,3 · 87,0 · 89,3 · 91,1 · 91,9 · 89,2 · 83,3 · 87,9
> · 87,2 · 85,5) **ne se prolonge pas par ce 0,0 %** : la définition a changé sous elle.
...
**Ce qui reste vrai et mesurable — le stock d'historique ne se réécrit pas tout seul :**
...
🗓️ **Consigne datée pour le 10/09** — à 15 trajets par passage et 24 passages, le rattrapage doit
porter ce chiffre à **~1 510**. *S'il ne bouge pas, le rattrapage ne tourne pas ; s'il bondit très
au-delà, c'est qu'un autre chemin recale en masse et il faut le nommer.*

👉 **Tâche neuve `T28` : redéfinir la mesure.** Un taux de recalage doit se prendre **à la clôture du
trajet**, sur une fenêtre **fermée**, et non sur une colonne que le rattrapage réécrit. *Sans ça,
personne ne peut dire si `T13` est fait — ni aujourd'hui, ni dans trois semaines.*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **25 numéros sur 41 effacés puis recréés en boucle, dont 24 SIM de boîtier · 8 occurrences · découvert 2026-08-10** *(épisodes des 2026-08-09 20:25 / 22 »)*

> ### ⚠️ 2026-09-01 — la signature réapparaît, à un vingt-cinquième de son amplitude, et se répare seule
>
> Une ligne le **30/08 23:25:00** : « **1** numéro(s) manquant(s) rétabli(s) », `episodeRepairs: 1`,
> `removalsBlocked: 0`. La fiche étant 🟢, le §6 de la procédure impose de traiter toute réapparition
> comme une **régression** et de l'instruire. Elle l'a été.
>
> **Les huit réconciliations horaires suivantes (00:25 → 07:25 le 01/09) rendent toutes :**
>
> ```json
> {"added": 0, "removed": 0, "skipped": 0, "unchanged": 46, "episodeRepairs": 0, "removalsBlocked": 0}
> ```
>
> **32 heures sans un seul rétablissement, sur 46 numéros** — contre 25 numéros effacés en boucle
> plusieurs fois par jour au plus fort de la fiche. Un rétablissement isolé d'**un** numéro est le
> comportement normal du cron quand la liste poussée gagne une entrée.
>
> 🗓️ **Test daté :** si une **deuxième** ligne `sms-allowlist` apparaît avant le **08/09**, ou si
> `removalsBlocked` devient non nul, **rouvrir cette fiche en 🔴** — deux épisodes ne sont plus un
> rattrapage d'ajout. Sinon, l'épisode du 30/08 reste classé comme tel et le statut ne bouge pas.
> *Une réapparition isolée n'est ni une régression prouvée ni un non-événement : c'est un point de
> mesure, et il en faut un second pour trancher.*
...
**Statut : 🟠 LES QUATRE CORRECTIFS SONT ÉCRITS — 1 à 3 DÉPLOYÉS le 2026-08-24, nº 4 (l'écran) ÉCRIT ET TESTÉ le 2026-08-26, NON DÉPLOYÉ** (PR #129 + [TRK-026](#trk-026)) ·
✅ **TEST DATÉ RÉPONDU le 26/08, double condition satisfaite** ·
*ancien statut : 🟠 correctif nº 4 non livré · preuve terrain en attente des coupes de 18:00 UTC* ·
découvert 2026-08-11 · **re-mesuré le 24/08 : 313 commandes `SENT`, 307 de plus de 24 h, 0 acquittée**

---

## ✅ 2026-08-26 — le test daté répond OUI, et l'écran est écrit

### La double condition, relevée séparément
...
**Le garde-fou de la fiche est satisfait** : le nombre de `SENT` de plus de 24 h tombe à zéro
**sans** que les coupures demandées aient baissé — 40 le 25/08, 73 le 24/08, 37 le 23/08.
*Si les deux étaient tombés ensemble, on aurait supprimé la fonctionnalité, pas le défaut.*
Les 316 lignes n'ont pas disparu : elles portent désormais « **nul ne sait** » au lieu de
pourrir en « envoyé ».

⚠️ **Le rythme baisse aussi** : commandes non confirmées par jour — 10 (17/08), 4, 6, 9, 7, 6,
6, 6, **2** (25/08). Le TCP répond mieux depuis [TRK-012](#trk-012)/[TRK-045](#trk-045), donc
le repli SMS sert moins.

### 🟢 Correctif nº 4 — l'écran, écrit et testé le 26/08

`GET /engine-control/unconfirmed` + écran `/admin/immobilisations` (carte dans le hub admin).
Résumé (total, 24 h, 7 j, ventilation par canal, véhicules concernés), regroupement par
véhicule, 60 plus récentes.

- **Cloisonnement** par `resolveTenantScope`, **fail-closed** : un non-super sans flotte ne voit
  rien, et la base n'est même pas interrogée. Deux tests le verrouillent dans les deux sens.
- **`FAILED` est explicitement EXCLU** de la requête. *« A échoué » et « nul ne sait » ne sont
  pas la même information*, et l'écran ne prononce jamais le mot « échec ».
- **LECTURE SEULE** — aucun bouton « marquer comme confirmée ». Un test vérifie qu'aucune
  écriture n'a lieu : acquitter d'office ferait disparaître ces lignes et supprimerait la seule
  trace de la question.

> 🔑 **Un fixture a failli faire passer le test pour une raison fausse** : il donnait le même
> `vehicleId` à deux plaques différentes, donc le regroupement les fusionnait. Le code groupait
> juste ; c'est le test qui mentait. *Corrigé — l'identifiant suit la plaque.*

**10 tests neufs.** API 183 suites / 2 736 tests verts, `typecheck`, `ng build`.
...
**Statut : 🟢 CORRIGÉ ET VÉRIFIÉ EN PRODUCTION le 2026-08-26** · 2026-08-12 · ancien statut : *🟠 CORRECTIF PROPOSÉ*

> 🟢 **26/08 — APPLIQUÉ.** Les deux colonnes sont désormais nommées et rendues **séparément** dans `commandes_sante_7j` : `acquittees_boitier` (`ackResponse`), `horodatage_boitier` (`ackedAt`) et `acquittees_humain` (`acknowledgedAt`). `commandes_en_attente` exige en plus que **les deux** soient nuls — filtrer sur le seul `acknowledgedAt` laissait passer une commande déjà acquittée par le boîtier.
>
> **Vérifié en production le 26/08 à 04:26 UTC** : `fix_continuous` rend `acquittees_boitier = 0` sur **510** commandes, `raw` en rend **2 sur 2**. *La réserve qui bloquait ce correctif — « il modifie la définition d'une grandeur suivie depuis neuf passages » — est levée par [TRK-051](#trk-051) : c'est précisément cette ambiguïté qui a failli faire refermer [TRK-014](#trk-014) deux passages de suite.*
...
>
> Mesure de ce jour sur 30 jours de `tracker_commands`, colonne `channel` comprise :
>
...
> | … | *(5 lignes de plus, toutes `TCP`, toutes `FAILED`)* | | | |
>
> **Les huit sont ANTÉRIEURES au correctif du 23/08.** Les deux seules commandes hors
> `fix_continuous` depuis sont deux `raw` du 24/08 — les canaris de [TRK-045](#trk-045). Le
> correctif n'a donc jamais rencontré le cas qu'il traite.
>
> ⚠️ **Et il bloque autre chose** : le volet 3 de [TRK-022](#trk-022) — provisionner le seuil de
> survitesse sur les 42 véhicules muets — **exige** que cette fiche soit prouvée, faute de quoi les
> 42 commandes partiront en TCP et expireront comme les huit ci-dessus.
>
> **Le geste, une minute :** émettre un `shock_on` depuis `/admin/trackers/:id` sur un boîtier
> vivant, puis lire une colonne — **preuve attendue : `channel = 'SMS'`**. Si c'est encore `TCP`,
> le correctif est faux et cette fiche repasse en 🔴 le jour même.

> 🧹 **Statut RECTIFIÉ le 2026-08-25**, dans les DEUX sens. L'index disait « 🔴 NON CORRIGÉ »
> (périmé : la porte SMS-only du lot B est en production, PR #110 ancêtre de `HEAD`) ; `wiki.json`
> disait « CORRIGÉ » (trop optimiste : rien ne l'a prouvé). **Mesure du 25/08 : AUCUN essai de
> template SMS-only depuis le correctif** — les derniers datent du 15/08 (4 `sensitivity` + 4
> `shock_on`, tous en échec). *Le test daté ne s'est toujours pas déclenché : ce n'est pas une
> amélioration, c'est un oubli d'essayer.*
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-08-19 — volet 1 EXERCÉ ET PROUVÉ le 2026-09-01, volets 2 et 3 ENTIERS** · découvert 2026-08-13

> ### ✅ 2026-09-01 — le volet 1 est enfin exercé, et le facteur est de mille
>
> `OVERSPEED` par jour sur FG-669-DQ, le seul véhicule du parc qui en produise :
>
...
> 13:52 ; 31/08 : 06:13 puis 13:27) : la fenêtre de 6 h est respectée au détail près.
>
> ⚠️ **Trois réserves, et aucune n'est mineure :**
> 1. **le volet 2 est intact** — 1 657 alertes `OVERSPEED` sur 30 j, **1 seul véhicule sur 44**.
>    42 boîtiers restent incapables d'alerter et rien à l'écran ne le dit ;
> 2. **l'enrichissement n'a pas été fait** — les messages disent toujours « Vitesse détectée :
>    135 km/h », sans durée ni maximum d'épisode, ce que cette fiche exigeait ;
> 3. 🔴 **la garde est conditionnelle et personne ne le savait** — voir [TRK-052](#trk-052) :
>    elle ne tient que tant qu'aucun exploitant n'acquitte pendant l'épisode. *Ce qui vient d'être
>    prouvé, c'est que la garde fonctionne quand on la laisse tranquille.*

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — l'index affichait « 🟢 CORRIGÉ », ce qui est trop
> affirmatif : la déduplication (`DEDUP_ALARME_MS` = 6 h, tous types d'alarme) est bien en ligne
> depuis le 19/08, mais **rien n'est venu la déclencher**. Mesure du 25/08 : **38 alertes en 7 jours,
> 5 types, aucune rafale**. *Un correctif jamais exercé n'est pas un correctif vérifié.*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 2** · 1 occurrence · découvert 2026-08-19 »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRIGÉ, NON DÉPLOYÉ** *(commit `e88a5eec`, branche `fix/trk-032-borne-coupure-commandee`, partie d'`origin/main` @ `42dcdb38` — **poussée sur `origin`, sans PR ni fusi »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRIGÉ, NON DÉPLOYÉ** *(commit `435e65f2`, branche `fix/trk-036-accuse-sms-rattache`, partie d'`origin/main` — **poussée sur `origin`, sans PR ni fusion** *(rectifié l »)*
...
## 🔎 2026-08-25 *(après-midi)* — le volume de journalisation est expliqué, et la « fenêtre qui rétrécit » n'a jamais existé

L'audit du matin mesurait ~4,7 Mo/j (contre 1,4 estimés) et en déduisait « fenêtre d'enquête
≈ 3 jours au lieu de ~21 ». **Enquête refaite sur une fenêtre de 8 h 29 : le chiffre est bon,
la causalité était fausse.**

### Les trois faits mesurés

1. **Chaque connexion écrit DEUX lignes** (`connection received` + `connection authorized`) —
   3 515 + 3 515 lignes en 8 h 29, soit **67 % du fichier**. L'estimation de 1,4 Mo/j comptait la
   seule sonde `pg_isready` (2 880 connexions/j) ; en réalité **l'API ouvre ~5-7 connexions/min**
   (~8-10 000/j), avec des pics alignés sur les crons de 5 min (9 à 08:10, 14 à 08:20).
2. **La cause du churn est la configuration Prisma par défaut** : `DATABASE_URL` ne porte ni
   `connection_limit` (→ pool = 2 × cœurs + 1 = **5** sur ce VPS), ni `application_name`
   (→ attribution impossible dans les journaux — la sonde, elle, se nomme). Les rafales de crons
   gonflent le pool, le moissonneur interne ferme les connexions oisives (~300 s), la rafale
   suivante rouvre. Structurel, pas une fuite : `pg_stat_activity` montre 3 connexions au repos.
3. 🎯 **LA PIÈCE SUBTILE : la fenêtre n'a JAMAIS été de ~21 jours.** `/etc/logrotate.d/docker-containers`
   fait tourner **tous** les journaux de conteneurs de l'hôte **chaque jour** avec `rotate 3`
   (+ `copytruncate`, `maxsize 50M`). La fenêtre est de **3-4 jours pour tout conteneur, quel que
   soit le volume** — les bornes Docker (`max-size=10m/max-file=3`) ne sont qu'un second plafond.
   La hausse de volume ne rétrécit rien : elle ne menace que le seuil `maxsize 50M`, très loin.

*(Bruit annexe identifié : une requête en ERREUR journalise son STATEMENT complet même avec
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRIGÉ, NON DÉPLOYÉ** *(commit `638d16aa`, branche `fix/trk-034-fenetre-recalcul`, partie d'`origin/main` — **poussée sur `origin`, sans PR ni fusion** *(rectifié le 2 »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRIGÉ, NON DÉPLOYÉ** *(commit `b28e389e`, branche `fix/trk-031-episodes-gps-bornes`, partie d'`origin/main` — **poussée sur `origin`, sans PR ni fusion** *(rectifié l »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 2** · 1 occurrence · découvert 2026-08-18 *(Première ligne de source `schedule-cron` depuis l'ouverture du référentiel le 28/07.) »)*
...
**Statut : 🟢 CORRIGÉ, EXERCÉ ET VÉRIFIÉ le 2026-08-21** · ouvert 2026-08-17

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — en-tête figé au 18/08, quand le raccroc n'avait pas
> encore tourné. Il a été **exercé puis vérifié le 21/08** : épisodes refermés 14 → **35**, médiane
> de la zone parking **0,78 j**, et **0 durée fabriquée sur 35** (contre 13 sur 20 auparavant).
> L'écran dit enfin la vérité qu'il promettait.
...
**Statut : 🔵 TERRAIN — TROU ASSUMÉ, garde-fou à écrire** · **contrepartie connue de la règle du
parking** · ouvert 2026-08-17

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — l'index le donnait « 🟢 CORRIGÉ », ce qui est faux :
> rien n'a été corrigé, c'est une **contrepartie assumée**. Le garde-fou qui la refermerait est
> toujours à écrire, et son prérequis reste bloquant — l'état du CONTACT n'est pas persisté sur les
> trames `no_fix` (`tcp-server.service.ts` n'y écrit que `lastSeenAt` et `lastNoFixAt`), donc
> `lastKnownIgnition` reste figé pendant toute la perte.
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ le 2026-08-23 (PR #113) ET VÉRIFIÉ le 25/08** · découvert 2026-08-14

> 🧹 **Statut RECTIFIÉ le 2026-08-25** — en-tête figé au 16/08. PR #113 (« l'écriture OFFLINE
> devient conditionnelle : fraîcheur dans le `WHERE`, même instruction ») vérifiée ancêtre de `HEAD`.
> **Mesure directe du 25/08 à 19:2x : 0 boîtier `OFFLINE` ayant émis dans les 15 dernières minutes**
> — le défaut n'est plus réalisé. C'est une mesure, pas une déduction.
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **42 038 alertes sur 51 524 (81,6 %)** · découvert 2026-08-13 sur 1 occurrence, **élargi le 2026-08-14 »)*
...
> ### ✅ 2026-09-01 — le test daté du 26/08 est RÉPONDU, sans exception sur six jours
>
> La consigne écrite le 26/08 était : *« la PROCHAINE ligne Overpass doit porter
> `level = 'DEGRADATION'` — et ne plus compter comme un défaut »*. Mesure de ce jour :
>
> | `source` | `level` | n | actives | dernière |
> |---|---|---|---|---|
> | `trip-analysis` | **`DEGRADATION`** | **22** | 22 | **01/09 01:45:16** |
> | `trip-analysis` | `ERROR` | 16 | **0** | **26/08 04:47:19** *(soit avant la bascule de 05:55)* |
>
> **Aucune ligne `ERROR` de cette famille depuis le déploiement, 22 en `DEGRADATION` depuis.** La
> bascule est nette, datée, sans exception sur six jours et 22 occurrences.
>
> 🔑 **Et le correctif ne cache rien** : les 22 lignes sont écrites, actives, horodatées et
> consultables — elles ne comptent simplement plus comme des défauts. *On nomme, on ne masque pas*,
> et c'est vérifiable : `volumetrie` rend `defauts_actifs = 4` **et** `degradations = 22`, jamais
> l'un sans l'autre.
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 3** · découvert 2026-08-21 *(en enquêtant sur [TRK-037](#trk-037)) »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 2** · découvert 2026-08-21 »)*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 2** · 1 cas mesuré, 1 boîtier perdu · 2026-08-21 »)*

> ### ✅ 2026-09-01 — exercé SIX FOIS le même matin, et il a eu raison six fois
>
> Le 31/08 entre 08:15 et 09:30 UTC, la confirmation par la pente a produit **six** `POWER_CUT`
> `CRITICAL` — « coupure **CONFIRMÉE au réexamen** : batterie passée de 100 % à 86-89 %… l'examen
> initial avait classé "contact coupé" ». C'est précisément le cas que cette fiche décrit : un
> soupçon ouvert à batterie pleine, verdict différé, puis tranché par la **pente**.
>
> **Les six se sont vérifiées matériellement** : `lastBatteryPercent = 0` pour les six, chacun
> devenu muet entre 11:53 et 13:50, dans l'ordre exact où il avait été coupé. **Zéro faux positif
> sur six cas**, et zéro cas manqué : aucun autre boîtier de la flotte n'est tombé ce jour-là.
>
> | Véhicule | `POWER_CUT` | Dernière trame | Batterie |
> |---|---|---|---|
> | FS-253-HR | 08:15:45 | 11:53:43 | 0 % |
> | FS-808-CE | 08:35:45 | 12:30:40 | 0 % |
> | FZ-731-YF | 08:45:45 | 12:48:28 | 0 % |
> | FZ-862-VY | 09:00:45 | 13:15:45 | 0 % |
> | FW-298-WV | 09:25:45 | 13:50:25 | 0 % |
> | FR-629-AD | 09:30:45 | 13:50:47 | 0 % |
>
> 🔑 **C'est le premier exercice de ce correctif à cette échelle, et le plus concluant possible :**
> la version d'avant aurait classé les six en « contact coupé » et n'aurait rien dit — six véhicules
> se seraient éteints en silence. *Le seul reproche qu'on puisse faire à cette alerte est qu'elle
> n'a rien empêché, mais ce n'était pas son travail.*
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🔴 NON CORRIGÉ** · **gravité 2** · lié à [TRK-017](#trk-017) et [TRK-025](#trk-025) · 2026-08-22 »)*
...
>
> | Véhicule | Cible | Cadence mesurée | Dernière trame `,C,` réellement reçue |
> |---|---|---|---|
...
>
> **Le modèle de cette fiche prédit 99 s pour `,C,99s;`**, et il avait été validé au canari le 24/08
> (six écarts de 99 s pile sur BP-434-RD). Trois boîtiers sur quatre rendent ici **2 à 7 s**.
>
> Second fait, indépendant : **un cycle quotidien identique**, aux mêmes heures les 30 et 31/08 —
> chacun reçoit un `,C,20s;` puis un `,C,99s;` quelques minutes ou quelques heures plus tard. Et le
> motif d'échec dominant de la semaine dit l'inverse du tableau : « cadence réelle **99 s** pour
> **20 s** demandé » (~29 occurrences), contre 8 en « 2-3 s pour 20 s ou 99 s demandés ».
>
> ⚠️ **Deux lectures restent ouvertes et rien ne les départage** : le boîtier applique la commande
> **précédente** (un cran de retard), ou l'auto-alignement oscille et mesure entre deux régimes.
> **Ce qui est certain** : cible et mesure se contredisent dans les deux sens, sur les mêmes
> boîtiers, tous les jours.
>
> ✅ **Et ce n'est PAS un déluge** — il faut le dire aussi nettement : le débit global est de
> **≈ 90 000 trames / 24 h pour 32 émetteurs**, soit **2 813 par émetteur**, *en dessous* des
> 3 300/émetteur du 26/08. Les quatre boîtiers concernés émettent 3 420 à 4 557 trames/24 h, dans
> la fourchette du reste du parc. *C'est un défaut de pilotage, pas encore un défaut de facture.*
>
> 🗓️ **Test daté — un troisième canari** : émettre `,C,99s;` en commande brute sur **GR-294-VW**
> (mesuré à 2 s) et relever les douze écarts suivants dans `wire_logs`. **99 s** ⇒ le boîtier obéit
> et c'est l'auto-alignement qui le dérègle ensuite ; **2 s** ⇒ le modèle est incomplet et cette
> fiche doit être rouverte.
...
**Signature** — *(aucune ligne d'erreur — une SÉQUENCE de deux commandes)*
...
**Statut : 🟢 CORRIGÉ ET PROUVÉ EN PRODUCTION le 2026-09-05** · **gravité 2** · famille **mensonger** · 2026-09-02 → 2026-09-05 · *anciens statuts : 🔴 NON CORRIGÉ, puis 🟠 corrigé et testé non déployé, puis 🟠 déployé le 02/09 à 08:03 non exercé*

> ✅ **Exercé et prouvé le 2026-09-05.** Les deux commandes `fix_continuous` du 04/09 (00:55:42 et
> 00:58:46) citent la cible **DEMANDÉE** : « cadence réelle **20 s pour 20 s demandés** » et « 99 s
> **pour 20 s demandés** ». Et les commandes qui suivent un échec **nomment le défaut au lieu de le
> masquer** : « *Cible RÉVISÉE 20 s → 99 s après l'échec précédent (il y a 6 min) : cadence réelle
> 99 s. La cible demandée a CHANGÉ entre les deux commandes — cette concordance ne prouve pas que le
> boîtier a suivi une consigne.* » *C'est exactement la phrase que la fiche réclamait.*
...
En relisant le journal des commandes après les correctifs du 01/09, pour vérifier que
[TRK-056](#trk-056) et [TRK-057](#trk-057) tenaient. Deux lignes consécutives sur **HD-964-XY** —
le boîtier de référence de TRK-057 — se contredisaient à cinq minutes d'intervalle :

```
02/09 00:28:24  FAILED        « Sans effet constaté après 32 min : cadence réelle 99s pour 20s demandés »
02/09 00:33:29  ACKNOWLEDGED  « Cible atteinte : cadence réelle 99s pour 99s demandés »
```

**La cadence réelle est le même nombre des deux côtés : 99 s.** Le boîtier n'a pas bougé d'une
seconde entre l'échec et la réussite. Seule la **demande** a changé.

### Ce qui est mesuré

Définition : *un `FAILED` suivi d'un `ACKNOWLEDGED` sur le même boîtier en moins de 30 minutes*,
sur les sept derniers jours, template `fix_continuous`.

| | |
|---|---|
| Paires trouvées | **46** |
| Dont la cible a **changé** entre l'échec et la réussite | **46** |
| Dont la cible est **restée la même** | **0** |
| Délai moyen | **6,6 min** |

| Boîtier | Échec | Cinq minutes plus tard |
|---|---|---|
| HD-964-XY | `99s réel / **20s** demandé` | `99s réel / **99s** demandé` |
| GR-898-HY | `99s réel / **20s** demandé` | `99s réel / **99s** demandé` |
| EZ-259-DB | `99s réel / **20s** demandé` | `99s réel / **99s** demandé` |
| EY-613-MF | `99s réel / **20s** demandé` | `99s réel / **99s** demandé` |
| AL-927-QM | `100s réel / **20s** demandé` | `100s réel / **99s** demandé` |
| GS-138-LT | `99s réel / **20s** demandé` | `99s réel / **99s** demandé` |

> 🔑 **Quarante-six sur quarante-six.** Sur sept jours, il n'existe **pas un seul cas** où un
> boîtier ait échoué puis réussi *sur la même demande*. Toute « réussite » qui suit un échec porte
> une autre cible.

### Cause racine

**Deux écritures correctes qui, mises bout à bout, mentent.**

`desiredIntervalFor` recalcule la cible depuis l'état d'échantillonnage — `MOVING` → 20 s,
`IDLE_ENGINE_ON` → 30 s, `STOPPED` → 99 s. Un véhicule qui **s'arrête** juste après une commande à
20 s voit donc sa cible passer à 99 s. Or le boîtier était déjà à 99 s, puisqu'il n'avait jamais
suivi les 20 s. La clôture par échéance ([TRK-051](#trk-051)) compare la cadence mesurée à la
**nouvelle** cible, la trouve égale, et écrit « Cible atteinte ».

Prise seule, chaque ligne est vraie. **C'est leur succession qui raconte une réparation qui n'a pas
eu lieu** — et aucune des deux ne signale que la cible a changé : il faut comparer le `20` de la
première au `99` de la seconde, dans deux lignes distinctes d'un tableau, pour s'en apercevoir.

### 🔴 Ce que le motif cache, et qui est le vrai sujet

Sur ces 46 transitions, **une demande à 20 s adressée à un boîtier déjà à 99 s n'a jamais abouti**.
C'est la question de [TRK-008](#trk-008), et elle reste entière — mais l'écran la recouvre d'une
« réussite » toutes les six minutes.

⚠️ **Cette fiche ne contredit pas [TRK-057](#trk-057), elle en est le complément.** TRK-057 a réparé
les cibles *absurdes* (21, 28, 43, 56 s) et le parc est à **44/44 canoniques**. TRK-059 porte sur des
cibles parfaitement légitimes : 20 s pour un véhicule qui roule, 99 s pour un véhicule arrêté. *Le
réglage est juste ; c'est le récit qu'on en fait qui est faux.*

### ✅ Correctif proposé

La clôture par échéance connaît les deux cibles — il suffit qu'elle le dise :
...
⚠️ **Corriger le message, pas la clôture.** La clôture par échéance est utile : sans elle, les
commandes resteraient `SENT` indéfiniment, faute d'accusé matériel ([TRK-018](#trk-018)). *On
corrige le cri, pas le garde-fou.*

### 🗓️ Vérification — porte sur la CAUSE, pas sur l'affichage

Après déploiement, rejouer la requête de paires. **Le compte de paires « cible changée » doit
rester ≈ 46 sur 7 j** — le phénomène physique ne change pas — mais **aucune** ne doit plus porter le
libellé « Cible atteinte ».

⚠️ **Double condition, leçon du 26/08 :** si les **deux** compteurs tombent ensemble, on a supprimé
la clôture et non le mensonge. Un seul doit tomber.

---

## TRK-060

**Signature** — `system-metrics | ERROR | Invalid prisma.$queryRaw() invocation: getaddrinfo
EAI_AGAIN <HOTE>`
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`3c36cce0`), NON EXERCÉ** · **gravité 3** · famille **brut** · 2026-09-02 *(🧹 en-tête rectifié le 2026-09-05 — ancien libellé : « CORRECTIF ÉCRIT ET COMMITÉ, NON DÉPLOYÉ », lui-même rectifié le 04/09 depuis « 🔴 NON CORRIGÉ ». Marqueur « purge des mesures » **vérifié le 05/09 sur l'artefact SERVI**. Aucune nouvelle ligne `system-metrics` depuis le 02/09 : le correctif attend une occasion.)*

> ### L'incident est bénin. C'est le message qui envoie enquêter sur une panne de base qui n'a jamais eu lieu.

### Ce qui est mesuré

Une seule ligne, **la seule de son espèce en 90 jours de rétention** :
...
**Et la conséquence réelle est chiffrée :** `system_metrics` porte **1 437 points sur les 1 440**
attendus en 24 h. Le collecteur tourne toutes les 60 s
(`metrics-collector.service.ts:24`, `@Interval(60_000)`), attrape son exception, l'enregistre et
continue ; le passage suivant a réussi. *Une résolution DNS Docker qui bafouille une seconde a coûté
un point de mesure sur mille quatre cent quarante.*

Aucun redémarrage ne l'explique : `tracky-postgres` tourne sans interruption **depuis le 04/08**,
`restarts = 0`, et `tracky-api` depuis le 01/09 15:10.

### Cause racine

**Le défaut n'est pas l'incident, c'est le message.** `EAI_AGAIN` est un code de résolution de nom
recopié tel quel depuis la couche transport, à travers l'enveloppe d'erreur de Prisma. Il ne dit :

- **ni ce qui a échoué** — la collecte de métriques système ;
- **ni la conséquence** — un point de graphe manquant ;
- **ni qu'il est sans gravité** — le passage suivant répare tout seul.

Ce que lit un exploitant à 8 h du matin, c'est `ERROR` + le nom du conteneur de base de données. Il
instruit une panne de base. *Le message envoie enquêter au mauvais endroit — c'est la définition de
la famille **brut**, et le voisinage de la famille **mensonger**.*

⚠️ **Le contraste, dans la même collecte, le même jour :** `trip-analysis` écrit
*« Limites de vitesse indisponibles : Overpass injoignable sur 1 requête(s) — les excès de vitesse
ne sont pas affirmés sur ce trajet, **le reste de l'analyse est conservé** »*. Elle nomme la
dépendance, la conséquence, et ce qui survit. **Le savoir-faire existe dans ce dépôt ; il n'est pas
appliqué ici.**

### ✅ Correctif proposé

Dans les **deux** `catch` de `metrics-collector.service.ts` (lignes 41 et 57 — *chercher les
jumeaux*, §7.5 de la procédure) :
...
*Un message apaisant sans compteur, c'est le profil exact de [TRK-008](#trk-008) : un défaut qui
casse sans crier.*

### 🗓️ Vérification

À la prochaine occurrence : la ligne doit nommer la collecte et sa conséquence, et **rester
`ERROR`**. Puis provoquer 5 échecs consécutifs (couper la résolution du nom dans un environnement de
test) : la 5ᵉ doit sortir en **`CRITICAL`**. ⚠️ *Sans ce second volet, le correctif ne fait
qu'adoucir le message d'une vraie panne.*
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-01 à 09:17, NON EXERCÉ** · **gravité 1** · famille **faux positif** · 2026-09-01 · *ancien statut : 🔴 NON CORRIGÉ*

> ### ✅ 2026-09-01 (apres-midi) — CORRECTIF LIVRE, sur les DEUX chemins
>
> Garde posee dans `alerts.service.ts` (chemin trame, apres l'ecriture de `lastPowerNotice`)
> **et** dans `createPowerCutConfirmedAlert` (chemin du cron de reexamen). La donnee etait
> deja chargee des deux cotes : **aucune requete ajoutee**.
>
> **On suspend l'ALERTE, jamais la CONNAISSANCE** — un test verrouille le fait que
> `lastPowerNotice` continue d'etre ecrit sur un vehicule hors service.
>
> **Verifications :** 6 tests neufs, dont 3 verifies EN ECHEC sur l'ancien code. Les
> contrepoints — « le meme vehicule EN SERVICE alerte toujours », « la note reste ecrite » —
> passent sur les deux versions : c'est leur role, ils empechent de « corriger » en eteignant
> le detecteur.
>
> 🗓️ **TEST DATE — et il ne peut PAS etre passe aujourd'hui.** Les 9 vehicules hors service
> sont **tous hors ligne** : aucun n'emet plus une trame, donc rien ne vient exercer la garde.
> *Le correctif est livre, il n'est pas prouve.* Le compteur a surveiller est
> `alertes_depuis_declaration` de la section `hors_service` : il vaut **7** et **ne doit plus
> jamais croitre**. S'il augmente, la garde n'a pas tenu.
...
l'alerte`
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ PAR LE COMPORTEMENT le 2026-09-01 à 09:30:00** · **gravité 2** · famille **mensonger** · 2026-09-01 · *anciens statuts : 🔴 NON CORRIGÉ, puis 🟠 déployé en attente de vérification*

> ### 🟢 2026-09-01 09:30:00 — PROUVE PAR LE COMPORTEMENT, au premier passage du cron
>
> Deploiement a **09:17:41**. Le cron de la veille accident passe toutes les 30 minutes ; **le
> tout premier passage, a 09:30:00, a retracte l'alerte** — sans intervention.
>
> **Au journal du conteneur :**
>
> ```
> [ACCIDENT] retractation HD-779-MA — reprise apres 960 min, batterie 100 %
> [ACCIDENT] 1 alerte(s) retractee(s) — le boitier a repris
> ```
>
> **En base, et c'est la que la double condition se lit :**
>
> | Ce qu'on verifie | Attendu | Mesure |
> |---|---|---|
> | la retractation est ecrite | `payload.retractation` present | ✅ |
> | le motif est explicite | heure de reprise + batterie + « aucun choc confirme » | ✅ |
> | **l'acquittement humain n'est PAS reecrit** | `acknowledgedAt` = 31/08 19:15:38, `acknowledgedBy` = l'exploitant | ✅ **intacts** |
> | le payload d'origine survit | `derniereVitesseKmh` = 113,268 | ✅ |
> | l'auteur est nomme | `par = detection-accident/retractation` | ✅ |
>
> *Un seul compteur a bouge : l'alerte a gagne sa retractation, elle n'a rien perdu.*
>
> ### 🔴 ET UN SECOND DEFAUT, TROUVE SUR CETTE PREMIERE RETRACTATION REELLE
>
> Le motif ecrit annoncait : « le boitier a repris l'emission le **01/09 a 11:29**, soit
> **960 min** apres cette alerte ». **C'est faux.** HD-779-MA a repris le **31/08 a 20:00**,
> apres **150 minutes** de silence. La cause tient en une phrase : `lastSeenAt` avance a chaque
> trame — il designe la DERNIERE, jamais la premiere d'apres l'alerte.
>
> Le chiffre faux n'etait pas anodin : il transformait un trou de 2 h 30 en un silence de seize
> heures, et aurait fait chercher pourquoi une alerte d'accident etait restee seize heures sans
> suite. *Un motif de retractation qui affirme une heure fausse est de la famille MENSONGER —
> exactement celle de cette fiche. Le correctif reproduisait le defaut qu'il corrigeait.*
>
> **Corrige et redeploye dans la foulee** : la reprise est desormais lue sur la **premiere
> position posterieure a l'alerte** (requete indexee, empruntee une fois par retractation). A
> defaut, le motif dit explicitement que l'heure de reprise **n'est pas mesurable** au lieu d'en
> inventer une, et `silenceApresAlerteMin` vaut `null` plutot qu'un nombre faux. Deux tests
> neufs, dont celui qui verrouille **150 et non 960**.
>
> ⚠️ **La ligne deja ecrite en base garde son motif imprecis** — l'idempotence l'empeche de
> repasser, et on ne reecrit pas l'historique. Elle est datee, et cette section explique
> pourquoi elle dit 960.

> ### ✅ 2026-09-01 (apres-midi) — CORRECTIF LIVRE, et un defaut de conception trouve avant le deploiement
>
> La veille se retracte : toute alerte `ACCIDENT` de cette veille dont le boitier a **reemis
> apres** sa creation est annotee d'un motif — heure de reprise, silence reel, batterie — dans
> `payload.retractation`, et refermee si elle etait encore ouverte.
>
> 🔴 **LE DEFAUT TROUVE EN VERIFIANT LA PRODUCTION AVANT DE DEPLOYER.** La premiere version ne
> reprenait que les alertes NON acquittees. Or l'alerte de HD-779-MA **avait ete acquittee par
> un exploitant a 19:15**, quarante-cinq minutes AVANT le retour du boitier : le correctif
> n'aurait donc jamais pu s'exercer sur son propre cas de reference. Et le fond compte plus que
> l'anecdote — *une fausse alerte acquittee est indiscernable d'un vrai accident traite* : le
> registre garde « accident critique, acquitte par untel », et l'information qu'il n'y a jamais
> eu de choc est perdue. **Acquitter dit QUI A REGARDE ; se retracter dit CE QUI ETAIT VRAI.**
> Desormais on annote toujours, on ne referme que ce qui est ouvert, et l'acquittement humain
> n'est jamais reecrit.
>
> 🔴 **ET LA GARDE QUI A FAILLI MANQUER.** Le type `ACCIDENT` a DEUX emetteurs : cette veille
> (qui infere d'un SILENCE) et le **capteur de choc** du boitier. Un boitier qui signale un choc
> CONTINUE d'emettre — une retractation aveugle aurait donc referme **toutes les alertes de choc
> reelles** en moins de trente minutes, en ecrivant « aucun choc confirme » sur la seule alerte
> du systeme qui en ait mesure un. Seules les alertes `detection: 'telemetrie'` sont
> retractables, et un test le verrouille. *Le correctif d'un faux positif ne doit jamais pouvoir
> eteindre un vrai positif.*
>
> ⚠️ **Le seuil de 2 h n'a PAS ete releve**, contre l'option 2 proposee par cette fiche : on ne
> ralentit pas un filet de securite pour corriger un defaut d'affichage. Un accident annonce six
> heures apres n'est plus une alerte, c'est un constat.
>
> **Verifications :** 9 tests neufs sur un fichier de specification cree pour l'occasion, qui
> rejouent le cas HD-779-MA a l'heure pres.
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-01 à 09:17, NON EXERCÉ** · **gravité 2** · famille **faux positif** · 2026-09-01 · *ancien statut : 🔴 NON CORRIGÉ*

> ### 🧹 2026-09-05 — LE CRITÈRE DE VÉRIFICATION ÉTAIT TROP LARGE, ET IL ACCUSAIT LA MAUVAISE CHAÎNE
>
> Le critère écrit ici — « deux alertes de même type et même véhicule dont la première est acquittée ;
> la seconde à moins de 6 h = le correctif n'a pas tenu » — a désigné **trois paires du 04/09**.
> **Aucune n'est une régression.**
>
> `alerts.service.ts:332` porte une borne que ce critère ignorait :
>
> ```ts
...
> fenêtre de 6 h que ce correctif touche. Sur les alarmes nées du boîtier (`tripId IS NULL`), les
> seuls doublons de la semaine sont **deux `LOW_BATTERY` du 31/08**, antérieurs au correctif.
>
> 🔑 **CRITÈRE RECTIFIÉ — la vérification porte désormais sur `tripId IS NULL` uniquement.**
> *Une consigne de vérification écrite avant l'arrivée d'une seconde chaîne accuse la mauvaise.
> Le rapport du 05/09 allait annoncer une régression qui n'existe pas ; c'est la lecture du code,
> et elle seule, qui l'en a empêché.*

> ### ✅ 2026-09-01 (apres-midi) — CORRECTIF LIVRE, et ce n'est PAS l'option 1
>
> L'option 1 de cette fiche — « retirer `acknowledgedAt: null` » — a ete **ecartee telle
> quelle**, parce qu'elle aurait aussi musele le bouton de detresse : un conducteur appuie sur
> `SOS`, l'exploitant acquitte, le conducteur rappuie vingt minutes plus tard pour une AUTRE
> urgence — et plus rien ne part pendant six heures.
>
> Le correctif livre distingue donc **alarmes d'ETAT** et **alarmes PONCTUELLES** :
>
> | Famille | Types | Comportement |
> |---|---|---|
> | **ETAT** *(l'alarme se repete parce que l'etat dure)* | `POWER_CUT`, `LOW_BATTERY`, `OVERSPEED`, `GEOFENCE_EXIT`, `MOVEMENT_IDLE`, `BONNET`, `DOOR`, `IDLE_TIME`, `GPS_LOST`, `FATIGUE` | la fenetre de 6 h decide **seule** — l'acquittement ne re-arme plus |
> | **PONCTUELLE** *(elle se repete parce qu'il se passe du neuf)* | `SOS`, `ACCIDENT`, `COLLISION`, `TOW`, `TAMPER`, `ILLEGAL_IGNITION`, surveillance, evenements de conduite | comportement d'origine **conserve** |
>
> ⚠️ **Un type d'alerte ajoute plus tard tombe du cote PONCTUEL**, c'est-a-dire du cote qui
> alerte le plus. **Fail-open vers le signal**, meme doctrine que TRK-047.
>
> Applique aussi au chemin du cron (`createPowerCutConfirmedAlert`), qui portait le meme
> predicat. **Verifications :** 5 tests, dont celui qui verrouille que **`SOS` acquitte rouvre
> toujours**.
>
> 🗓️ **TEST DATE :** la prochaine alarme d'etat acquittee en cours d'episode ne doit produire
> qu'**une** ligne. Le candidat naturel est `OVERSPEED` sur FG-669-DQ, seul vehicule du parc qui
> en produise, a raison de 1 a 2 par jour.

> ### La déduplication des alarmes tient six heures — sauf si l'exploitant regarde son écran.

### Ce qui a été mesuré, et la corrélation est exacte : 2 cas sur 2

Le 31/08, six véhicules ont perdu leur alimentation et leur batterie s'est vidée pendant des
heures. Huit alertes `LOW_BATTERY` en sont sorties. **Deux véhicules en ont reçu deux** :

| Véhicule | 1ʳᵉ alerte | Acquittée | 2ᵉ alerte | Écart |
|---|---|---|---|---|
| **FS-808-CE** | 11:50:37 | **11:50:56** *(19 s plus tard)* | **12:05:38** | 15 min |
| **FZ-731-YF** | 11:55:34 | **12:05:59** | **12:10:36** | 15 min |
| FS-253-HR | 11:19:32 | 11:40:00 | *(aucune)* | — |
| FZ-862-VY | 12:28:21 | 12:39:23 | *(aucune)* | — |
| FW-298-WV | 13:10:24 | 19:15:38 | *(aucune)* | — |
| FR-629-AD | 13:21:21 | 19:15:38 | *(aucune)* | — |

**Les deux seuls véhicules à recevoir un doublon sont les deux dont la première alerte a été
acquittée alors que la condition physique durait encore.** Les quatre autres, acquittés plus tard,
n'en ont reçu qu'une — leur batterie se vidait pourtant tout autant, et leur boîtier répétait la
même alarme dans chaque trame.

### Cause racine

`apps/api/src/alerts/alerts.service.ts:229-240` — le prédicat de déduplication porte **deux**
conditions, et c'est la seconde qui fait le défaut :
...
Le commentaire au-dessus l'assume explicitement : *« On rouvre seulement si la précédente a été
acquittée — l'exploitant a alors signifié qu'il avait traité l'épisode. »*

**L'hypothèse est fausse en exploitation.** Acquitter ne veut pas dire « j'ai traité », mais
« j'ai vu » — mesuré ici à **dix-neuf secondes** après la création, sur une condition physique qui
allait durer deux heures de plus. `createPowerCutConfirmedAlert` (`:494`) porte le **même**
prédicat, donc le même défaut.

### Pourquoi c'est plus grave que deux doublons

C'est exactement le mécanisme qui ramènerait le déluge de [TRK-022](#trk-022) : le 12/08,
FG-669-DQ a produit **1 317** alertes `OVERSPEED` en une journée, une toutes les 24 secondes. La
garde de 6 h posée le 19/08 l'a ramené à **1-2 par jour** — mais elle ne protège que tant que
**personne n'acquitte pendant l'épisode**. Un exploitant qui nettoie son écran pendant que le
véhicule roule encore à 135 km/h rouvre le robinet à la trame suivante.

> 🔑 **La protection dépend d'un geste humain qu'aucune fiche n'avait nommé comme condition.**
> Un garde-fou dont l'efficacité est inversement proportionnelle à l'attention de l'exploitant
> est un garde-fou qui lâche exactement le jour où quelqu'un regarde.
...
2. **Poser un plancher indépendant de l'acquittement** : aucune réouverture avant N minutes
   (proposition : 15 min), acquittée ou non. Corrige le cas mesuré sans toucher au principe.
3. **Le plus juste — fermer sur l'ÉTAT, pas sur l'écran** : ne rouvrir que si la condition physique
   a cessé (batterie remontée, vitesse repassée sous le seuil pendant N minutes). C'est la notion
   d'**épisode** que [TRK-022](#trk-022) réclamait déjà et qui n'a jamais été écrite.

⚠️ **Ne pas « corriger » en retirant la fenêtre de 6 h** : elle est ce qui a divisé le volume par
mille. Le défaut est dans la seconde condition, pas dans la première.

### 🗓️ Vérification — double condition, à relever SÉPARÉMENT

Sur un épisode long **acquitté en cours** : le nombre d'alertes doit tomber à **1** *pendant que*
le nombre d'**épisodes distincts** reste identique. Si les deux baissent, on a supprimé du signal
et pas des doublons.

```sql
SELECT "vehicleId", type, count(*) AS alertes,
       count(*) FILTER (WHERE "acknowledgedAt" IS NOT NULL) AS acquittees,
       min("createdAt"), max("createdAt")
FROM alerts WHERE "createdAt" > now() - interval '24 hours'
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET VÉRIFIÉ EN PRODUCTION le 2026-08-26 à 05:57** (option 2, sans migration) · ⚠️ **non exercé à l'écran** · **gravité 2** · famille **mensonger** · 2026-08-26 · *anciens statuts : 🟠 correctif écrit non déployé, puis 🔴 NON CORRIGÉ*

> 🔑 **`ACKNOWLEDGED` ne veut pas dire « acquitté par le boîtier ».** Il veut dire « la cadence
> mesurée a rejoint la cadence demandée, sans aucune confirmation du matériel ». La colonne que
> tout le monde agrège affirme donc un fait — *le boîtier a répondu* — qui est faux **118 fois
> sur 120**.

### La mesure (2026-08-26, 01:11 UTC)

| | |
|---|---|
| Commandes `ACKNOWLEDGED` sur 7 j | **120** |
| dont portant une vraie réponse (`ackResponse`) | **2** — deux `raw`, un seul IMEI, le 24/08 |
| `fix_continuous` `ACKNOWLEDGED` | **118**, dont **0** avec réponse de boîtier |
| `ackedAt` sur TOUTE la table | **2 sur 5 173** |

Le `observedResult` de ces 118 lignes dit lui-même la vérité, mot pour mot :
« *Cible atteinte : cadence réelle 99s pour 99s demandés — **sans accusé de réception du
boîtier**. Close par échéance après N min.* »

### Cause racine

`TrackerCommandStatus` (`PENDING · SCHEDULED · SENT · ACKNOWLEDGED · FAILED · CANCELLED`) **ne
contient aucune valeur signifiant « a produit l'effet demandé, sans confirmation du matériel »**.

Quand le correctif de [TRK-013](#trk-013) (PR #111, déployé le 23/08) a appris à la clôture par
échéance à **comparer avant d'affirmer**, il a dû loger ce verdict neuf dans une valeur existante,
et a pris la moins fausse — `ACKNOWLEDGED` (`apps/api/src/tracker-fix-mode/tracker-fix-mode.service.ts:463`).

⚠️ **Le code n'est pas négligent, et c'est ce qui rend la fiche intéressante.** Il écrit la vérité
dans `observedResult`, et il se refuse explicitement à toucher `ackedAt`/`ackResponse`, avec le
commentaire : « *on ne touche ni à `ackedAt` / `ackResponse` (réservés à une vraie réponse du
boîtier : TRK-014 mesure leur absence, un faux `ackedAt` truquerait cette mesure)* ».
**L'auteur a protégé l'instrument de [TRK-014](#trk-014) et a quand même corrompu sa lecture** —
parce que le champ qu'il a dû réutiliser n'est pas celui qu'il a protégé.

> 🔑 *Un statut est une agrégation ; un `observedResult` est une lecture ligne à ligne. Écrire la
> vérité dans le second ne rachète pas une affirmation fausse dans le premier : personne
> n'agrège des phrases.*

### Ce que ça a déjà coûté

Cet audit lit `status` dans la section `commandes_sante_7j`.

- **24/08** — 57 `ACKNOWLEDGED` apparaissent « dans une famille qui n'en avait **jamais** produit
  une seule ». Le rapport suspend son jugement.
- **25/08** — 118. Le rapport note : « *Ce que ces 57 lignes prouvent reste donc à établir* », et
  inscrit [TRK-020](#trk-020) comme blocage.
- **26/08** — établi : elles ne prouvent **rien** sur les boîtiers.

**Deux passages consécutifs ont failli refermer [TRK-014](#trk-014)** — dont la thèse est
précisément « aucun accusé de réception boîtier, jamais » — sur la foi d'un compteur qui dit 120
là où la réponse est 2.

### Correctif proposé

1. **Avec migration** — ajouter `COMPLETED_UNCONFIRMED` à `TrackerCommandStatus` et l'écrire à la
   place d'`ACKNOWLEDGED` en `tracker-fix-mode.service.ts:463`. `ACKNOWLEDGED` redevient réservé à
   une réponse matérielle.
2. **Sans migration (recommandé pour commencer)** — partout où le statut est agrégé (écran admin
   des commandes, `commandes_sante_7j`), **scinder `ACKNOWLEDGED` sur `ackResponse IS NOT NULL`**.

### Vérification — porte sur la cause, pas sur l'affichage

Un lecteur qui n'a **que la colonne d'agrégation** sous les yeux doit pouvoir répondre à « combien
de boîtiers ont répondu ? » sans ouvrir `observedResult`. Aujourd'hui il répondrait **120** ; la
bonne réponse est **2**.

✅ **Fait le 26/08 pour l'instrument de l'audit** : `collecte.sql` rend désormais
`reponse_boitier` et `total_famille`, et porte l'avertissement en commentaire. Il rend
`fix_continuous` : **514 commandes, 0 réponse de boîtier**. L'écran admin, lui, n'est pas corrigé.

> ⚠️ **Corollaire à ne pas perdre — le « métronome de 72 échecs/jour » était un artefact.**
> Neuf points, `fix_continuous` par jour : `FAILED` 71 · 71 · 76 · 74 · 70 · 72 · 64 · **27** ·
> **15**, `ACKNOWLEDGED` 0 · 0 · 0 · 0 · 0 · 0 · **5** · **52** · **61**, **TOTAL 71 · 71 · 76 ·
> 74 · 70 · 72 · 69 · 79 · 76**. Le total ne bouge pas : ce que ce dispositif rapportait depuis dix
> jours comme « 72 échecs par jour » comptait des **expirations**, dont ~80 % avaient atteint leur
> cible. ⚠️ **Non tranchable sur cette donnée** : PR #110 ([TRK-012](#trk-012), format de trame) et
> PR #111 ([TRK-013](#trk-013), clôture qui compare) sont parties **le même jour** — les boîtiers
> obéissent-ils enfin, ou le juge a-t-il appris à regarder ? Probablement les deux.
...
**Statut : 🟢 CORRIGÉ ET DÉPLOYÉ le 2026-08-25 à 14:58** (PR #136) · ⚠️ **NON EXERCÉ** · **gravité 2** · famille **mensonger** · 2026-08-25

> 🟢 **25/08 14:58 — CORRIGÉ, TESTÉ, DÉPLOYÉ.** Les trois points du correctif ci-dessous sont en
> ligne. **8 tests neufs**, dont 4 qui exercent le VRAI handler via une couture de création de
> socket ; vérification test-first honnête (**3 échouent sur l'ancien code**, et le contrepoint
> « refus réel » passe sur les deux versions). Suite web **453 verts**, `ng build` OK. Marqueurs
> confirmés dans le bundle SERVI par des **littéraux de chaîne** — jamais par un nom de variable,
> qu'un bundle minifié rend invalide ([TRK-002](#trk-002)).
>
> 🔑 **Le déploiement n'a touché QUE le web : l'API n'a pas redémarré.** Le correctif de la
> déconnexion au redéploiement n'a donc déconnecté personne — mais c'est aussi pour cela qu'il
> reste **NON EXERCÉ** : la preuve comportementale demande une vraie bascule d'API.
>
> 🗓️ **Test daté, au prochain redémarrage d'API** : une session ouverte avant la bascule doit
> rester ouverte après. `SELECT count(*) FROM user_sessions WHERE "startedAt" < <bascule> AND
> "lastSeenAt" > <bascule> + interval '1 minute'` doit rendre **> 0** — il rendait **0** aux trois
> redémarrages mesurés.
...
**Signature** — *(aucune ligne d'erreur — angle mort d'observabilité)* `background-tasks | catalogue |
traitement planifié absent du catalogue, donc invisible`
**Statut : 🟢 CORRIGÉ ET DÉPLOYÉ le 2026-08-25** · **gravité 3** · famille **angle mort** · 2026-08-25

> ### Le cron qui solde les commandes moteur tournait depuis un jour sans figurer nulle part.

### Comment on est tombé dessus

En vérifiant le **cumul** des trois lots avant de déployer — pas en cherchant ce défaut. La suite
complète est passée de « 181 suites vertes » à **1 échec** : `catalogue-exhaustif.spec.ts`.
*C'est exactement ce que la vérification du cumul est censée produire ; sans elle, ce défaut
serait reparti pour un tour.*

### Ce qui est mesuré — et le défaut est PRÉEXISTANT

| Contrôle | Résultat |
|---|---|
| `@Cron('0 */10 * * * *')` dans `engine-control.service.ts` de la version SERVIE (`f508405`) | **présent** (ligne 168) |
| Ce fichier revendiqué par le catalogue de `f508405` | **0 occurrence** |
| Conséquence | le garde était **rouge depuis le déploiement du 24/08** |

Ce n'est donc pas une régression des lots du jour : la campagne TRK-018 a ajouté ce cron sans
l'inscrire, et le déploiement est passé.

### Cause racine

`background-tasks.service.ts` porte un catalogue **écrit à la main** — choix assumé et documenté
(`SchedulerRegistry` ignore les `setInterval` bruts). Le garde `catalogue-exhaustif.spec.ts`
existe précisément pour qu'un oubli fasse échouer la construction. Il a fait son travail. **Ce
qui a manqué, c'est la lecture de son verdict.**

> 🔑 **Un test de complétude ne protège que si on lit son verdict.** Le garde a été écrit le
> 19/08 après avoir découvert que `scheduled-task-heartbeat` — *la sonde qui détecte les
> traitements silencieux* — manquait au catalogue. Cinq jours plus tard, le même oubli se
> reproduit sur un autre cron, le garde crie, et le déploiement passe outre. *Le profil exact de
> [TRK-008](#trk-008) et [TRK-043](#trk-043) : un traitement qui travaille sans que son silence
> soit visible.*

### Correctif appliqué

Entrée `engine-command-expiry` ajoutée au catalogue (`source`, cadence réelle, criticité, et ce
qu'on perd si elle s'arrête). Marqueur vérifié dans le `dist/` servi.

### 🗓️ Vérification

`/admin/background-tasks` doit désormais lister « Fin de vie des commandes moteur », toutes les
10 min. Et le garde doit rester vert : **lire son verdict avant chaque déploiement** — c'est la
seule partie du correctif qui ne s'automatise pas.
...
> véhicule **CONSIDÉRÉ STATIONNÉ** — exception typée `PresumedParkedException`, aucune commande,
> aucune alerte « coupe impossible », lignes de blocage closes, état « Stationné · parking
> souterrain » sur liste/fiche/snapshot. Lieu inconnu → report **honnête** (« hors champ GPS depuis
> N min »), jamais de `REJECTED_SPEED` sur une vitesse figée. **Filet de sécurité** : alerte
> CRITICAL `OFF_SCHEDULE_MOVEMENT` à la réapparition EN ROULANT pendant la plage de coupure
> (détection à l'ingestion ; abstentions : plage autorisée, override, RESTORE né pendant
> l'obscurité). ⚠️ **Le correctif proposé ci-dessous par l'audit du matin était INSUFFISANT** :
> « autoriser la coupe si la vitesse est périmée » aurait coupé à l'aveugle un véhicule dans un
> tunnel — un tunnel ne produit AUCUNE position, le scan d'immobilité y est structurellement
> aveugle. On ne coupe donc JAMAIS à l'aveugle un véhicule perdu en mouvement. 4 tests vérifiés
> EN ÉCHEC sur l'ancien code ; migration `ALTER TYPE AlertType ADD VALUE`. **État prod au 25/08** :
> l'ancre de FS-253-HR est à 3 m d'une zone parking validée (présomption immédiate au déploiement) ;
> celle de FZ-862-VY n'a PAS encore de zone à son emplacement (seule zone à 6,8 km) — il passera au
> report honnête, puis en présomption dès validation/auto-qualification du lieu.

> ### La coupe programmée est refusée parce que le véhicule roule — d'après une vitesse mesurée sept heures et quarante minutes plus tôt.

### Ce que ça veut dire

FZ-862-VY devait être immobilisé à **20:00**. À **01:02**, cinq heures plus tard, il ne l'est
toujours pas. Ce n'est pas un défaut d'affichage : **c'est une fonction demandée par le client qui
ne s'exécute pas**, et rien à l'écran ne dit pourquoi en termes exacts.

### Ce qui est mesuré

Treize commandes `CUT` créées et refusées, une toutes les ~30 minutes, **toutes portant le même
texte au centième près** :

| Créées | Statut | Motif |
|---|---|---|
| 24/08 20:00:11 → 25/08 01:02:00 *(13 fois)* | `REJECTED_SPEED` | `Vitesse trop élevée : 27.15 km/h` |

Cette vitesse est celle de la **dernière position du véhicule, datée du 24/08 17:29:47** — la
seule qu'il ait produite depuis :

| Champ | Valeur |
|---|---|
| `status` | `ONLINE` — le boîtier émet |
| `lastPositionAt` | **24/08 17:29:47**, figé |
| `lastNoFixAt` | avance à chaque trame |
| Heures sans fix | **7,7 h** |

Le véhicule est entré quelque part sans ciel à 27 km/h, et l'horloge de sa vitesse s'est arrêtée
là.
...
`lastPosition.speedKmh`**, et un seul a reçu le test de fraîcheur :
...
> prouve AUCUN mouvement — l'appliquer bloquait la coupe pour toujours (74 REJECTED_SPEED/j) »*

> 🔑 **Le raisonnement est juste, il n'a été appliqué qu'à un garde sur deux.** Soixante lignes
> plus bas, la même valeur périmée condamne à nouveau — sous un autre nom. *Quand on corrige un
> raisonnement, il faut chercher tous les endroits qui le tenaient, pas seulement celui qui a
> crié.* La procédure le prescrit au §7.5 (« chercher les jumeaux ») ; ce jumeau-ci a attendu six
> semaines et une coïncidence pour se montrer.

### ⚠️ Ce n'est PAS une régression du 24/08

Le code fautif date du **08/07** (commit `9ca272c1`), et il est bien dans l'artefact servi
(marqueur vérifié). Ce qui est neuf, c'est **l'occasion** : il faut qu'un véhicule perde son fix
GPS pendant que sa dernière vitesse dépasse 20 km/h.

| Jour | `REJECTED_SPEED` | Trackers |
|---|---|---|
| 16 → 23/08 | **0** | — |
| 24/08 | **10** | 1 |
| 25/08 *(à 01:11)* | **3** | 1 |

*Un défaut qui attend une coïncidence n'est pas moins réel — il est seulement plus difficile à
croire présent.*

### Pourquoi le report de [TRK-029](#trk-029) ne rattrape pas le coup

Le contexte des deux lignes `schedule-cron` porte `knownDeadline: false` et
`waitingBackoff: true`. Le libellé « Vitesse trop élevée » n'est pas un compte à rebours
analysable par `parseKnownCountdown`, donc le correctif retombe sur le **backoff exponentiel** :
`stuckMinutes` passe de **31** à **212** entre les deux lignes. **Plus ça dure, moins on
réessaie.**

### Correctif proposé

Aligner `:448` sur le raisonnement déjà écrit en `:383`.

```ts
// La vitesse ne condamne que si elle est FRAÎCHE. Pour le scheduler, une vitesse périmée ne
// prouve aucun mouvement : le mouvement RÉCENT est déjà vérifié par le scan (2) ci-dessus.
if (lastPosition.speedKmh > MAX_SPEED_FOR_CUT &&
...
⚠️ **Ce n'est pas un affaiblissement de garde** (§8). Un véhicule réellement en mouvement est
refusé **deux fois avant** d'arriver là : en (1) si sa position fraîche dépasse 5 km/h, en (2) si
une trame > 5 km/h existe dans les 10 dernières minutes. La seule chose retirée est la
condamnation par une valeur dont le code affirme lui-même qu'elle ne prouve rien.

### 🗓️ Vérification — porte sur la CAUSE, pas sur l'affichage

Au prochain véhicule qui perd son fix alors que sa dernière vitesse dépasse 20 km/h : la coupe
programmée doit **aboutir**, et le compte de `REJECTED_SPEED` de source `SCHEDULER` doit revenir
à **0**.

⚠️ **Ne pas juger à la disparition des lignes `schedule-cron`** : elles disparaîtraient aussi si
l'on cessait de demander la coupe. *Un critère de réussite également satisfait par l'abandon de la
fonction ne mesure rien.*

### Action terrain, indépendante du correctif

FZ-862-VY n'est pas immobilisé. À couper à la main depuis `/admin/trackers/:id` si le
propriétaire le souhaite — un admin n'est pas soumis à la règle du scheduler.
...
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRECTIF PROPOSÉ — PR #135 (`fix/trk047-seuil-recalcul`), 25/08** · **gravité 3** · famille **faux positif** · 2026-08-25 »)*

> 🟠 **25/08 (après-midi)** — l'option 2 de la fiche est implémentée, en mieux : l'espacement
> MÉDIAN des positions voisines est **MESURÉ** (6 de part et d'autre, 2 requêtes indexées dans la
> seule branche rare) et le trou ne crie que s'il dépasse **3 ×** cette médiane. Fail-open VERS LE
> SIGNAL (sans tracker/voisinage/sur erreur → l'alerte part). Le fait reste compté, la tranche
> reste figée. `STOPPED_THROTTLE_MS` exporté comme LA constante qui sépare « ce que le boîtier
> envoie » de « ce que la base garde ».

> ### Le seuil qui évite les fausses alertes est calibré sur la cadence d'émission ; la grandeur qu'il protège est celle des positions stockées.

### Ce que ça veut dire

Une seule ligne (24/08 08:22:26, GS-878-NX, tranche 07:31:13 → 07:35:00), et elle ne se répétera
pas **sur cette tranche** : le code fige les trajets concernés juste après avoir alerté. Mais elle
se rejouera sur d'autres tranches et d'autres véhicules, indéfiniment.

### Ce qui est mesuré

Positions **stockées** de GS-878-NX ce matin-là :

| Heure | Positions | Espacement moyen |
|---|---|---|
| 06:00 | 11 | ~5 min |
| 07:00 | 11 *(07:04:47 → 07:59:36)* | ~5 min |
| 08:00 | 99 | ~35 s |
...
`apps/api/src/trip-analysis/trip-automation.service.ts:85` :
...
des **positions écrites**. L'écart entre les deux est énorme :

| Sur 24 h | |
|---|---|
| `SKIPPED_THROTTLE` | **178 610** |
| `INSERTED` | **27 787** |
| Trames volontairement non stockées | **87 %** |

À l'arrêt, l'espacement réel des positions est de l'ordre de **5 minutes**, pas de 20 secondes.
**Le seuil est cinq fois trop petit dans le seul régime où il sert.**

> 🔑 **Deux cadences portent le même nom et ne mesurent pas la même chose.** L'échantillonnage
> adaptatif a créé un écart d'un facteur 15 entre « ce que le boîtier envoie » et « ce que la base
> garde » ; toute constante calibrée sur la première et appliquée à la seconde est fausse d'autant.
> *Il vaut la peine de chercher les autres seuils exprimés « en cadences ».*

### Correctif proposé

Calibrer le seuil sur la grandeur qu'il protège, pas sur celle qui lui ressemble :

1. **le moins cher** — porter la constante à ~3 × l'espacement de stockage à l'arrêt (≈ 15 min) ;
2. **le plus juste** — n'alerter que si la tranche vide est **encadrée** de positions rapprochées,
   ce qui distingue un trou réel d'un stationnement, sans dépendre d'aucune constante.
...
Sur 7 jours, **aucune** ligne `recompute:no-positions` dont la tranche tombe entièrement dans une
plage à contact coupé.

---

## TRK-048

**Signature** — *(aucune ligne d'erreur — angle mort pur)* `trackers | currentFixIntervalS |
cadence enregistrée figée au dernier fix GPS`
**Statut : 🟢 CORRIGÉ** · *(🧹 en-tête rectifié le 2026-08-25 — il était resté figé à sa rédaction initiale, alors que l'index ET le manifeste disent CORRIGÉ. **Les sections datées ci-dessous font foi.** Ancien en-tête : « 🟠 CORRECTIF PROPOSÉ — PR #134 (`fix/trk048-cadence-perimee`), 25/08** · **gravité 2** · famille **angle mort** · 2026-08-25 »)*

> 🟠 **25/08 (après-midi)** — l'option 1 de la fiche est implémentée : prédicat pur
> `cadenceMesurePerimee` (péremption = 3 × l'intervalle mesuré, plancher 3 min — un heartbeat
> horaire reste mesurable 3 h, un vestige à 1 s se périme en 3 min), « non mesurable » sur les
> écrans admin, balayage de récupération TRK-045 borné par `lastValidFrameAt` ≤ 5 min, et
> **aucune réécriture du champ**. La section `cadence_reelle` ajoutée à `collecte.sql` donne à
> l'audit un compteur d'émetteurs rapides qui ignore les vestiges — c'est elle qui doit tomber à
> 0, pas le compteur naïf.

> ### Un boîtier qui émet toutes les vingt secondes est enregistré à une seconde — et c'est ce champ qui sert d'instrument de contrôle à TRK-045.

### Ce que ça veut dire

Ce défaut ne crie pas. Il **fausse la mesure** que le passage du 25/08 avait consigne d'utiliser
pour juger le correctif de [TRK-045](#trk-045).
...
Les trames sont des `L`, sans fix :
`imei:864035054757027,tracker,260825011621,100%,L,,,c22,,6764c47,,,,,0,`
**Le boîtier est vivant, ponctuel, et sans ciel.**

### Cause racine

`reconcile()` ne recalcule `currentFixIntervalS` qu'à partir de `lastValidFrameAt`
(`apps/api/src/tracker-fix-mode/tracker-fix-mode.service.ts:609-619`) :

```ts
const prev = tracker.lastValidFrameAt;
if (!prev) { return { nextCurrentFixIntervalS: tracker.currentFixIntervalS, ... }; }
const observedS = Math.max(1, Math.round((frame.deviceTime.getTime() - prev.getTime()) / 1000));
```

Tant qu'aucune trame **valide** n'arrive, la valeur **n'est plus rafraîchie** : elle reste celle du
dernier fix — ici une valeur héritée de l'épisode TRK-045, quand ce boîtier émettait vite. Le
champ ne dit donc pas « cadence actuelle » mais **« cadence au dernier fix »**, et rien, ni en
base ni à l'écran, ne distingue les deux.

> 🔑 **Le critère d'acceptation de TRK-045 est passé pour la mauvaise raison.** La consigne était :
> *« Boîtiers à `currentFixIntervalS <= 6` : 0 ou 1 »*. Mesuré : **1** — donc conforme. Sauf que ce
> 1 est un **vestige**, pas un émetteur rapide : le boîtier en question émet à 20 s. *Un critère
> satisfait par une valeur périmée ne mesure rien.* Et s'il avait existé un vrai émetteur rapide
> en même temps, le compteur aurait affiché 2 et on aurait accusé le mauvais boîtier.

⚠️ **Même famille que [TRK-024](#trk-024)** : un état qui **survit aux trames** qui devraient le
démentir.

### Portée

**3 boîtiers sur 43** portent un `currentFixIntervalS` sous le plancher d'auto-alignement (20 s).
Ce champ est lu par au moins trois consommateurs :

- `tracker-fix-mode.service.ts:547` — la sélection des boîtiers à réaligner ;
- la section `cadence_derive` du SQL de collecte ;
- la fiche véhicule et `/admin/trackers/:id`.

### Correctif proposé

Ne pas afficher, ni exploiter, une cadence dont la mesure est périmée. Deux options, la première
préférée :

1. **Rendre la péremption visible.** L'horodatage existe déjà — c'est `lastValidFrameAt`. Traiter
   la valeur comme **inconnue** au-delà de ~3 × la cible ; l'écran, `cadence_derive` et le
   réalignement lisent alors « non mesurable », jamais un chiffre faux.
2. **Mesurer sur les trames plutôt que sur les fix** : compter la cadence d'**émission** (qui
   existe même sans GPS) séparément de la cadence de **positionnement**. Plus juste, plus coûteux.

⚠️ **Ne pas « corriger » en remettant le champ à zéro ou à la cible** : ce serait remplacer un
chiffre faux par un autre. L'information juste, ici, est **l'absence d'information**.

### 🗓️ Vérification

Reprendre FS-253-HR au passage suivant : tant qu'il est sans fix, `currentFixIntervalS` doit se
lire « non mesurable » et **non** `1`. Et le compteur « boîtiers ≤ 6 s » du contrôle TRK-045 doit
tomber à **0**.
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-05 à 00:00:35** *(volet CODE)* · gravité **1** · 4 lignes / 3 incidents · 2026-09-03 → 2026-09-05 *(🧹 en-tête rectifié le 2026-09-05 — ancien libellé : « CORRECTIF ÉCRIT ET COMMITÉ, NON DÉPLOYÉ ». ⚠️ **Volet COMPTE toujours 🤝 HUMAIN : à sec depuis le 03/09 00:13.**)*

> ✅ **Prouvé par la DOUBLE CONDITION le 2026-09-05 à 00:00:35.** La ligne porte
> `level = DEGRADATION` (et non `ERROR`), nomme l'action — « *Action : recharger le compte* » —,
> précise ce qui n'est **pas** affecté (« les analyses de flotte, exécutées localement »), garde le
> motif du fournisseur dans le contexte (`motifFournisseur`) au lieu de le servir à l'utilisateur,
> et elle est **SEULE** là où l'incident du 03/09 en produisait deux.
>
> 🔑 **Le compteur `ERROR` est tombé sans que le total de la famille bouge** : la ligne existe
> toujours. *Si les deux étaient tombés ensemble, on aurait supprimé l'alerte et non le défaut.*

**Première occurrence de toute l'histoire conservée.** La requête sur les 90 jours de rétention
rend **exactement ces deux lignes**, toutes deux du 03/09 à 00:13:23.
...
`AiServiceError('http', …)`. `http` n'étant pas dans `TRANSIENT_KINDS`, la ligne est **persistée
en `ERROR`**.

**Ce n'est ni une faute d'appel, ni un aléa passager.** C'est une **panne de compte** : elle ne
guérit pas seule, elle se reproduira à l'identique à chaque appel facturé, et l'action qui la
résout n'est pas dans le code. La taxonomie du fichier est par ailleurs excellente — huit `kind`
distincts, `TRANSIENT_KINDS` motivé par un incident daté — **il lui manque exactement une case** :
*le fournisseur refuse de servir pour une raison contractuelle, pas technique.*
...
`userAgent: iPhone OS 18_7`. L'utilisateur a lu sur son téléphone, en anglais, le nom du
sous-traitant et l'ordre d'aller créditer un compte auquel il n'a pas accès. Or le commentaire de
`describeProviderError` énonce son intention : « pour que **le centre d'alerte** porte la cause ».
*L'intention visait l'auditeur ; une seule chaîne sert deux publics, et rien ne les sépare.*
...
### Portée réelle — étroite, et c'est l'information importante
...
| `agenda_agent` | `api` | 1/jour, ~0,065 $ | **oui** |
| Optimiseur de placement *(interactif, `/agenda`)* | `api` | à la demande | **oui — c'est lui qui a échoué** |

Dernier appel `api` **réussi** : **00:01:02**. Échec : **00:13:23**. Le compte s'est vidé dans cet
intervalle de douze minutes.

⚠️ **Incident NON déclaré clos** : aucun appel `api` n'a été retenté depuis. Le silence de
`ai_usage_logs` dit seulement que personne n'a redemandé.

### Correctif proposé

1. **Ajouter un `kind` `provider_unfunded`**, reconnu sur le corps du 400 au même endroit que
   `isTransientBadRequest`. **Non transitoire** — il doit alerter — mais **niveau `DEGRADATION`**,
   pas `ERROR` : service indisponible pour une raison assumée et externe, exactement le
   raisonnement retenu pour Overpass en [TRK-037](#trk-037).
2. **Écrire un message qui nomme l'action** : « Assistance IA indisponible : le compte du
   ...
   C'est le patron que `trip-analysis` applique déjà dans ce dépôt.
3. **Séparer les deux publics.** Corps HTTP générique pour le client ; motif fournisseur dans le
   `meta` de la ligne d'erreur, où il a été voulu.
4. **Dédupliquer** — faire porter à `AiServiceError` le marqueur déjà employé pour les refus
   attendus, afin que le filtre global n'archive pas ce que le service a déjà journalisé.

### Vérification

Provoquer un appel `api` (optimiseur de placement) : **une seule** ligne doit apparaître, en
**`DEGRADATION`**, et la réponse HTTP ne doit plus contenir le mot « Anthropic ».

---

## TRK-062

### ✅ 2026-09-14 — PROUVÉ au premier balayage : 298 h, puis un état terminal en cinq minutes

Déployé le **13/09 à 20:25:24** (`66d286f5`, `deploy.sh`, migration `20260913200000` : valeur
`SENT_UNCONFIRMED` dans `TrackerCommandStatus`, colonne `expiredAt`). **Au balayage de 20:30:00**, les
deux commandes du 01/09 — `shock_on` (0592bca9) et `shock_off` (2e05d62b), BP-434-RD — passent en
`SENT_UNCONFIRMED` avec `expiredAt = 2026-09-13 20:30:00`, après **298,3 h et 294,9 h**. Le journal de
l'API l'écrit : *« TRK-062 : 2 commande(s) de boîtier parties par SMS close(s) en SENT_UNCONFIRMED
(échéance 240 min) »*. Le 14/09 à 01:12, `commandes_en_attente` rend **0 ligne** — la première collecte
sans aucun résident depuis l'ouverture de cette fiche. Marqueurs relus dans l'artefact servi :
`cloturerCommandesSmsSansReponse` et `SENT_UNCONFIRMED` dans `dist/tracker-commands/tracker-commands.service.js`.

⚠️ **Ce qui n'est pas exercé** : la borne sur une commande **neuve** — « envoyée » pendant quatre heures
(`TRACKER_COMMAND_SMS_EXPIRY_MIN = 240`, la référence mesurée du canal : 3 h 50 le 19/08), puis la bascule,
**jamais avant**. Aucune commande SMS n'est partie depuis le déploiement. *Jumeau de [TRK-018](#trk-018) :
purement temporel, rien n'est conclu sur l'issue, `lastError` reste vide.*


**Signature** — commande `tracker_commands` avec `channel = 'SMS'` et `status = 'SENT'`, sans
`ackedAt`, au-delà de toute échéance.
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-13 à 20:30:00** *(`66d286f5`, T5 — les 2 résidentes closes au premier balayage, voir la section du 14/09 ci-dessous ; en-tête rectifié le 14/09, ancien en-tête : « 🔴 NON CORRIGÉ »)* · gravité **2** · 2 commandes · 2026-09-03 *(⚠️ **requalifié le 2026-09-04** : l'état terminal cherché — `SENT_UNCONFIRMED` — existe déjà pour les commandes MOTEUR mais pas dans l'énumération des commandes de boîtier. Le correctif exige une **migration**, exclue d'une passe automatique par le §8. Spec prête dans la [roadmap](./ROADMAP-CORRECTIFS.md).)*

### D'abord, une réussite : [TRK-021](#trk-021) est prouvé
...
| 14/08 21:02 | `shock_on` | `TCP` ❌ | `FAILED` | idem |
| *(+ 4 autres, jusqu'au 24/05)* | `shock_on` | `TCP` ❌ | `FAILED` | idem |

Les 6 tentatives antérieures au correctif sont parties en TCP et ont toutes échoué en 15 s ; les 2
postérieures sont parties en **SMS**. Le test daté de TRK-021, en attente depuis le 15/08, **est
répondu**.

### Cause racine — le compteur qui tombe a un voisin qui monte

Les commandes SMS-only ne sont plus `FAILED` : elles sont `SENT` **pour toujours**. Le choix est
délibéré et bien argumenté (`tracker-commands.service.ts:377-382`) :
...
> fabriquer un faux échec sur une commande qui a parfaitement abouti. »*
...
Ces deux lignes occupent à demeure l'écran « commandes en attente > 10 min », l'un des quatre
compteurs suivis par l'audit. Sur les **5** en attente le 03/09, **3** relèvent du flux courant
(`fix_continuous`, 22 à 28 min) et **2 sont des résidents permanents** (2 134 et 2 340 minutes).
Laissé ainsi, ce compteur cessera de mesurer un retard pour mesurer une accumulation.

⚠️ **Jumeau exact de [TRK-007](#trk-007)** — « commandes `fix_continuous` bloquées en `SENT` à
vie » — corrigé sur le chemin TCP. *Il n'est pas revenu : un chemin neuf l'a réintroduit, sans
jamais croiser sa correction.*

### Correctif proposé

**Requalifier, ne pas raccourcir.** Au-delà d'un délai calé sur la mesure (**24 h**, six fois le
pire délai observé), une commande SMS `SENT` passe à un statut terminal **distinct de `FAILED`** —
la commande **est partie**, c'est la réponse qui manque, et la passerelle n'expose aucun accusé de
remise ([TRK-018](#trk-018), [TRK-026](#trk-026)). Elle quitte alors l'écran des commandes en
attente et rejoint une catégorie **comptable**.

### Vérification — la double condition

Les commandes SMS de plus de 24 h disparaissent de `commandes_en_attente` **et** le total de la
famille `shock_*` reste inchangé. *Si les deux tombent, on a supprimé le suivi, pas le défaut.*
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET VÉRIFIÉ SUR L'ARTEFACT SERVI le 2026-09-04 à 01:14:35** · gravité **1** ·
...
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`bacc9b44`), ET LE SUJET A CHANGÉ** · gravité **1** · famille **à lire, pas à notifier** · 2026-09-04 → 2026-09-05 *(🧹 en-tête rectifié le 2026-09-05 — ancien libellé : « CORRECTIF ÉCRIT ET COMMITÉ, NON DÉPLOYÉ ».)*

> 🎯 **Mesuré le 2026-09-05 : `speedAlertEnabled` vaut `true` sur 2 sociétés sur 5**, contre **0 sur
> 5** la veille. Un humain a tranché la décision produit que cette fiche réclamait, au moins en
> partie. Et ça se voit : **12 `OVERSPEED` le 04/09, 12 sur 12 nées d'un TRAJET** (`tripId` non nul),
> là où les 8 de la semaine précédente venaient toutes du chemin historique du boîtier — **la chaîne
> V5 écrit pour la première fois**.
>
> 🔑 **Le silence de la sentinelle nº 1 est donc désormais LÉGITIME**, et pour la bonne raison : sa
> condition — « aucune société armée alors que des excès sont mesurés » — n'est plus vraie.
> *L'instrument est capable de rendre autre chose que ce silence ; c'est ce qu'il fallait vérifier
> avant de le lire.* Le marqueur `sentinelle-chaine-vitesse-jamais-armee` est présent sur l'artefact
> SERVI, mais **aucune sentinelle n'a tourné depuis le déploiement** (derniers passages 04/09 01:05
> et 08:52) : le correctif reste **non exercé**, et il le restera probablement toujours.
>
> ⚠️ **À surveiller sans crier** : 12 alertes en un jour n'est pas le déluge de 1 317 de
> [TRK-022](#trk-022). Mais c'est le **premier jour** d'une chaîne armée. Relever le compte quotidien
> d'`OVERSPEED` au prochain passage.
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-11 à 06:30:03** · gravité **3** · 2 occurrences · 2026-09-04 → 2026-09-11 *(🧹 en-tête recalé le 13/09 : la ligne hebdomadaire porte `comptesTechniquesEcartes: 1` et ne cite plus le compte technique — voir la section datée. Ancien en-tête : « 🟠 CORRECTIF DÉPLOYÉ le 2026-09-04 à 17:01 (`68034a1d`), NON EXERCÉ ». Rectifié le 2026-09-05 — ancien libellé : « CORRECTIF ÉCRIT ET COMMITÉ, NON DÉPLOYÉ », lui-même rectifié le 04/09 depuis « 🔵 TERRAIN / action humaine ». Marqueur `comptesTechniquesEcartes` **vérifié le 05/09 sur l'artefact SERVI**. Refroidissement **hebdomadaire** : prochaine ligne attendue vers le **11/09**. **Prévenir le second titulaire reste une action humaine.**)*

> ✅ **2026-09-11 06:30:03 — EXERCÉE : le compte technique est écarté, et le « ~21 » ne pouvait pas tomber** *(relevé le 13/09)*
>
> *« **53** notifications n'ont pas pu être remises cette semaine faute d'appareil abonné, sur
> **1 compte actif** : tyger.bcn@gmail.com (53) »* — contexte **`comptesTechniquesEcartes: 1`**,
> `system@tracky.local` **absent**. Le discriminant écrit d'avance est franchi.
>
> **Mais 53 n'est pas ~21, et il fallait compter avant de conclure** — `notification_deliveries`,
> `reason = no_device`, `status = SUPPRESSED` (c'est ce que la sentinelle compte) :
>
...
>
> Le numérateur a été **multiplié par 2,5** par la tempête `agents-locaux` du plafond CLI
> ([TRK-069](#trk-069)) : chaque `CRITICAL` part vers les super-admins, et l'un d'eux n'a pas
> d'appareil. **Sans le correctif, la ligne aurait dit 106.** 🔑 *Une consigne qui prévoit un nombre
> suppose un débit ; quand le débit change, c'est la FORME qui prouve, pas le nombre* — la même
> leçon que TRK-075 le 10/09. **Prévenir le titulaire reste T6, et l'enjeu a grandi : 53 en une
> semaine.**
...
**Statut : 🟠 CORRECTIF DU MESSAGE DÉPLOYÉ le 2026-09-04 à 17:01, NON EXERCÉ** · gravité **1** ·
famille **brut** · 1 occurrence · 2026-09-04 *(🧹 en-tête rectifié le 2026-09-05 — ancien libellé :
« CORRECTIF DU MESSAGE ÉCRIT ET COMMITÉ, NON DÉPLOYÉ ». Marqueur `decrireEchecRelaisSms` **vérifié
le 05/09 sur l'artefact SERVI**. Toujours **1 seule occurrence** : le correctif attend une occasion,
et **les trois questions du coupe-circuit restent entières**.)*

### 🟢 2026-09-16 — le chantier est EN PRODUCTION, et sa première nuit n'est pas probante

`fa9ff1d1` à 17:35:05 puis `0c9672c9` à 18:14:50 UTC le 15/09 (`deploy.sh --attendre`, journal complet, arbre VPS
`main` propre), relais `724bcb8` à 17:24, `ENGINE_AUTOMATIC_CUT_ENABLED=true`. La section « 24 h de preuve » (T65)
s'applique depuis ce passage et a rendu ses six verdicts (rapport du 16/09) : **ping du S21 OK à 60 s**, sentinelle
Android **1 épisode expliqué** (S21 verrouillé 13:49 → 17:51, T55), **interlock rouge par construction** — aucune
remise SMS prouvée depuis le 14/09 07:00, la preuve manuelle du soir n'a pas été envoyée, la première preuve
automatique (T45) tombe à 02:30 UTC —, RESTORE non prouvées et « TCP seul » **non exercés**. Conséquence : **les 25
coupes de 20:00 UTC ont été refusées**, 0 `CUT` / 0 `RESTORE` / 0 SMS depuis le déploiement, 30 plannings restés
`IN_WINDOW`. *Le garde-fou a fait exactement ce que le doc 25 §12 annonçait.* Le bruit qu'il produit en le faisant
(20 `CRITICAL`, 5 e-mails) est instruit à part : [TRK-081](#trk-081). ✅ **T67** (sentinelle des RESTORE bornée à
24 h) : 0 rappel depuis 18:06 là où 28 étaient dus. **Statut inchangé** : le correctif du message reste non exercé
(0 ligne `sms-gateway`), et la fiche ne se fermera que sur une nuit **probante** — coupes acquittées, RESTORE
prouvées à 07:10, `verdict=OK` deux fois.
...
invalid input syntax for type uuid: "<ACTEUR SYNTHÉTIQUE>"`, contexte
`{ note: "échec écriture journal système (async)", action: "trips_recompute" }`.
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET VÉRIFIÉ SUR L'ARTEFACT SERVI** · gravité **2** ·
famille **brut** · 10 occurrences · 2026-09-04 *(née et close le même jour)*

### Une fiche qui naît close — et qui mérite quand même d'exister

Les 10 lignes ont été écrites le **04/09 entre 14:45:00 et 16:55:16** : c'est la source **la plus
bruyante des dernières 24 h**, et elle était **inconnue du référentiel** au moment de la collecte.
Le correctif `19d7d76c` a été commité le même jour à **15:51 UTC** par une session parallèle, et
déployé à **17:01:33**.

> ⚠️ **Elle est consignée malgré tout.** Un défaut trouvé et corrigé le jour même reste un défaut qui
> a existé en production, et le motif qu'il porte est en train de devenir une famille — voir la
> parenté ci-dessous. *Une fiche qu'on n'écrit pas parce que « c'est déjà réglé » est une fiche dont
> personne ne reconnaîtra le motif la fois suivante.*

### Cause racine

Le journal de recalcul, ajouté le matin même, passait `triggeredByUserId` à
`systemActivityLog.create()`. Or l'automatisation appelle `recompute()` avec un utilisateur
**synthétique** — `trip-automation.service.ts:1251`, `id: 'system-trip-automation'` — qui n'est pas
un UUID. La colonne en est un : Postgres refuse l'écriture (`22P02`).

### 🔴 Le coût n'était PAS le bruit

Le journal est *fire-and-forget* : le recalcul lui-même **réussissait**. Ce qui échouait, c'était la
trace — donc :

> **Aucun recalcul automatique ne laissait de trace.** Précisément ceux qu'un client ne peut pas
> expliquer quand ses trajets changent tout seuls.

*Une ligne rouge dans le centre d'alerte disait « écriture de journal échouée » ; ce qu'elle voulait
dire était « le journal ne journalise plus la moitié de ce qu'il devrait ».*

### Correctif appliqué (`19d7d76c`)

`acteurHumain()` teste la **forme UUID** — pas l'existence en base, car c'est le format qui fait
échouer l'écriture. Selon l'origine : un humain garde son `triggeredByUserId` ; une machine laisse ce
champ **vide** et **`actor` NOMME l'origine**. *Écrire l'un ou l'autre selon l'origine vaut mieux que
de perdre la trace.*

⚠️ Le jeu d'essai existant a révélé au passage que **son propre acteur, « u1 », n'était pas un
UUID** : il décrivait un appelant qui ne peut pas exister en base. *Un harnais qui ne peut pas
reproduire la production ne protège de rien.*

### Vérification — faite le 2026-09-05, et les DEUX moitiés y sont
...
> 🔑 **C'est la double condition, et elle est indispensable ici.** Un correctif qui se serait contenté
> de retirer le champ fautif aurait rendu **le même zéro à gauche** — et un zéro à droite. *La trace
> est revenue ; c'est ça, la preuve.*

### Parenté — le motif « acteur non humain » a maintenant deux occurrences

[TRK-065](#trk-065) écartait un **compte technique** du décompte d'une sentinelle ; celle-ci écarte
un **acteur machine** d'une colonne d'auteur. Dans les deux cas, du code écrit pour des humains a
reçu une machine et n'avait pas de case pour elle. *Il vaut la peine de chercher les autres endroits
où un identifiant d'utilisateur est exigé d'un appelant automatique.*
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ EN PRODUCTION le 2026-09-12 à 00:00:23** · gravité **2** · famille **brut** · 2 occurrences · 2026-09-04 → 2026-09-12 · *(🧹 en-tête recalé le 13/09 : ligne exercée sous sa forme corrigée — 503, `ERROR`, dépendance et conséquence nommées, motif technique conservé, pas de jumelle `CRITICAL`. Ancien en-tête : « 🟠 CORRECTIF DÉPLOYÉ le 2026-09-07 à 00:58:58 (`c80632ba`), NON EXERCÉ ». Recalé le 07/09 : `AbortSignal` et `ServiceUnavailableException` vérifiés sur l ARTEFACT SERVI. Ancien en-tête : « 🔴 NON CORRIGÉ ». ⚠️ **Déployé n est pas prouvé** — aucun rejet de transport depuis le 04/09 12:57)*

> ✅ **2026-09-12 00:00:23 — EXERCÉE, ET LES QUATRE CONDITIONS TOMBENT AU MOT PRÈS** *(relevé le 13/09)*
>
> `http | ERROR | Vizyo Auth est injoignable : l'appel POST /v1/auth/refresh n'a pas pu aboutir. La
> session de l'utilisateur ne peut pas etre verifiee : il va etre deconnecte. Motif technique :
> aucune reponse en 8 s.` — contexte `statusCode: 503`, route `POST /api/auth/refresh`, un mobile
> Android (`requestId 16397`).
>
> | Condition écrite le 06/09 | |
> |---|---|
> | `statusCode 503`, pas 500 | ✅ |
> | `ERROR`, pas `CRITICAL` | ✅ — `http CRITICAL` reste à **2** (04/09) : **pas de jumelle**, la double condition tient |
> | Nomme la dépendance **et** la conséquence | ✅ « Vizyo Auth » · « il va être déconnecté » |
> | Motif technique **conservé** en fin de phrase | ✅ « aucune réponse en 8 s » — *le délai de 8 s, c'est le correctif qui le pose* |
>
> ⚠️ **Une coïncidence, un seul point** : l'appel est parti vers 00:00:15, et `logrotate.timer` et
> `dpkg-db-backup.timer` se déclenchent à **00:00:03** sur l'hôte. Si une seconde ligne tombe à
> minuit, poser la question du logrotate des journaux Docker (stanza générique de l'hôte, cf. la
> passe du 25/08). **Trois points ou rien.**

### Ce qui a été observé

Une seule ligne, le **04/09 à 12:57:05**, depuis un iPhone (`iPhone OS 18_7`, Safari 26.6.1),
`requestId 1396`. C'est l'un des **deux seuls `CRITICAL` actifs** du centre d'alerte.

### Cause racine

`auth-client.service.ts`, méthode privée `request()` : l'appel à **Vizyo Auth** est un `fetch`
**sans `try/catch` et sans délai d'expiration**.

```ts
const res = await fetch(url, { method, headers, body: … });
if (!res.ok) { … }   // ← ce cas-là est bien traité
```

Le cas `!res.ok` est correctement instruit (401/403 → `UnauthorizedException`, autre → `Error`
nommée avec le statut et le corps). C'est **uniquement le rejet de transport** — DNS, connexion
coupée, TLS — qui remonte nu jusqu'à NestJS, lequel en fait un **500**.

### Trois défauts dans la même ligne

| # | Défaut | Pourquoi ça compte |
|---|---|---|
| 1 | **Message BRUT** — `fetch failed` | Ne nomme ni la dépendance (**Vizyo Auth**), ni l'opération (rafraîchir un jeton), ni la conséquence (l'utilisateur va être déconnecté) |
| 2 | **Code HTTP faux** — 500 | Une dépendance injoignable est un **503**. Un 500 dit « nous avons un bug » : le client ne peut pas distinguer « réessaie » de « ta session est morte » |
| 3 | **Niveau `CRITICAL`** | Pour une panne de transport d'un tiers sur **un seul** rafraîchissement. Le raisonnement de [TRK-037](#trk-037) et [TRK-061](#trk-061) conduit à `DEGRADATION` |

> 🔑 **C'est la TROISIÈME récidive du même motif, sur une troisième chaîne.**
> [TRK-060](#trk-060) : `system-metrics` rendait `EAI_AGAIN` brut. [TRK-066](#trk-066) :
> `sms-gateway` rendait `The operation was aborted due to timeout`. Ici : `fetch failed` sur
> l'authentification. *Trois fois, un `fetch` vers une dépendance a servi son erreur de transport
> telle quelle. Ce n'est plus une inattention, c'est un défaut de fabrique : **aucun appel sortant de
> ce dépôt n'a de gabarit de message d'échec**.*

### Correctif proposé

1. Envelopper le `fetch` de `request()` : `signal: AbortSignal.timeout(…)` et capture du rejet de
   transport.
2. Lever une `ServiceUnavailableException` (**503**) dont le message nomme **Vizyo Auth**,
   l'opération et la conséquence — **motif technique conservé en fin de phrase** et dans le contexte.
   *On change l'ordre, on n'efface pas la preuve* (règle de TRK-060 et TRK-066).
3. **Traiter le jumeau** : `verifyLoginCode()` appelle `fetch` en direct, avec le même angle mort.
   *Un défaut corrigé d'un seul côté revient toujours par l'autre.*
4. Envisager le gabarit commun que les trois fiches réclament désormais.

### Vérification

Au prochain échec de transport vers Vizyo Auth : la ligne porte `DEGRADATION`, nomme la dépendance,
et la réponse HTTP est un **503**. ⚠️ **Le motif technique doit rester lisible** — s'il disparaît, on
a nettoyé l'écran au lieu de traduire le message.
...
**Statut : 🔵 TERRAIN** · gravité **2** · famille **angle mort** · **3 occurrences** · vue la 1ʳᵉ fois le 2026-09-05 *(création, 0 occurrence)*, **premières lignes le 2026-09-06**

> 📈 **Mise à jour du 2026-09-06 — l'instrument a parlé au premier matin sans poste.** Ce que cette
> fiche annonçait (« la première est attendue au premier matin où le poste n'aura pas tourné ») est
> arrivé, et les trois lignes se répondent :
>
...
>
> **Trois motifs distincts, aucune redondance** : le refroidissement a tenu. Les deux agents pointent
> vers le même moment — **le poste a cessé de travailler dans la soirée du 05/09**. Un raisonnement
> en « 2 × cadence » n'aurait rien dit avant le **07/09** : *48 h gagnées sur l'écran que cette
> sentinelle complète.*
>
> ⚠️ **Elle fait passer les `CRITICAL` actives de 2 à 5.** C'est un capteur qui s'allume, **pas** une
> plateforme qui se dégrade. À relire dans quelques jours : si un PC éteint chaque nuit produit trois
> `CRITICAL` chaque matin, c'est le **niveau** qu'il faudra rediscuter, jamais la sentinelle.

> 📏 **2026-09-13 — 25 lignes en trois jours pour UNE cause : le plafond hebdomadaire de la CLI du poste.**
>
> Du **10/09 02:00:02** au **13/09 06:00:02** UTC, `passages_agents_locaux` porte **36 passages en
> échec** avec la même phrase : `echec de la CLI : You've hit your weekly limit · resets Sep 13, 12pm
> (Europe/Paris)`. `rattrapage-recits` 25, `courrier-ia` 4, `agent-recit-trajet` 1 sur 72 h —
> **0 succès**. Les deux agents qui n'appellent pas de modèle ont tourné normalement
> (`agent-limites-vitesse` 11/11, `agent-qualite-gps` 2/2) : *le poste était allumé, seule la CLI
> refusait.* `ai_usage_logs` (`executor = local`) : 199 appels réussis le 09/09, **0 les 10, 11 et
> 12/09**, puis **30 dès 10:12:17 UTC le 13/09** — douze minutes après la remise à zéro. La file
> `travaux_ia_locaux` porte 7 échecs définitifs (→ source `travaux-ia`, 6 lignes) et 10 travaux en
> attente. **Les deux audits quotidiens — même CLI — n'ont pas tourné non plus** (centre d'alerte :
> 11 et 12/09 ; VPS : du 10 au 13/09). 80 heures, et rien de cassé sur la plateforme.
>
> 🔑 **Ce que la fiche annonçait à sa création est arrivé, sous une autre forme** : *« c'est le
> NIVEAU qu'il faudra rediscuter, jamais la sentinelle »*. 25 `CRITICAL` (19 encore ouvertes) plus
> 6 `ERROR` `travaux-ia` pour dire une seule chose — **une cause commune doit produire UNE ligne**,
> en `DEGRADATION` (la cause est connue et extérieure), avec un refroidissement par cause (**T31**).
> Et le plafond lui-même est une décision d'exploitation : **trois canaux IA, trois plafonds, zéro
> canal ouvert** — le repli du repli n'avait pas de plan (**T32**, cf. [TRK-071](#trk-071)).
>
> ⚪ **Bruit distinct, à retirer du niveau `CRITICAL` par la même occasion** : « Passage manqué :
> `agent-limites-vitesse` » à **04:50 UTC trois jours de suite** (10, 11, 12/09), refermé seul à
> 06:50 (« repassé à 08:30 Paris ») — la cadence déclarée (6,5 h) ne tombe pas sur l'horaire réel.
...
**Signature** — `ASSISTANCE | ERROR | Assistance à reprendre — <EMAIL> : <MOTIF>` (variante urgente : `RAPPEL URGENT — <EMAIL> : <MOTIF>`, en `CRITICAL`). Contexte : `conversationId`, `userId`, `fleetId`, `gravite`.
**Statut : 🟠 CORRECTIF DÉPLOYÉ le 2026-09-07 à 00:58:58 (`2112e9ae`), NON EXERCÉ** · gravité **2** · famille **circulaire** · 2 occurrences · 2026-09-06 · *(🧹 en-tête recalé le 07/09 : marqueur `causeTechnique` ×5 vérifié sur l ARTEFACT SERVI et ancienne règle de niveau disparue. Ancien en-tête : « 🔴 NON CORRIGÉ ». ⚠️ **Déployé n est pas prouvé** — aucun échec IA depuis le 05/09 17:00, la double condition reste à exercer)*

### Ce que ça veut dire

Un seul incident « le compte du fournisseur IA n'a plus de crédit » produit **deux** lignes au centre
d'alerte, à 14 millisecondes d'intervalle — et la seconde annule le bénéfice de la première :

| Ordre | Ligne | Niveau |
|---|---|---|
| 1 | « Assistance IA indisponible : … Action : recharger le compte. » | ✅ `DEGRADATION` |
| 2 | « Assistance à reprendre — admin@… : **Classement indisponible** » | 🔴 **`ERROR`** |

La première est le correctif du chantier C3 (point 5) et de [TRK-061](#trk-061) : un compte à sec est
une **dégradation assumée**, pas un défaut de la plateforme. La seconde le **recompte comme un
défaut**, sous un autre libellé.

### Cause racine

`assistance-ai.service.ts:153-155` — quand l'appel IA échoue, le `catch` fait deux choses :

1. `tracerErreur(e, user, 'classement')` → `classerEchecIa(err)` → niveau `DEGRADATION`, `kind` et
   `motifFournisseur` au contexte. **C'est juste.**
2. `return this.sansIaReponse(REPONSE_INDISPONIBLE, 'LOW', true, 'Classement indisponible')` — le
   `true` est une **escalade**, qui remonte à `assistance.service.ts:135` :
   `if (r.escalade) await this.signalerReprise(user, conv.id, r.motifEscalade, r.gravite)`.

Et `signalerReprise` décide son niveau ainsi (`assistance.service.ts:203`) :

```ts
const niveau = urgent || gravite === 'CRITICAL' ? 'CRITICAL' : 'ERROR';
```

`LOW` n'étant ni `urgent` ni `CRITICAL`, **le repli technique sort en `ERROR`**.

> 🔑 **La règle de niveau est écrite sur la GRAVITÉ de la conversation, jamais sur la CAUSE de
> l'escalade.** Elle ne peut donc pas distinguer « un utilisateur a vraiment besoin d'un humain »
> de « l'IA était en panne, on a rendu la main ». *Deux situations opposées, un seul niveau.*

Mesuré le 05/09 : à **12:23:59** la paire était `ERROR` + `ERROR` (avant le correctif C3) ; à
**17:00:35**, après, `DEGRADATION` + `ERROR`. **Le correctif a supprimé la moitié du bruit.**

C'est le motif de [TRK-004](#trk-004) — *« le même défaut existe dix lignes plus loin sur un chemin
voisin »* — et celui de [TRK-061](#trk-061) — *« un incident, deux lignes »* — rejoués sur une
quatrième chaîne.

### Correctif proposé

Distinguer les deux natures d'escalade, qui n'ont rien à voir :

- escalade **décidée par l'assistant sur le contenu** de la conversation → garder `ERROR` : c'est un
  signal produit légitime, quelqu'un attend un humain ;
- escalade qui n'est qu'un **repli sur une panne technique déjà consignée** → ne pas écrire de
  seconde ligne au centre d'alerte, ou l'écrire **au niveau déjà décidé pour cet incident**.

Concrètement : passer à `signalerReprise` la cause du repli (un `kind` optionnel, issu de
`classerEchecIa`) et, quand elle est renseignée, aligner le niveau sur celui de l'incident d'origine.
Les chemins de `sansIaReponse` qui suivent un `tracerErreur` sont tous concernés — les chercher tous,
c'est la leçon de TRK-004.

⚠️ **Le journal système (`assistance_escalade`) doit continuer à écrire dans les deux cas.**
L'escalade est un fait ; ce qui est en cause est l'endroit où elle se lit, pas son existence.

### ⚠️ Ce qu'il ne faut PAS faire

- **Ne pas supprimer la ligne d'escalade** : une vraie demande de reprise humaine doit rester
  visible. On corrige son NIVEAU quand elle est un repli technique, pas son existence.
- **Ne pas abaisser tout `signalerReprise` à `DEGRADATION`** : une escalade décidée sur le contenu
  est un défaut de service, et elle vaut `ERROR`.

### Vérification

Au prochain échec IA, il ne doit rester **qu'UNE** ligne `ASSISTANCE` pour l'incident, en
`DEGRADATION`, et le journal système doit porter son `assistance_escalade`.
🔴 **Double condition — un seul compteur doit tomber :** si les deux lignes disparaissent, on a
supprimé la trace de l'escalade au lieu de la classer.

---

## TRK-071

**Signature** — `AI_ROUTER | DEGRADATION | Repli IA en échec : <DE> → <VERS> (<KIND>) — <MOTIF>`. Contexte : `de`, `vers`, `kind`, `motifFournisseur`.
**Statut : 🔵 TERRAIN** *(l'action est humaine : recharger un compte)* · gravité **1** · famille **terrain** · 1 occurrence · 2026-09-06

### Ce que ça veut dire

**Les deux comptes de fournisseur IA sont à sec en même temps.** Le repli automatique
`claude → gpt`, livré le 05/09 (`b62ba508`, chantier C3 point 1), a été exercé **six minutes après sa
mise en ligne** et n'avait nulle part où aller :
...
Le compte **Anthropic** est vide depuis le **03/09 00:13** ; le compte **OpenAI** est constaté vide
le 05/09 à 12:23.

### Ce n'est PAS un défaut logiciel

`ai-router.service.ts:460-463` classe correctement : `err.transient ? 'DEGRADATION' : err.niveau`,
et `provider_unfunded` est mappé sur `DEGRADATION` avec quarantaine longue (15 min). La ligne nomme
le moteur de départ, celui d'arrivée, la sorte d'échec et le motif du fournisseur. **L'instrument a
parlé juste, au premier exercice.**

> 🔑 **Un mécanisme de secours ne vaut que par la ressource qu'il vise.** Le routeur bascule, échoue,
> l'écrit, le date et le classe — et le résultat pour l'utilisateur est identique à l'absence de
> repli. *Livrer une redondance sans provisionner sa cible, c'est livrer une ligne de journal.*

### Action

**Humaine, et elle seule** : recharger **au moins un** des deux comptes. Tant que les deux sont
vides, [TRK-061](#trk-061), [TRK-070](#trk-070) et cette fiche décrivent le même fait par trois
portes différentes.

### ⚠️ Ce qu'il ne faut PAS faire

- **Ne pas ajouter un troisième fournisseur** pour « fiabiliser le repli » : le défaut n'est pas le
  nombre de moteurs, c'est qu'aucun n'est provisionné.
- **Ne pas faire taire cette ligne.** Elle est en `DEGRADATION`, donc déjà non comptée comme défaut,
  et elle est la seule preuve datée que le repli a été exercé.

### Vérification

Après recharge, l'appel doit repartir sans écrire de ligne `AI_ROUTER`. Si un seul compte est
rechargé, le repli doit **aboutir** — donc, là encore, **plus aucune ligne**.

---

## TRK-073

**Signature** — *absence de ligne, pas de message* : `trip_automation_runs` sans ligne pour un créneau
horaire où `system_activity_logs` porte un `trips_recompute` d'acteur `system-trip-automation`.
Symptôme visible en aval : `scheduled-task-heartbeat | CRITICAL | Tâche planifiée à l'arrêt : « Automatisation des trajets » est ACTIVÉE mais ne tourne plus — dernier passage il y a <DURÉE>…`
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-08 à 17:12:05** (`dae97b03` + `dc35f1a3`)
*(en-tête rectifiée le 2026-09-09 ; libellé antérieur conservé en clair : « 🔴 NON CORRIGÉ »)*
· gravité **1** · famille **mensonger** · 8 créneaux perdus le 06/09 · 2026-09-06 → 2026-09-08

> ✅ **PROUVÉ LE 2026-09-09, ET LA CONSIGNE ÉTAIT ÉCRITE D'AVANCE.** Le 08/09 porte **24 passages sur
> 24, dont exactement UN marqué `interrupted`** — celui de 05:45:00, tué en vol par le déploiement de
> 05:45. Les deux moitiés du test sont franchies **séparément** : le compte monte à 24, *et* la ligne
> manquante n'a pas été fabriquée. Série : 05/09 **23** · 06/09 **16** · 07/09 **17** · 08/09 **24**.
>
> **Le correctif** : la ligne naît avec le passage (`status = 'running'`, migration
> `20260908053000`), la **même** ligne se complète à la clôture (`done`, ou `failed` sur exception),
> et une ligne restée `running` au démarrage de l'API devient `interrupted` — journal d'activité +
> `CRITICAL`. Rien n'est relancé : le passage suivant reprend le reste à faire.
>
> 🆕 **Signature du témoin neuf, à reconnaître et non à ré-instruire :**
...
> **C'est la voix du correctif, pas un défaut** — d'où l'absence de fiche propre.
>
> ⚠️ **La toute première ligne dit « 0 min », et c'est un fossile.** Le commit `3d6834b8` (08/09
> 07:51 Paris) corrige la formulation **six minutes** après cette ligne ; l'artefact servi porte
> « moins d'une minute ». *Une ligne écrite avant son correctif de formulation ne se relit pas comme
> une régression.*
>
> 🔴 **Ce que le correctif crée, et qui est déjà traité** — depuis `f988c74e`, **une seule `CRITICAL`
> suffit à envoyer un e-mail**. Un déploiement pendant un passage horaire en enverrait donc un à
> chaque fois. Le garde-fou : `deploy.sh` **refuse de partir** quand une ligne `status = 'running'`
> est ouverte (`fd87ca46`). **Vérifié présent sur le VPS** — `/opt/vizyo-tracky/deploy/vps/deploy.sh`,
> arbre git **propre** au commit `578038d0`. *Sans lui, on aurait échangé huit passages muets contre
> un e-mail à chaque mise en ligne.*
>
> ⚠️ **`trip_automation_runs` ne garde que 100 lignes.** Le 04/09 valait **22** mesuré le 06/09 et
> vaut **19** ce jour : la journée la plus ancienne de la fenêtre **s'érode par le bas**. *La lire
> comme une baisse fabriquerait une dégradation de toutes pièces* — la mise en garde avait été écrite
> le 08/09, et c'est la première fois qu'elle sert.
>
> ⚠️ **L'audit du 08/09 cherchait `EN_COURS` sur l'artefact et le trouvait absent.** Le correctif
> avait livré la même idée sous un autre nom (`status = 'running'`). *Chercher le mot d'une
> spécification plutôt que le comportement qu'elle décrit fait manquer un correctif présent.*

### Ce que ça veut dire

Le 06/09, `trip_automation_runs` porte **16 lignes au lieu de 24**. Manquent : **10:45**, puis
**13:45 → 19:45**. Le témoin de vie en a conclu que la tâche « ne tourne plus » et a écrit quatre
`CRITICAL`.

**La tâche tournait.** Sept des huit créneaux manquants portent la preuve positive d'un passage :

| Créneau | `trips_recompute` | `actor` | Ligne d'historique |
|---|---|---|---|
| 10:45 · 13:45 · 14:45 · 16:45 · 17:45 · 18:45 · 19:45 | ✅ à `:45:00` | `system-trip-automation` | ❌ |
| 15:45 | *(rien à recalculer — indécidable)* | — | ❌ |
| **20:45** | ✅ | `system-trip-automation` | ✅ *(22 recalculés, 28 analysés)* |

Le passage de 13:45 a **supprimé 9 trajets et en a recréé 3** : ce n'est pas une opération à vide.
Le créneau 15:45 est seulement *indécidable* — un passage sans rien à recalculer n'écrit pas de ligne
de recalcul, comme 02:45, 03:45, 04:45 et 06:45, qui ont pourtant leur ligne d'historique.

### Deux hypothèses écartées par la mesure

1. **La garde anti double-run de [TRK-043](#trk-043)** — non. Depuis son correctif, un tick annulé
   laisse une trace (`trip_automation_tick_annule`). Sur **7 jours** : **une seule**, le 04/09 à
   08:45. Aucune le 06/09. *Le correctif de TRK-043 tient — et c'est justement la trace qu'il a
   ajoutée qui permet de l'innocenter. Un correctif qui rend son propre silence lisible se laisse
   mettre hors de cause.*
2. **Le passage a échoué** — non plus. `run()` enveloppe tout son corps dans un `try` dont le `catch`
   écrit un `CRITICAL` (`trip-automation.service.ts:496-498`, `phase: 'run'`). **Aucune ligne
   `TRIP_AUTOMATION` le 06/09** ; les deux dernières datent des 24 et 29/08.

Il reste une seule lecture : **ni abouti, ni échoué — interrompu.**

### Cause racine

`trip-automation.service.ts`, méthode `run()` : `persistRun()` (qui écrit `lastRunAt`) et
`recordRun()` (qui écrit la ligne d'historique) sont appelés **ligne 470-471**, après tout le
travail, **sur le seul chemin heureux**. Le `catch` de la ligne 496 n'écrit qu'au centre d'alerte,
jamais dans la table d'historique.

> 🔑 **`trip_automation_runs` ne peut structurellement contenir que des succès.** Un passage
> interrompu y est indiscernable d'un passage qui n'a jamais eu lieu, et l'écran qui annonce
> « 16 passages » ne mesure pas ce qui a tourné : il mesure ce qui a fini.

**Et le témoin lit cette jauge.** `scheduled-task-heartbeat` juge le silence depuis `lastRunAt`.
Un passage interrompu ne le met pas à jour ; au bout de 4 h, le témoin déclare « à l'arrêt » une
tâche qui a tourné quatre fois entre-temps. **Le témoin ne ment pas — il lit fidèlement une jauge
qui ment.** C'est le profil de [TRK-008](#trk-008) et [TRK-043](#trk-043) : un traitement dont le
silence n'est pas informatif.

### Correctif proposé

Poser la marque de passage **au DÉPART**, pas à l'arrivée :

1. écrire la ligne d'historique (ou au minimum `lastRunAt`) **avant** la boucle de travail, avec un
   état `EN_COURS`, puis la compléter à la clôture. **La donnée du départ est déjà persistée** — la
   garde de TRK-043 lit `dernierDepartPersiste()` ; elle n'est simplement pas celle que le témoin
   regarde ;
2. au démarrage du service, refermer les lignes restées `EN_COURS` avec un motif explicite
   (« passage interrompu — le service a redémarré »), comme la sentinelle des agents du poste sait
   déjà écrire « passage interrompu avant la fin ».

⚠️ **Ne pas corriger le témoin.** Le défaut est en amont, dans le point de mesure. Relever le seuil
de 4 h ou faire taire `scheduled-task-heartbeat` échangerait un message faux contre un silence faux.

⚠️ **Vérification qui porte sur la CAUSE** : au prochain jour comportant un redéploiement,
`trip_automation_runs` doit porter **24 lignes**, dont une ou plusieurs **marquées interrompues** —
et non 16 lignes toutes en succès. *Si le compte monte à 24 sans qu'aucune ne soit marquée
interrompue, on a maquillé le carnet au lieu de le tenir.*

### Sur la cause de l'interruption elle-même — hypothèse, pas mesure

L'historique git montre **neuf commits entre 16:39 et 19:45 UTC** le 06/09, et un déploiement
**mesuré** à 00:58:58 UTC le 07/09. Un passage dure de 1 à 15 min ; un redéploiement pendant ce temps
tue la ligne de clôture. Cohérent avec la fenêtre observée, **sans en être la preuve** : les
redémarrages intermédiaires ne sont plus observables (`StartedAt` ne garde que le dernier).

**Le défaut ci-dessus ne dépend pas de cette hypothèse.** Quelle que soit la cause de
l'interruption, le carnet devrait la consigner — et [TRK-043](#trk-043) avait écrit son critère
d'acceptation comme « 24 lignes **moins un par redéploiement** », c'est-à-dire en acceptant d'avance
que le carnet perde des passages. *Un critère qui absout la perte empêche de la voir.*

### Série mesurée

| Jour | Passages / 24 | Analyses |
|---|---|---|
| 02/09 | 15 | 221 |
| 03/09 | 23 | 273 |
| 04/09 | 22 | 246 |
...
⚠️ **Fait mesuré, pas tendance** — mais la grandeur est stable par nature : 24 créneaux par jour,
définition inchangée. Premier relevé de cette série ; les suivants la rendront dicible.

---

## TRK-092

**Signature** — `email | ERROR | Unable to fetch data. The request could not be resolved.` (contexte `template: error_rate_alert`) ;
`sims-sync | ERROR | WhereverSIM injoignable : fetch failed` ; `positions | ERROR | Invalid prisma.engineControlCommand.findFirst()
invocation: getaddrinfo EAI_AGAIN tracky-postgres` ; `wire-logger | ERROR | Invalid prisma.wireLog.create() invocation: getaddrinfo
EAI_AGAIN tracky-postgres`.
**Statut : ⚪ BRUIT** · gravité **4** · famille **brut** · 5 lignes le 20/09 03:10 → 16:17 · 2026-09-21

### Cinq messages de transport bruts pendant l'étranglement du VPS et le reboot

**Ce qui a été mesuré.** Le 20/09, sous VPS-045 (VM à 10 % de son CPU) puis pendant le reboot V4 (16:17 → 16:20) : `email` à 03:10:10
et 07:10:04 — l'e-mail `error_rate_alert` n'a pas pu être remis au fournisseur (« Unable to fetch data. The request could not be
resolved. » est le libellé du SDK pour une erreur réseau), **renvoyé et `DELIVERED` 10 min après** dans les deux cas ; `sims-sync` à
04:30:08 — la synchronisation WhereverSIM (`whereversim.client.ts:129`) n'a pas abouti, prochaine à 06:30 ; `positions` et
`wire-logger` à 16:17:42 / 16:17:47 — Docker avait déjà retiré la résolution de `tracky-postgres` pendant que l'API vivait encore
(`coban-wire-logger.service.ts:35-65` écrit l'erreur Prisma telle quelle). **Aucune conséquence mesurée** : les e-mails sont partis,
la synchro a repris, le reboot était voulu.

**Cause racine, en une phrase.** Aucun appel sortant de ce dépôt n'a de gabarit de message d'échec : c'est la **5ᵉ récidive** du motif
de [TRK-060](#trk-060) (`system-metrics`), [TRK-066](#trk-066) (`sms-gateway`), [TRK-068](#trk-068) (`http` → Vizyo Auth) — chacune
corrigée **localement**, jamais au niveau de `ErrorLogger`. La traduction réseau (`/EAI_AGAIN|ENOTFOUND|ECONNREFUSED|ETIMEDOUT/`)
existe dans `metrics-collector.service.ts:32` et nulle part ailleurs.

**Correctif proposé.** Un gabarit commun « *<dépendance>* injoignable : *<conséquence>* — motif technique : *<brut>* », appliqué dans
`ErrorLogger.record()` quand le message correspond au motif réseau et que la source est connue (`email` → « le fournisseur d'e-mail
n'a pas répondu : l'alerte sera renvoyée au prochain cycle », `sims-sync` → « WhereverSIM injoignable : l'inventaire des SIM date
de HH:MM, prochaine synchronisation à HH:MM », Prisma `EAI_AGAIN` → « la base est injoignable (résolution DNS) : … »). **Double
condition** : le motif brut reste en fin de phrase (*sinon on a nettoyé l'écran au lieu de traduire*, cf. TRK-066), et une vraie
erreur d'appel (400, contrainte) n'est jamais habillée en panne réseau.

**À ne pas faire.** Ne pas archiver ces 5 lignes : elles datent l'étranglement et le reboot mieux que le journal du conteneur.

---

## TRK-091

**Signature** — `engine-control-restore | CRITICAL | Worker RESTORE en erreur — intention conservée pour reprise` — contexte
`error: Invalid prisma.engineDeliveryAttempt.create() invocation: Unique constraint failed on the fields: ("commandId","attemptNumber")`,
`commandId`, `imei` (**pas de plaque** — [TRK-085](#trk-085)) ; sur la commande, `lastError = Worker RESTORE en erreur : Invalid
prisma…` ; `engine_delivery_attempts` ne porte **qu'une** tentative nº 1.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **3** · famille **course** · 6 commandes, 4 lignes (+1 fondue) le 20/09 · 2026-09-21 · 👉 **T78**

### Le worker RESTORE ré-émet une commande dont le premier envoi est encore en vol, et écrit « en erreur — intention conservée » sur une remise en route acquittée

**Ce qui a été mesuré (20/09, VM à 10 % de CPU).** EY-613-MF (RESTORE 03:00:41, ligne 03:01:28) et **cinq CDEF31 nées entre
05:02:59 et 05:05:44** — GR-294-VW, GS-878-NX, HD-584-BF, HD-603-XY, HD-998-XY — lignes à 05:03:18, 05:04:22, 05:05:38 (+1 fondue
par l'anti-flood de 60 s). **Les six sont `ACKNOWLEDGED` par TCP 6 à 17 s après leur création.** GR-294-VW au détail : créée
05:02:59,313 → tentative nº 1 écrite 05:03:02,314 (+3,0 s) → trame `K;` journalisée 05:03:03,109 → `kt` du boîtier 05:03:05,210 →
rapprochement `ack` 05:03:10,015 → `ackedAt` 05:03:16 → **`CRITICAL` « Worker RESTORE en erreur » à 05:03:18**, deux secondes après
l'accusé. `engine_delivery_attempts` : une seule ligne, nº 1, `ACKNOWLEDGED` — **la contrainte unique (T53) a fait son travail**.

### Le mécanisme

1. `createCommand` (`engine-control.service.ts:1131`) crée la RESTORE `status: PENDING`, `nextAttemptAt: new Date()` — **sans
   `dispatchLeaseUntil`** — puis la dispatche **en ligne** (`dispatchBounded`, :1228 → `dispatchCommand`, :1792).
2. Le worker `processPendingRestores` (`@Cron('*/15 * * * * *')`, :2193) sélectionne `PENDING … nextAttemptAt ≤ now … bail NUL ou
   expiré` (:2199), **pose son propre bail** (:2216) — le seul que le code connaisse — et appelle `dispatchCommand` à son tour (:2292).
3. `dispatchCommand` **écrit la trame sur la socket d'abord** (`sessionRegistry.send`, :1808) et **ouvre la tentative ensuite**
   (`beginAttempt`, :1951), dont le numéro est `attemptCount + 1` **lu sur l'objet en mémoire** (:1770) — celui du `findMany` du tick,
   donc `0` pour une commande que le dispatch en ligne est en train de passer à `1`.
4. Le `create` tombe sur la contrainte ; le `catch` du worker (:2404) écrit `lastError` brut + `nextAttemptAt: +30 s` sur la commande
   (`where ackedAt: null`) et une **`CRITICAL`** « intention conservée pour reprise ».

En temps ordinaire le dispatch en ligne prend 50–100 ms (création → `sentAt`) et le worker ne voit jamais la commande `PENDING`.
Le 20/09, à 89 % de steal, il a pris **3 à 4 s**, et le tick de 05:03:00 a trouvé 5 commandes sur 27 dans cette fenêtre.

### Ce que ça coûte

- **Une seconde trame `K;` sur la socket** par commande touchée — écrite par le worker avant que la contrainte l'arrête ; **invisible
  dans `wire_logs`**, dont la ligne `OUT` n'est écrite qu'après la tentative (:1953). Pour une RESTORE la trame est idempotente ; pour
  une CUT le chemin n'existe pas (seul le worker RESTORE ré-émet).
- **4 `CRITICAL` fausses** (+1 fondue), un e-mail « erreurs critiques », et un `lastError` Prisma brut **sur 5 commandes réussies** —
  l'écran « Commandes moteur » montre « Worker RESTORE en erreur » sur des remises en route acquittées.
- Le `nextAttemptAt: +30 s` posé par le `catch` est sans effet ici (l'ACK ferme la commande avant), mais sur une commande qui aurait
  tardé à être acquittée il aurait fait partir **une troisième trame**.

**Cause racine, en une phrase.** Deux émetteurs — le dispatch en ligne et le worker — partagent une commande sans partager le bail
qui doit les exclure, numérotent leurs tentatives depuis une copie mémoire, et la contrainte de base n'arrête le doublon
**qu'après** la trame, puis le traduit en panne.

### Correctif proposé *(même chantier que T71 — TRK-083)*

1. `createCommand` pose **`dispatchLeaseUntil = now + ENGINE_DISPATCH_LEASE_MS`** à la création : le dispatch en ligne est le premier
   détenteur du bail ; le worker le respecte déjà (:2206, :2221). Le dispatch le libère (déjà fait, :1972).
2. `beginAttempt` numérote **depuis la base** (`max(attemptNumber) + 1` sous le bail, ou relecture de `attemptCount` par
   `SELECT … FOR UPDATE`), pas depuis l'objet passé en argument.
3. **La ligne d'attempt, puis le guetteur, puis la trame** — `beginAttempt` et `waitForAck` **avant** `sessionRegistry.send` ; c'est le
   geste de T71, et il ferme les deux fiches d'un coup.
4. Dans le `catch` du worker, une `P2002` sur `engine_delivery_attempts` **n'est pas une panne** : `logger.warn` « commande déjà en
   cours de dispatch », **pas de `lastError`, pas de `CRITICAL`**, relecture de la commande au tick suivant.

**Vérification (double condition)** : au prochain matin chargé (`%steal` > 20 % à 05:00 UTC, ou un `pg_sleep` de 3 s en recette),
**0 `Unique constraint`** et **0 `CRITICAL` « Worker RESTORE en erreur » sur une commande acquittée** ; **et** une RESTORE dont le
dispatch en ligne échoue vraiment (socket absente, crash entre `create` et `dispatch`) **est toujours reprise par le worker au tick
suivant** — `isOrphanPending` (:1519) et T48 restent exercés.

**À ne pas faire.** Ne pas retirer la contrainte unique : c'est elle qui a limité le coût à des lignes fausses. Ne pas archiver les
4 lignes du 20/09 : elles datent la course.

---

## TRK-090

**Signature** — `sms-daily-proof | CRITICAL | Preuve SMS quotidienne REFUSEE a la soumission vers <NUMÉRO> — la passerelle a rejete
le message ; sans remise prouvee sous 24 h, les coupes automatiques du soir seront refusees.` (contexte `phase: submit`, `error: The
operation was aborted due to timeout`, `provider: vizyo-texto`) **puis, 15 min après**, `sms-daily-proof | CRITICAL | Preuve SMS
quotidienne en ECHEC : <N> message(s) refuse(s) sur <N> — la chaine SMS est cassee (SIM, application ou operateur). Sans remise
prouvee sous 24 h, l interlock refusera les coupes automatiques de ce soir (kill-switch inchange).` (contexte `phase: verify`,
`failed: 1`, **`echo: 0`**). Jumelle de forme : `sms-gateway | ERROR | SMS non remis au relais : le relais SMS (vizyo-texto) n'a pas
répondu dans le délai accordé. Le message vers …1615 n'est pas parti …` ([TRK-066](#trk-066), message ✅ — **et faux sur le fait**).
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **2** · famille **mensonger** · 2 épisodes (4 `CRITICAL`) le 20/09 02:30 et 04:30 · 2026-09-21 · 👉 **T77**

### La preuve SMS quotidienne est déclarée « cassée » alors que le téléphone l'a reçue : un délai client de 10 s est lu comme un refus, et l'écho n'est consulté que pour un sortant « accepté »

**Ce qui a été mesuré (20/09, VM à 10 % de CPU — VPS-045).**

| | Soumission (`sms.send`) | Sortant écrit `failed` | **Le téléphone reçoit** (écho entrant, corps identique) | `verify` à +15 min |
|---|---|---|---|---|
| 02:30 | 02:30:01,012 | 02:30:11 (+10 s : `AbortSignal.timeout(10_000)`, `sms-gateway.service.ts:967`) | **02:30:49**, 02:31:16, 02:31:33 | 02:45 « **en ECHEC** — la chaîne SMS est cassée », `echo: 0` |
| 04:30 | 04:30:00,013 | 04:30:10 | **04:30:46**, 04:30:54 | 04:45 « **en ECHEC** », `echo: 0` |

Le relais a reçu la demande, l'a passée au S21, le S21 a envoyé le SMS vers son propre numéro, et Tracky l'a **reçu en entrant 38 s
après la soumission** (`[Vizyo Tracky] Preuve quotidienne de la chaine SMS 2026-09-20T02:30:01.012Z via vizyo-texto — ne pas repondre.`,
horodatage de la soumission dans le corps). Entre-temps le client HTTP de Tracky avait abandonné à 10 s et écrit le sortant `failed`
(`sendViaVizyoTexto`, chemin `catch`). Quinze minutes plus tard, `verifyHeartbeat` (`sms-heartbeat.service.ts:405-427`) relit les
sortants **et** les échos — dans la même requête — mais **ne rapproche l'écho que d'un sortant `accepted`** :

```ts
if (outcome === 'accepted' && log.body && echoedBodies.has(log.body)) { … outcome = 'delivered'; echo++; }   // :413
…
const verdict = failed > 0 ? 'ECHEC' : delivered > 0 ? 'OK' : 'INDETERMINE';                                  // :427
```

Un sortant `failed` est compté « refusé » sans regarder les 3 échos qui sont dans `echoedBodies`. `failed > 0` prime : **ECHEC**,
`CRITICAL`, e-mail « 3 erreurs critiques — sms-daily-proof » à 03:00, push `preuve-sms` « ECHEC » aux super-admins à 04:45 et 06:45
Paris. Deux fois dans la nuit. À 19:30 la preuve est passée normalement (`delivered` +10 s, « verdict=OK »).

**Et le sortant `failed` n'est pas une remise terminale pour l'interlock.** À 18:00 UTC, `lastTerminalSuccessAt` valait **05:02:57**
— un `engine_control_fallback` `delivered` (FR-428-DQ, [TRK-083](#trk-083)) — un **SMS de secours payant** que rien n'avait
prévu. Sans lui, la dernière remise prouvée aurait été la preuve du 19/09 19:30 : **22 h 30 à 18:00, 24 h 30 à 20:00 — 26 coupes
CDEF31 retenues** par l'interlock, sur une chaîne SMS qui livrait en 38 s.

⚠️ **Question ouverte côté relais, à instruire dans `vizyo-texto`** : **3 échos** pour la preuve de 02:30, **2** pour celle de 04:30
(corps identique au caractère près, horodatage de soumission compris), et **17 « Resume engine Succeed »** entrants entre 03:02:48
et 03:09:34 pour **3** `resume123456` sortants. Tracky n'a soumis qu'une fois (pas de réessai dans `sendViaVizyoTexto`). Soit le
relais ou l'application Android **réémet** quand le client HTTP a coupé, soit les boîtiers répondent à chaque K (TCP + SMS). Si c'est
la première hypothèse, chaque étranglement du VPS coûte des SMS en double — ce n'est pas ce que cette fiche corrige, mais c'est
le prochain fait à mesurer.

**Cause racine, en une phrase.** Un **délai côté client** (10 s) est enregistré comme un **refus côté passerelle** (`failed`, état
terminal), et cet état ferme la porte à la preuve de remise que l'application reçoit elle-même 38 s plus tard — l'inverse exact de
[TRK-018](#trk-018), qui faisait dire « remis » sans preuve ; ici on dit « cassé » avec la preuve du contraire en main.

### Correctif proposé *(sans toucher au délai de 10 s sur une commande moteur, ni à l'interlock)*

1. `sendViaVizyoTexto` : un `AbortError` / délai **n'est pas un `failed`**. Écrire le sortant **`queued`** avec `errorMessage: "délai
   client 10 s — issue inconnue"` et `providerId` NUL, pour que `reconcileOutboundStatus` (T45, statut poussé par le relais) **ou
   l'écho** puissent le requalifier. Un refus HTTP explicite du relais (4xx / 5xx) reste `failed`.
2. `verifyHeartbeat` : rapprocher l'écho **quel que soit le statut du sortant** (`failed` compris) — si le corps est revenu en
   entrant, la remise est **prouvée par réception** : sortant → `received`, `delivered++`, verdict OK, **et archivage (`resolvedAt`)
   de la ligne « REFUSEE a la soumission » de la même preuve**.
3. Le message « REFUSEE … la passerelle a rejeté » ne doit s'écrire **que** sur un refus explicite ; sur un délai : « la passerelle
   n'a pas répondu en 10 s — issue inconnue, vérification à +15 min » (`ERROR`, pas `CRITICAL`).
4. Vérifier que l'interlock lit un sortant requalifié `received` comme remise terminale (c'est déjà le statut que `verify` pose sur
   un écho, :415).

**Vérification (double condition)** : au prochain délai client sur une preuve, **0 `CRITICAL`** si l'écho revient dans les 15 min,
sortant `received`, `lastTerminalSuccessAt` avancé ; **et** une preuve jamais revenue produit toujours `INDETERMINEE` (+15 min) puis
`ECHEC` à la preuve suivante. **Ne pas** allonger le délai de 10 s : sur une RESTORE c'est le dernier recours (TRK-066).

**À ne pas faire.** Ne pas archiver les 4 lignes du 20/09 à la main : elles datent les deux faux verdicts. Ne pas « corriger » en
supprimant la ligne « REFUSEE » — elle est juste au moment où elle est écrite ; c'est la relecture qui manque (même dessin que
[TRK-089](#trk-089) (b)).
...
**Signature** — (a) `sms-gateway-watchdog | CRITICAL | Passerelle SMS indisponible : téléphone <ÉTAT> : dernier ping il y a <N> s
(seuil <N> s). Les coupes automatiques sont bloquées par sécurité ; les RESTORE restent prioritaires.` — contexte `androidState`
(`STALE` / `OFFLINE`), `androidAgeSeconds`, `androidLastSeenAt`, `relayQueueDepth` ; (b) `sms-daily-proof | ERROR | Preuve SMS
quotidienne INDETERMINEE : <N> message(s) sur <N> n ont jamais quitte leur statut de soumission apres 15 min. […] Sans remise
prouvee sous 24 h, l interlock refusera les coupes automatiques de ce soir.` — contexte `phase: verify`, `indeterminate`, `oldestAgeMin`.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **3** · famille **à lire, pas à notifier** *(et (b) : mensonger par omission)* ·
9 + 2 lignes le 19/09 02:29 → 04:45 · 2026-09-20

### La sentinelle du téléphone crie toutes les 16 min, et la preuve remise en retard ne referme jamais son verdict

**Ce qui a été mesuré (nuit du 18 au 19/09).** Le S21 a cessé de pinger à **02:23:55 UTC** (`lastSeen` figé) et est revenu entre
04:36 et **04:46** — 2 h 22, cause côté téléphone (T55). Pendant l'épisode : `sms-gateway-watchdog` a écrit **9 `CRITICAL`** —
02:29 `STALE` (305 s > 240), puis `OFFLINE` à 02:45, 03:00, 03:16, 03:32, 03:48, 04:04, 04:20, 04:36 (1 265 → 7 925 s), une par
balayage de 16 min — et **3 e-mails** « N erreurs critiques — sms-gateway-watchdog » (02:30, 03:40, 04:40). Les preuves quotidiennes
de 02:30 et 04:30 UTC sont restées **en file au relais** ; `verify` à +15 min (02:45, 04:45) a écrit deux `ERROR` « INDETERMINEE …
l'interlock refusera les coupes de ce soir ». À **04:46:41 et 04:46:53** le téléphone est revenu, les deux SMS sont partis, remis
(`statusUpdatedAt` poussé par le relais — T45), **échos entrants reçus** ; l'interlock a lu `lastTerminalSuccessAt = 04:46` et **les
30 coupes de 18:00 et 20:00 sont parties** (sans ces remises, la preuve précédente — 18/09 19:30 — aurait eu 24 h 30 à 20:00 : 26
coupes retenues). **Rien ne l'a écrit** : aucune ligne « téléphone revenu », aucune ligne « preuve finalement remise » ; les 9
`CRITICAL` et les 2 `ERROR` sont toujours actives, et à 07:00 Paris l'écran annonçait encore une soirée menacée.

Les pushs T69 ont fait leur travail : `passerelle-sms` 2 `SENT` à 02:29, 03:32, 04:36 (refroidissement 1 h), `preuve-sms` 2 `SENT`
à 02:45 et 04:45 — c'est le **récit au centre d'alerte** qui manque, pas l'alerte.

**Trois défauts, une cause.** (1) Le watchdog réécrit à chaque balayage — le motif de [TRK-081](#trk-081) (T68) sur une seconde
source, hors de portée de l'anti-flood de `ErrorLogger` (60 s ≪ 16 min). (2) Aucune ligne de sortie : la dernière parole du sujet
est « 7 925 s hors ligne ». (3) Le verdict de la preuve est **définitif à +15 min** : `verify` tourne une fois et personne ne relit
quand le relais pousse `delivered` deux heures plus tard — la ligne est juste quand elle est écrite et fausse dès 04:47, et elle
envoie préparer une preuve manuelle pour un soir qui n'en a plus besoin.

**Cause racine, en une phrase.** Deux témoins écrits pour *l'instant* (un balayage, une vérification unique) sur un état qui
...
donnée qu'ils jugent change.

**Correctif proposé** *(sans toucher au watchdog lui-même ni à l'interlock — ils ont tenu)* :

1. `sms-gateway-watchdog.service` : **une** `CRITICAL` à l'entrée en `STALE` / `OFFLINE` (avec `lastSeen`), rappels `DEGRADATION`
   **horaires** tant que ça dure, et **une ligne de sortie** « téléphone revenu après H h MM (hors ligne de HH:MM à HH:MM) » qui
   pose `resolvedAt` sur les lignes de l'épisode — le dessin de T68 et de T74.
2. `sms-daily-proof` : quand le relais pousse un statut terminal sur un `gateway_daily_proof` **après** la phase `verify`, écrire
   **une** ligne « preuve de 04:30 finalement remise à 04:46 (+2 h 16) — interlock vert » et archiver la ligne `INDETERMINEE`
   correspondante ; à défaut, relire le verdict à +60 et +120 min.
3. Ne pas toucher aux notifications T69 (3) et (4) : une par heure, une par preuve, c'est juste.
...
prochaine preuve remise en retard, **une** ligne qui le dit et la ligne `INDETERMINEE` archivée — **et** une preuve jamais remise
produit toujours son `INDETERMINEE` puis son `ECHEC`.

**À ne pas faire.** Ne pas archiver les 11 lignes du 19/09 à la main : elles sont la mesure de l'épisode. Ne pas allonger le
délai de `verify` (15 min) : à 21:45 Paris il conditionne la coupe de 22:00.

### 📏 2026-09-21 — 2ᵉ épisode, et ce n'est pas le téléphone

Le 20/09 de **01:53 à 11:46 UTC**, **8 `CRITICAL`** `Passerelle SMS indisponible : The operation was aborted due to timeout`
(01:53, 02:25, 03:04, 03:21, 03:36, 04:13, 05:10, 11:46), contexte `reachable: false`, `androidState: null` : le S21 pinguait
(60 s toute la nuit, vérifié à 01:21 / 01:22 le 21/09) — **c'est l'appel de santé du relais** (`sms.healthCheck()`, 5 s) **qui expirait**
sur une VM à 10 % de CPU (VPS-045, levée à 13:36). Le watchdog ouvre après 2 ticks en défaut, **referme après 3 ticks sains**
(`onGoodTick`, un simple `logger.log`), puis **rouvre** à l'expiration suivante : chaque réouverture = une `CRITICAL` et un push
(`ouverture` court-circuite l'espacement d'une heure) — **7 pushs `passerelle-sms`** (13 `SENT`), 3 e-mails, et la sentinelle du
lendemain : « admin@ a reçu 15 notifications dont 6 passerelle-sms » ([TRK-072](#trk-072)). **0 ligne de sortie**, 18 `CRITICAL` actives.

**(d) Le motif est brut.** `reason = health.error` recopié tel quel (`sms-gateway-watchdog.service.ts:60-64`) : *The operation was
aborted due to timeout* ne dit ni « relais », ni « 5 s », ni ce qui reste possible. Même famille que [TRK-066](#trk-066) — et le
même correctif : « relais SMS sans réponse en 5 s (téléphone : dernier ping il y a N s) ». Le dessin de T76 vaut pour les deux causes :
une `CRITICAL` à l'ouverture, rappels `DEGRADATION`, **une sortie qui archive**, et une hystérésis qui ne rouvre pas un incident
refermé depuis moins d'une heure.

---

## TRK-084

**Signature** — *angle mort — aucune ligne.* Une indisponibilité de l'API pendant une transition de planning (ouverture de
plage) retarde les `RESTORE` **sans qu'aucune ligne ne le dise** : les commandes naissent à la reprise de l'API avec
`createdAt` = heure de reprise et **`scheduledAt` = NULL**, le passage d'automatisation sauté n'existe pas, et le témoin
`scheduled-task-heartbeat` — qui tourne dans l'API — n'a rien vu.
**Statut : 🔴 NON CORRIGÉ** · gravité **1** · famille **angle mort** · 1 occurrence (l'incident du 17/09) · 2026-09-18 · 👉 **T72**

### Une API à terre n'écrit pas qu'elle est à terre — et le retard d'une reprise n'existe nulle part

### Ce qui a été observé

Le 17/09, `deploy.sh --attendre` (lot A, `5e9d613e`) a recréé `tracky-api` à **04:56:31** ; la migration
`20260917090000_rdv_lot_a_…` a échoué (contrainte créée deux fois) et **l'API a redémarré en boucle jusqu'à 05:52:37**
(`--repli avant-20260917-0447-87ae29c9`). Récit complet, cause et correctifs du script :
`docs/fiabilite-coupe-circuit-2026-09/31-INCIDENT-DEPLOIEMENT-2026-09-17-API-A-TERRE-56-MIN.md`. **Cette fiche instruit ce que le
centre d'alerte en a montré : presque rien.**

| Fait | Où ça se lit | Où ça ne se lit PAS |
|---|---|---|
| L'API n'a pas tourné 56 min | `docker logs` (`P3009`), `journal.jsonl` (04:56 puis 05:52 repli), `docker inspect` | `error_logs` : **0 ligne** ; `system_metrics` ; `scheduled-task-heartbeat` (il juge un silence depuis `lastRunAt`, mais il vit **dans** l'API) |
| Le passage d'automatisation de 05:45 n'a pas eu lieu | `trip_automation_runs` : 04:45 puis 06:45 — **23 / 24** le 17/09 | aucune ligne : TRK-073 marque `interrupted` un passage **commencé** ; un passage jamais démarré est indiscernable d'un passage absent |
| 24 `RESTORE` CDEF31 dues à 05:00 UTC sont nées à **05:53:00–05:53:02** | `engine_control_commands.createdAt` ; `schedule_history` 05:53 ; le journal du conteneur (« Schedule transition → RESTORE » ×24) | `scheduledAt` **NULL sur les 24** ; T51 (« RESTORE non confirmé depuis plus de 60 s ») compte depuis **`createdAt`** : une reprise émise **53 min en retard puis acquittée en 38 s** est, pour le centre d'alerte, une reprise parfaite |
| 24 × « Socket TCP absente au premier dispatch » (conteneur neuf, aucune session) → **20 par SMS** (`resume123456`, une toutes les 15 s, `delivered` +5 à +8 s, écho « Resume engine Succeed » +7 s), 4 par TCP à la reconnexion | `engine_delivery_attempts`, `sms_logs` (30 sortants dont 6 `failed` vers les 2 SIM de T61) | — |
| Acquittées en **38 s à 14 min** ; **29 / 29 à 06:08, 0 véhicule resté coupé** | `ackedAt` | — |
| **24 véhicules immobilisés 53 à 67 min au-delà de 07:00 Paris**, à l'heure où les conducteurs les prennent | reconstitution (fenêtre × `ackedAt`) ; le client (« URGENT LES VOITURES NE DÉMARRENT PAS », 05:51) | nulle part |

Le centre d'alerte porte, pour toute la matinée, **6 lignes** — toutes sur les deux SIM injoignables (4 `sms-gateway-status`,
2 `engine-control-restore` BP-434-RD, cf. [TRK-085](#trk-085) et [TRK-088](#trk-088)).

### Cause racine

Le planificateur ne connaît pas d'**heure due** : il émet une `RESTORE` quand il *constate* `IN_WINDOW ≠ lastEvaluatedState`
(`schedule-cron.service.ts:291-363`), et la commande naît **à l'heure du constat**. Après une panne, le retard est donc
**effacé par construction** ; et tous les témoins susceptibles de dire « l'API est à terre » ou « une reprise est en retard »
vivent dans l'API. 🔑 *Un instrument ne peut pas mesurer sa propre absence — il faut un témoin qui survive à la panne, ou une
trace écrite à la reprise depuis ce que la panne a laissé (l'heure due, le tick sauté).*

### Ce qu'il faut aussi instruire — 6 `RESTORE` en double

`schedule_history` porte **deux** transitions `IN_WINDOW` le 17/09 pour six véhicules, et `engine_control_commands` six
`RESTORE` `SCHEDULER` « entrée dans la plage autorisée » de plus, créées **après** l'acquittement de la première :
HD-998-XY 06:02:00 (acquittée 06:01:37 — **un SMS payant de plus**, `delivered`, écho), HD-584-BF / HD-595-XY / HD-686-QX
06:12:00 (acquittées 06:04–06:07, TCP), **BP-434-RD / HD-603-XY 15:57:00** (acquittées 06:07 / 06:04 — 9 h 50 plus tôt, 20 min
après le redémarrage de 15:37). Le doc 31 cite une **relance manuelle à 06:03** (« réarmement des intentions parquées »,
`relancer-restore.js`). Le cron ne ré-émet que si `lastEvaluatedState ≠ IN_WINDOW` : quelque chose l'a remis en arrière. **Lire
ce script** ; si ce n'est pas lui, la paire de 15:57 désigne le cron après redémarrage. Test daté : au prochain redémarrage de
l'API en pleine plage, aucune `RESTORE` « entrée dans la plage » pour un véhicule déjà en route.

### Correctif proposé *(sans toucher à la garde ni à l'interlock)*

1. **Une heure due sur la reprise** : `evaluateSchedule()` connaît l'ouverture de la plage → la porter dans
   `engine_control_commands.scheduledAt` (colonne existante) ; T51 et la ligne de clôture mesurent depuis
   `coalesce(scheduledAt, createdAt)` ; **au démarrage**, le premier tick du cron écrit **une** ligne `CRITICAL` `schedule-cron`
   quand des transitions sont dues depuis > 5 min : « 24 reprises émises avec 53 min de retard sur l'ouverture de la plage (API
   indisponible de HH:MM à HH:MM) — véhicules : … ».
2. **Un témoin de l'API hors de l'API** : le relais `texto-relay` (autre conteneur, vivant pendant l'incident) ou le healthcheck
   Docker sait que l'API est `unhealthy` ; l'un des deux **pousse** (SMS au propriétaire par le relais, qui sait déjà envoyer)
   après N minutes d'API à terre entre 05:00 et 09:00 Paris. À défaut, la sentinelle de déploiement (T66) écrit au démarrage
   « API indisponible de HH:MM à HH:MM » (dernier heartbeat → `StartedAt`).
3. **Le passage absent doit se voir** : au démarrage, `scheduled-task-heartbeat` écrit une ligne par tâche horaire dont un tick a
   été **sauté** pendant l'arrêt (« passage de 05:45 non démarré : API indisponible »).
4. Instruire les 6 doublons (ci-dessus).

### 🗓️ Vérification (double condition)

À la prochaine indisponibilité > 5 min pendant une transition : **une** ligne `CRITICAL` qui nomme le retard et les véhicules,
**et** les reprises toujours émises **au premier tick** — rien ne doit retarder une `RESTORE` pour l'écrire.

---

## TRK-085

**Signature** — *outillage / centre d'alerte* — `engine-control-restore | CRITICAL | RESTORE non confirmé depuis plus de 60 s` et
`sms-gateway-status | CRITICAL | SMS en échec terminal (failed)` : **la plaque et l'IMEI sont dans le contexte, pas dans le message**.
Plusieurs véhicules dans la même minute → **une** ligne, et les autres **perdues sans compteur**.
**Statut : 🔴 NON CORRIGÉ** · gravité **2** · famille **angle mort** · mesuré le 17/09 (7 → 1 ; 6 → 4) · 2026-09-18 · 👉 **T73**

### L'anti-flood du centre d'alerte fond des véhicules distincts en une ligne — et perd les autres

### Ce qui a été observé

17/09 à 05:58, cinq minutes après les 24 `RESTORE` de l'incident ([TRK-084](#trk-084)) : `alertOverdueRestores()`
(`engine-control.service.ts:2541-2629`) trouve **7 commandes** non prouvées > 60 s, pose `alertedAt` sur les 7, appelle
`errorLogger.record()` **7 fois** et pousse **7 notifications** `restore-non-prouvee` (14 `SENT` vers les deux super-admins,
`notification_deliveries`). `error_logs` : **1 ligne** (BP-434-RD, 05:58:32). Même matin, **6 SMS refusés** au départ vers les
deux SIM de T61 (05:53:45 → 06:01:45) → **4 lignes** `sms-gateway-status`, dont une seule porte `repeatedSuppressed: 1`.
**Le téléphone du propriétaire en savait plus que l'écran.**

### Cause racine

`ErrorLogger.record()` (`observability/error-logger.service.ts:122-133`) déduplique sur l'empreinte
`source | level | message[0:140]` pendant **60 s** : deux véhicules dont la ligne dit la même phrase ne font qu'une ligne. Le
compteur des occurrences supprimées n'est reporté **qu'à la prochaine écriture de la même empreinte** — si elle ne vient pas
(les six RESTORE ont été acquittées), **il est perdu**. L'anti-flood est juste pour un cron qui échoue toutes les 30 s ; il est
faux pour des témoins **par véhicule** dont le message ne porte pas le véhicule. 🔑 *Même motif que T58 (clé de refroidissement
sans la cause) et que T49 (une ligne par cause), pris à l'envers : ici on voulait une ligne par véhicule, on en a eu une par
phrase.*

### Correctif proposé

1. **L'identité dans le message** des témoins par véhicule : « RESTORE non confirmée depuis 5 min — **BP-434-RD** (canal SMS,
   2 tentatives) », « SMS refusé au départ vers la SIM de **HD-584-BF** (RESULT_ERROR_GENERIC_FAILURE) ». Inventaire :
   `engine-control-tcp-only` ✅, `gps-integrity` ✅, `schedule-cron` ✅, `engine-control-interlock` ✅ (liste des plaques),
   **`engine-control-restore` ❌, `sms-gateway-status` ❌**.
2. **Ne jamais perdre le compteur** : à la première suppression d'une empreinte, mettre à jour `context.repeatedSuppressed` de la
   ligne **déjà écrite** (un `UPDATE` par empreinte et par fenêtre), ou vider `recent` en écrivant le compte sur la dernière ligne.
3. Ne pas toucher à la fenêtre de 60 s : c'est **le message** qui doit distinguer, pas l'anti-flood.

### 🗓️ Vérification (double condition)

Au prochain lot de RESTORE non prouvées : **autant de lignes que de véhicules** (ou une ligne qui les nomme tous) **et** un cron
qui échoue toutes les 30 s produit toujours **une** ligne par minute.
...
trajets bruts y subsistent. Rien n'a été supprimé.` — la phrase de [TRK-047](#trk-047), mais **une par passage horaire**, la
tranche = la fenêtre entière (J − 26 h → J − 10 min), sur un boîtier **vivant sans fix depuis plus de 26 h**.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **3** · famille **à lire, pas à notifier** · 8 occurrences (17/09 18:29 → 18/09 00:45, HM-769-GA) · 2026-09-18 · 👉 **T74**

### Le recalcul horaire crie chaque heure sur un véhicule sans fix depuis plus de 26 h — et son gel ne peut pas l'atteindre

### Ce qui a été observé

HM-769-GA est `ONLINE` (878 trames `no_fix` + 437 `heartbeat` en 24 h), **sans position depuis le 16/09 15:28:34** (33,7 h à la
collecte ; `gps_sans_fix`, `GPS_LOST` alerté le 16/09 08:35). Il porte **35 trajets bruts** (`segmentationSource` `ignition` /
`timeout`, des 31/08 et 11/09) que le recalcul horaire n'a jamais touchés. La première ligne tombe au passage de **17:45** —
exactement quand la fenêtre de 26 h cesse de contenir la moindre position — puis **une par passage**.

### Cause racine

`trip-automation.service.ts:861-988` : `dirty` est cherché depuis **`plancherRattrapage`** (60 j, ligne 873) ; la tranche est
bornée par `Math.max(windowFrom, dirty.startedAt − 30 min)` (ligne 883) → **`fromMs = windowFrom`** quand le trajet brut est
plus vieux que la fenêtre. Tant que la fenêtre contenait des positions, `recompute()` tournait sur la fenêtre (le travail horaire
ordinaire) et le trajet du 31/08 restait brut **en silence** (c'est le reste du rattrapage T13). Fenêtre vide : `positions === 0`,
au-dessus de l'horizon, tranche > 60 s, `trouNormalAuRegimeDeStockage` sans voisin (fail-open) → **alerte** ; puis le gel
`fige-sans-positions` (lignes 980-988) cible `startedAt ∈ [fromMs, toMs]` — **le trajet du 31/08 n'y est pas, rien n'est figé,
et `dirty` le retrouve au passage suivant**. Le commentaire promet « l'alerte ne se répétera pas puisque la tranche sort du
périmètre » : vrai quand le trajet brut est *dans* la tranche, faux quand il est *avant*. 🔑 *Le chemin horaire choisit son
trajet avec la borne du rattrapage et fige avec la borne du courant ; entre les deux, un trajet n'est ni recalculé ni figé.*

**Candidats à la même boucle** : HM-733-GA (**65** trajets bruts) et HM-779-GA (**39**), le jour où l'un d'eux passe 26 h sans
fix. Les boîtiers muets (KSR•370 177, FS-… 4 à 7) n'y tombent pas : sans trame, ils sortent de l'évaluation.

### Correctif proposé *(chemin horaire seul)*

1. Sélectionner `dirty` avec **`startedAt ≥ windowFrom − RECOMPUTE_BACKOFF_MS`** sur le chemin horaire — les plus anciens
   appartiennent au rattrapage (ligne 1072), qui a son propre front ; **ou** 2. si `dirty.startedAt < fromMs`, ne pas alerter et
   laisser le rattrapage ; **et** 3. quand `lastPositionAt` du boîtier est antérieur à `windowFrom`, la tranche vide n'est pas une
   anomalie de recalcul mais l'état déjà dit par `gps-integrity` : se taire.

### 🗓️ Vérification (double condition)

0 ligne sur HM-769-GA au passage suivant le correctif tant qu'il est sans fix, **et** la ligne part toujours pour un vrai trou
(positions avant **et** après la tranche) — le test de TRK-047 est à conserver.

---

## TRK-087

**Signature** — `http | ERROR | La création directe dans Vizyo Manager n'est pas configurée sur ce serveur (MANAGER_INTERNAL_URL).
Créez le client dans Manager, puis rattachez la flotte.` — `statusCode: 503`, `POST /api/installation-bookings/<ID>/confirm`,
`userAgent: node`, `::ffff:127.0.0.1`.
**Statut : ⚪ BRUIT — configuration manquante à la première recette, close le jour même** · gravité **4** · 1 occurrence (17/09 07:11:41) · 2026-09-18

### Une variable absente du conteneur neuf, dite par un message qui nomme la variable et le geste

La recette du lot A (`recette-prod-lot-a.js`, `admin@vizyoagency.com`, depuis le VPS) a confirmé un créneau **51 s après** le
déploiement de `092a740d` (07:10:50) : le conteneur n'avait pas `MANAGER_INTERNAL_URL`, le contrôleur l'a dit **en 503, en
français, en nommant la variable et l'alternative** — le contraire exact de [TRK-060](#trk-060) / [TRK-066](#trk-066) /
[TRK-068](#trk-068). La variable est **présente** sur le conteneur de 15:37 (`docker inspect`, nom seul lu) et la recette de 13:43
(« TEST lot D ») a produit ses deux e-mails. Rien à corriger ; la ligne reste la trace d'une recette faite dans le bon ordre.
Le lot D est documenté dans `docs/rdv-installation-v2/`.

---

## TRK-088

**Signature** — `sms-gateway-status | CRITICAL | SMS en échec terminal (failed)` — contexte `errorMessage: Send result:
RESULT_ERROR_GENERIC_FAILURE (Generic failure cause)`, `imei`, `smsLogId`, `providerId`.
**Statut : 🔵 TERRAIN** *(le fait est T61 ; la forme est [TRK-085](#trk-085))* · gravité **3** · 4 lignes pour 6 échecs (17/09 05:53 → 06:01) · 2026-09-18

### La source `sms-gateway-status` parle pour la première fois : le relais pousse un `failed`, Tracky l'écrit

C'est **la voix de T45** (statuts poussés par le relais, en ligne depuis le 15/09) : chaque SMS dont le S21 rapporte un échec
terminal produit une `CRITICAL`. Le 17/09, les 6 échecs sont les 3 tentatives de `resume123456` vers **BP-434-RD** et les 3 vers
**HD-584-BF** — les deux SIM que le S21 ne peut pas joindre (T61, test du 14/09 : refus au départ, `RESULT_ERROR_GENERIC_FAILURE`,
sans différence côté fournisseur). Trois échecs → verdict « injoignable » → **T62 s'est exercé** (2 lignes
`engine-control-tcp-only` à 20:00, coupes TCP seulement, RESTORE à la reconnexion) : la ligne fait son travail. Ce qui ne va pas
est la forme : le message ne nomme ni le véhicule ni la conséquence (« le secours SMS n'existe pas pour ce véhicule »), et
l'anti-flood fond les IMEI ([TRK-085](#trk-085)). Ne pas archiver : ces lignes sont la mesure de T61.

---

## TRK-083

**Signature** — *commandes* / `engine-control` — `engine_control_commands` : `CUT` ou `RESTORE` en `SENT_UNCONFIRMED`,
`channel = TCP`, `smsAttemptCount = 0` ; `engine_delivery_attempts` : `TCP` `TIMED_OUT` « ACK timeout after 15000ms » ;
**et `wire_logs` porte la trame `jt` (CUT) / `kt` (RESTORE) du boîtier dans les secondes qui suivent la trame `OUT`**.
Aucune ligne au centre d'alerte.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **2** · famille **course** · 1 occurrence mesurée · 2026-09-17 · 👉 **T71**

### Le guetteur d'ACK TCP est armé APRÈS deux écritures en base — un boîtier qui répond plus vite que la base est déclaré « non confirmé »

### Ce qui a été observé

Nuit du 16 au 17/09, coupes CDEF31 de 22:00 Paris : **28 `CUT` `SCHEDULER`**, 27 `ACKNOWLEDGED` (26 par TCP en 0,4 – 5,4 s,
1 par SMS en 83 s) — et **GR-898-HY en `SENT_UNCONFIRMED`**, seule commande de la nuit sans preuve. Chronologie à la
milliseconde (`engine_control_commands`, `engine_delivery_attempts`, `wire_logs`), comparée aux 27 autres :
...
| **réponse `jt` du boîtier** (`wire_logs` IN, `imei:864035054756326,jt,260916200137,…`) | **20:01:38,339** | 0,7 à 5,3 s après l'OUT |
...
| issue | `TIMED_OUT` 20:01:54,410 → `SENT_UNCONFIRMED` 20:40:00 (échéance T5) | `ACKNOWLEDGED` |

Le véhicule **est coupé** : 69 positions de 20:00:22 à 03:23:11, vitesse 0, contact coupé, boîtier `ONLINE`. La plateforme,
elle, dit « nul ne sait » — et **n'écrit rien nulle part**.

### Cause racine

La trame part sur la socket **en premier** (`sessionRegistry.send`, ligne 1808), puis deux écritures en base
(`beginAttempt`, `writeSent`), et **seulement ensuite** le guetteur d'ACK est inscrit (`ackWaiter.waitForAck`, ligne 1985).
Or `AckWaiterService` (`tracker-commands/ack-waiter.service.ts`) n'a **aucune mémoire** : `tryMatch()` ne regarde que les
`waiters` inscrits au moment où la trame arrive. **Entre l'écriture socket et l'inscription, tout ce que le boîtier répond
est perdu.** À 20:01 la base a mis **8,5 s** sur ces deux écritures (2,4 + 6,1 s, contre 5 à 90 ms pour les 27 autres —
`dockerd` était à 92 % d'un cœur derrière un client `docker logs` bloqué depuis 12:41, VPS-016 nº 6) et le boîtier a
répondu en ≈ 6 s : **la réponse est arrivée 0,9 s avant le guetteur.**

🔑 *C'est le motif de T48 (« course ACK/SMS : ne jamais rétrograder `ACKNOWLEDGED` en `SENT` ») pris par l'autre bord :
T48 a réglé la course entre deux écrivains, pas la course entre le boîtier et l'inscription du lecteur.*

### Pourquoi ce n'est pas cosmétique

- Sur une **`CUT`** : un statut faux (« nul ne sait ») pour un véhicule bien coupé, et **le seul défaut de la nuit sans
  aucune ligne** — l'exploitant qui lit l'écran des commandes voit une coupe « non confirmée » et peut aller vérifier
  un véhicule qui n'a rien.
- Sur une **`RESTORE`** : le même `catch` (lignes 2038-2050) **planifie le secours SMS** (`nextAttemptAt = now`,
  « RESTORE sans ACK TCP — fallback SMS durable planifié ») → **un SMS payant** vers le boîtier, une seconde commande `K`
  qu'il exécutera une seconde fois, **une `CRITICAL` `engine-control-restore` à +15 min** (T51) et **une notification
  push au propriétaire** (T69) — *pour une remise en route qui a réussi*. Sur les 22 RESTORE CDEF31 de 05:00 UTC, une
  seconde de latence base suffit, et le matin est l'heure des sauvegardes.

### Jumeaux

- `tracker-commands/tracker-commands.service.ts:328-360` — `update({ status: SENT, sentAt })` **puis** `waitForAck` ;
- `tracker-fix-mode/tracker-fix-mode.service.ts:287` — `armAckListener()` appelé après l'update `SENT`.

Même ordre, même trou. C'est une **cause plausible d'une part du « 0 `ackedAt` sur 4 823 »** de [TRK-014](#trk-014) :
un boîtier qui répond `fix ok` avant l'inscription est un boîtier « qui ne répond jamais ».

### Correctif proposé *(sans toucher à la garde ni au repli)*

1. **Inscrire le guetteur AVANT l'écriture socket** : `waitForAck()` rend une promesse ; l'armer avant
   `sessionRegistry.send()`, et l'annuler (`removeWaiter`) si `send()` rend `false`. Les deux écritures en base restent
   où elles sont — la latence base ne peut plus faire rater un ACK.
2. **Ou** donner à `AckWaiterService` une **mémoire courte par IMEI** (les trames des 30 dernières secondes), relue à
   l'inscription avant d'attendre — plus robuste, et couvre les trois services d'un coup.
3. Dans les deux cas, **journaliser** la latence `beginAttempt → writeSent` quand elle dépasse 1 s : c'est le témoin
   d'une base qui rame pendant une fenêtre de commande, et il n'existe pas.

### Vérification

Plus aucune commande `SENT_UNCONFIRMED`/TCP dont `wire_logs` porte un `jt`/`kt` dans les 20 s de l'`OUT` — requête à
ajouter à `collecte.sql` si la fiche reste ouverte plus d'une semaine. **Double condition** : un boîtier qui ne répond
vraiment pas doit **toujours** tomber en `TIMED_OUT` à 15 s — *si `SENT_UNCONFIRMED` disparaît entièrement, on a désarmé
le témoin, pas réglé la course.*

### 📏 2026-09-21 — exercé trois fois en 24 h, dont une fois sans charge

| Commande | Trame OUT | Réponse du boîtier | Guetteur armé (`sentAt`) | Issue |
|---|---|---|---|---|
| EP-047-TY RESTORE 20/09 03:03:39 | ≤ 03:03:43,4 | `kt` **03:03:44,9** | 03:03:47,3 (+3,9 s de base, steal 89 %) | TIMED_OUT → **SMS payé** 03:05:39 (`delivered` 03:06:04) → `CRITICAL` « RESTORE non confirmé » 03:04:52 + push → ACK 158 s |
| AL-927-QM RESTORE 05:00:48 | ≤ 05:00:54,9 | `kt` **05:00:54,907** (5 ms avant le journal OUT) | ~05:00:55 | TIMED_OUT → ACK tardif 05:01:24 (le rapprochement lui-même a pris 30 s) → **SMS payé quand même 05:01:31, 7 s APRÈS l'ACK** |
| **EP-047-TY CUT 18:00:02** *(steal 1 %)* | 18:00:02,320 | `jt` **18:00:02,277** | 18:00:02,317 (+300 ms) | TIMED_OUT → **`SENT_UNCONFIRMED`** à 18:40 — coupe exécutée (71 positions à 0 km/h, contact coupé) |

FR-428-DQ (05:01:50) : SMS créé 05:02:29,011, ACK 05:02:29,906 — la même course à 0,9 s dans l'autre sens. **Le cas de 18:00 tranche
ce que le 17/09 laissait ouvert : 300 ms de latence base suffisent, la charge n'est pas la condition** — un boîtier qui répond en
250 ms bat toujours `beginAttempt` + `writeSent`. Et le secours SMS (`dispatchSmsAttempt`, :2091) **ne relit pas `ackedAt`** juste
avant `trySmsFallback` : AL-927-QM a payé un SMS 7 s après son accusé. **Complément à T71** : (a) relecture `ackedAt` immédiatement
avant la soumission SMS, (b) annulation au relais (T41) si l'ACK arrive pendant la soumission, (c) sous charge, l'ACK peut arriver
après les 15 s — c'est alors le rapprochement tardif qui doit **annuler le SMS en file**, pas l'inverse. Coût de la journée : **2 SMS
payés pour rien, 1 CUT « non confirmée » exécutée, 3 `CRITICAL` + 3 pushs « non prouvée » pour des reprises réussies.** Voir aussi
[TRK-091](#trk-091), même chantier (la ligne d'attempt, puis le guetteur, puis la trame).

---

## TRK-082

**Signature** — `sentinelles | ERROR | <N> trajet(s) de « <SOCIÉTÉ> » ont un excès qui aurait dû produire une alerte, et
n'en a pas. Les alertes de vitesse sont pourtant actives pour cette société. Premier trajet concerné : <ID>.`
Contexte : `fleetId`, `tripId`, `trajets[]`, `total`, `depuis`. Clé de refroidissement
`SENTINELLE_EXCES_SANS_ALERTE:<fleetId>`, 20 h.
**Statut : ⚪ BRUIT — faux positif · CORRECTIF PROPOSÉ** · gravité **3** · famille **mensonger** · 1 occurrence · 2026-09-16 · 👉 **T70**

### La sentinelle « excès sans alerte » ignore la déduplication par excès (T30) et accuse la chaîne pour 3 trajets qui ont alerté

### Ce qui a été observé

16/09 06:30:01, mh cars, 3 trajets — **la première fois que cette sentinelle parle pour une société dont les alertes sont
armées** ([TRK-064](#trk-064) avait instruit son silence du 04/09). Les trois trajets sont de **FV-941-LZ**, le 15/09,
et **tous trois ont été recréés par le recalcul horaire** (`createdAt` à :45:00) **après** que l'excès a produit son
alerte sur le trajet jumeau :

| Trajet accusé | Fenêtre | Créé | `maxSpeedKmh` | Alerte `OVERSPEED` du véhicule à cet instant |
|---|---|---|---|---|
| `f5fcd5f8` | 05:10:48 → 05:52:17 | **06:45:00** | 131,1 | **05:49**, `startAt` 05:22:37, 131 km/h |
| `efa359bc` | 06:19:37 → 06:59:42 | **07:45:00** | 131,0 | **06:47**, `startAt` 06:32:37, 131 km/h |
| `d3566589` | 15:21:46 → 16:00:36 | **16:45:00** | 133,4 | **15:51**, `startAt` 15:25:57, 133 km/h |

### Cause racine

Quand le trajet recréé a été analysé, `createSpeedingAlert` (`alerts.service.ts:770`) a retrouvé le doublon par
`memeExcesDejaAlerte` — même véhicule, même instant GPS — et **n'a pas ré-alerté : c'est exactement ce que T30 devait
faire**. Mais la sentinelle (`observability/sentinelles-coherence.service.ts:499-506`) juge « alerté » par
**`alert.tripId = analyse.tripId`** : l'alerte est accrochée au jumeau, le trajet recréé n'en a pas → accusation.

🔑 *T30 a changé la clé d'identité de l'alerte (du trajet à l'excès) ; l'instrument qui contrôle la chaîne lit encore
l'ancienne clé.* Même motif que [TRK-043](#trk-043) et [TRK-073](#trk-073) : l'instrument est juste, sa jauge ne l'est
plus. Et c'est un faux positif **mensonger** — il envoie regarder une chaîne d'alerte qui vient de bien faire, sur une
société qui a précisément servi à prouver que la détection marche.

⚠️ Ce que la fiche ne dit pas : que la sentinelle est inutile. Le cas qu'elle existe pour attraper — un excès qualifié
sans **aucune** alerte — reste possible (TRK-064) ; il faut la garder, et lui donner la bonne clé.

### Correctif proposé *(`sentinelles-coherence.service.ts`, la sentinelle seule)*

Considérer un trajet comme alerté s'il existe une alerte `OVERSPEED` **du même véhicule** dont `payload.startAt`/`endAt`
recouvre l'instant de la décision (`memeExces`, le paquet partagé — la **même fonction** que le producteur, pour que les
deux ne divergent plus), ou à défaut dont la fenêtre `tripStartedAt`/`tripEndedAt` chevauche celle du trajet.

### Vérification — double condition

Silence sur ces trois trajets (et sur tout trajet recréé dont l'excès est déjà alerté) **et** la sentinelle doit encore
parler quand un véhicule a un excès qualifié sans **aucune** alerte à cet instant — *le test existant est à adapter, pas
à retirer.*
...
**Signature** — `engine-control-interlock | CRITICAL | CUT automatique bloquée : capacité de RESTORE non démontrée (<RAISON>) : <N> refus depuis la dernière ligne — véhicules : <PLAQUES>. Prochaine ligne dans 15 min au plus tôt.`
Contexte : `cause: "interlock"`, `reason`, `refusalsSinceLastLine`, `vehicles[]` (≤ 40), `trackerId`, `imei`, `fleetId`, `plate`, `spacingMin: 15`.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **3** · famille **à lire, pas à notifier** · 20 occurrences · 2026-09-16 · 👉 **T68**

### L'interlock refuse toute la nuit — et le dit toutes les 15 minutes en `CRITICAL`, avec un e-mail par heure

### Ce qui a été observé

Première nuit du chantier coupe-circuit en production (`fa9ff1d1` à 17:35, `0c9672c9` à 18:14 UTC le 15/09,
`ENGINE_AUTOMATIC_CUT_ENABLED=true`). À **20:00:00** (22:00 Paris), le planificateur demande la coupe des
25 véhicules CDEF31 armés ; l'interlock (`engine-control.service.ts:1630`, T45 / T49) lit
`lastTerminalSuccessAt` = **14/09 07:00:02** (la preuve hebdomadaire) → **37 h** → `freshProof = false` →
`reason = "dernière preuve de remise SMS trop ancienne (> 24 h)"` → **refus**. Toutes les autres conditions
étaient vraies (la cascade de `reason` les teste avant : `enabled`, `reachable`, `operational`,
`deliveryProofAvailable`). La preuve manuelle que le doc 25 §12 prévoyait pour le soir n'a pas été envoyée ;
la première preuve automatique (T45) tombe à 02:30 UTC.

**Le refus est juste, et c'est le comportement annoncé** — 0 `CUT`, 0 `RESTORE`, 0 SMS depuis le déploiement,
25 véhicules restés mobiles, 30 plannings restés `IN_WINDOW` (T49 n'avance pas l'état), donc aucune RESTORE due
à 05:00. Ce que la fiche instruit, c'est **le bruit** :

| Mesure (15/09 20:00 → 16/09 01:15 UTC) | Valeur |
|---|---|
| Lignes `engine-control-interlock` | **20**, toutes `CRITICAL`, toutes la même `reason` |
| Cadence | **une toutes les 15 min** (20:00:00, 20:15:20, 20:30:30, 20:52:30, 21:07:40, … 01:09:00) |
| Contenu | alternance **« 24 refus »** (le groupe, palier 30 min du cron) / **« 1 refus »** (AL-927-QM, refusé seul au premier tick et décalé de 15 min) ; 59 refus sur la 2ᵉ ligne (paliers 2 et 5 min) |
| Attendu d'ici la fin de la plage (05:00 UTC) | **~36 lignes** pour **une** cause connue depuis 17:35 |
| E-mails du veilleur du taux d'erreurs (`email_logs`, `DELIVERED`) | **5** « 1 → 4 erreurs critiques — engine-control-interlock » à 20:10, 21:20, 22:30, 23:30, 00:30 (+ 2 pour `engine-control-restore`, T67) |
| `CRITICAL` actives au centre d'alerte | **28**, dont **20** de cette source |

### Cause racine

`signalWithheldCut` (`engine-control.service.ts:1691`, T49 — `93dba465`) : la clé d'espacement est
`interlock|<reason>`, l'espacement `ENGINE_INTERLOCK_ALERT_SPACING_MS` = 15 min, et **chaque ligne est écrite en
`CRITICAL`**, la première comme la vingtième. Le cron (`schedule-cron.service.ts:393`) retente chaque véhicule sur
les paliers `CUT_BACKOFF_MS` = 2 / 5 / 15 / 30 min **sans écrire sa propre ligne** — c'est voulu, et c'est bien —
donc après quatre refus les 24 véhicules reviennent ensemble toutes les 30 min, et le moteur écrit à chaque
retour puisque 30 ≥ 15.

**En une phrase :** T49 a réglé un interlock qui *vacille* (« une ligne par cause et par quart d'heure » remplace
« un `CRITICAL` par appel ») ; il n'a pas prévu un interlock **rouge par construction pendant neuf heures**, où le
rappel toutes les 15 min n'apporte aucune information nouvelle mais coûte un `CRITICAL` et déclenche le veilleur
du taux d'erreurs à chaque heure. *Un état qui dure se lit sur une page ; il ne se notifie pas trente-six fois.*

### Ce que ce n'est PAS

- **Pas un défaut de l'interlock** : il a refusé pour la bonne raison, et il aurait laissé passer une preuve
  fraîche. La nuit est « non probante » au sens de T65 parce que la preuve manuelle n'a pas été faite — un fait
  d'exploitation, écrit tel quel dans le rapport du 16/09.
- **Pas la tempête de T67** (RESTORE de l'été relues) : autre source, autre cause, éteinte à 18:14.
- **Pas une dégradation du relais ni du téléphone** : ping du S21 à 60 s exactement pendant toute la nuit.

### Correctif proposé — sur `signalWithheldCut`, et lui seul

1. **La première ligne d'une cause reste `CRITICAL`.** C'est le signal, et il doit continuer à réveiller.
2. **Les rappels de la même `reason` passent en `DEGRADATION`** *(le vocabulaire du centre pour « état voulu /
   qui dure », cf. le kill-switch dans la même fonction)* et s'espacent à **60 min**
   (`ENGINE_INTERLOCK_REMINDER_SPACING_MS`), avec le compte **cumulé** des refus et le nombre de véhicules
   distincts — pas la liste complète à chaque fois (elle est déjà dans la première ligne).
3. **Une ligne de clôture** quand `safe` redevient vrai après au moins une ligne écrite : *« Coupes automatiques à
   nouveau autorisées à HH:MM — N refus retenus pendant H h MM sur M véhicules »*, en `DEGRADATION`. C'est elle
   qui permet de lire la nuit d'un coup d'œil, et de savoir que l'état a cessé.
4. **Un changement de `reason` rouvre en `CRITICAL`** — la clé par raison est conservée : un relais qui tombe à
   03:00 ne doit pas se cacher derrière le rappel horaire de la preuve périmée.

### Vérification

La prochaine nuit où l'interlock refuse : **1 `CRITICAL`** à la première coupe refusée, **au plus 1 `DEGRADATION`
par heure** ensuite, **1 ligne de clôture** quand la preuve revient — et `email_logs` porte **1 e-mail** pour cette
source, pas 5. **Double condition** : la ligne `CRITICAL` d'ouverture doit toujours exister ; *si la source se tait
entièrement, on a désarmé le témoin, pas réglé son rythme.*

### À ne pas faire

- **Ne pas allonger la fenêtre des 24 h** de l'interlock, ni rendre la preuve « disponible » sans remise
  terminale — *corriger un message ≠ affaiblir une garde*. La preuve quotidienne (T45) est la réponse au fond ;
  cette fiche ne traite que la forme.
- **Ne pas couper l'e-mail du veilleur du taux d'erreurs** pour cette source : c'est la forme des lignes qui doit
  changer, pas leur comptage — sinon la prochaine vraie rafale passera sans e-mail.
- **Ne pas archiver les 20 lignes** pour vider l'écran : elles sont la mesure de cette fiche.

---

## TRK-080

**Signature** — `sentinelles | ERROR | <N> compte(s) ont RÉDUIT leurs notifications dans les dernières 24 h : <EMAIL> (TOUT coupé | types : <TYPE> | familles : <TYPE>). C'est le signal qu'on cherche à ne jamais voir : quelqu'un a jugé qu'on le dérangeait…`
Contexte : `comptes[]`, `depuis`. Clé de refroidissement `SENTINELLE_NOTIFICATIONS_COUPEES`, quotidienne.
**Statut : ⚪ BRUIT — faux positif d'intention · CORRECTIF PROPOSÉ** · gravité **4** · famille **faux positif** · 1 occurrence · 2026-09-14

### La sentinelle nº 9 parle pour la première fois — et personne n'a rien coupé depuis l'application

### Ce qui a été observé

Le 14/09 à **06:30:02**, première ligne jamais écrite par `notificationsCoupees()`
(`apps/api/src/observability/sentinelles-coherence.service.ts:942`, sentinelle nº 9 « QUELQU'UN VIENT DE
COUPER ») : *« 1 compte(s) ont RÉDUIT leurs notifications dans les dernières 24 h : tyger.bcn@gmail.com
(TOUT coupé). »*
...
| Mesure | Valeur |
|---|---|
| `notification_preferences` du compte | **une ligne créée le 13/09 à 20:15:02** (`createdAt = updatedAt`), `pushEnabled = false`, `mutedTypes = {POWER_CUT, OVERSPEED}` *(les défauts)*, `minSeverity = WARNING` |
| Le compte | `SUPER_ADMIN`, actif, **sans appareil abonné** — celui des 53 notifications « perdues » de [TRK-065](#trk-065), et celui de la décision **T6** du 13/09 : *« voulu, notifications en phase de test »* |
| `system_activity_logs` entre 20:10 et 20:20 | **aucune mutation HTTP** — seules deux `POST /api/partner/activity` anonymes |
| La seule route qui écrit cette table | `PUT /api/notifications/preferences`, réservée au **titulaire du jeton** (`notification-preferences.service.ts:327`, `upsert`) — **pas appelée** |
| Le rapport de la veille (14/09 01:12) | savait déjà : *« tyger.bcn, dont l'interrupteur maître est désormais « push désactivé » »* |

La ligne est donc née **hors application**, le soir où le propriétaire réglait `PUSH_ROLLOUT` et
tranchait T6. La sentinelle, elle, a lu un `updatedAt` dans sa fenêtre de 24 h et un `pushEnabled = false`,
et a conclu — comme son message le dit — qu'un *client* avait jugé qu'on le dérangeait.

### Cause racine, en une phrase

La sentinelle lit un **réglage** et en déduit une **intention**, alors que la table ne dit **ni qui** a
écrit **ni par où** : un réglage posé par un administrateur pour un compte technique rend exactement la
même ligne qu'un client excédé. *Elle a raison de crier — c'est bien le réglage à surveiller — et tort de
conclure.*

> 🔑 **Un instrument qui surveille un geste doit savoir de qui vient le geste.** Le message parle d'une
> personne (« quelqu'un a jugé »), la donnée ne parle que d'un booléen. Même défaut, en miroir, que
> [TRK-064](#trk-064) : là, la sentinelle se taisait pour la même raison que la chaîne ; ici, elle crie pour
> une raison qu'elle ne peut pas vérifier.

### Correctif proposé

- `notification_preferences` gagne **`updatedById`** *(nul = écrit hors application)*, renseigné par
  `update()` depuis le jeton ;
- la sentinelle distingue **trois phrases** — *« a coupé lui-même »* (le signal, `ERROR`), *« coupé par
  un administrateur »* et *« réglage écrit hors application »* (`DEGRADATION`, qui **nomme** l'auteur
  quand il est connu) ;
- **ne pas** élargir la fenêtre ni retirer le type : le signal reste celui qu'on cherche à ne jamais voir.

### Vérification

La prochaine coupure faite **par un administrateur** depuis un autre compte produit une ligne
`DEGRADATION` qui nomme l'auteur ; une coupure faite **par le titulaire** produit toujours l'`ERROR`
d'aujourd'hui. *Si la source se tait entièrement, on a désarmé la sentinelle, pas le faux positif.*

---

## TRK-079

**Signature** — `frontend-anon | ERROR | [demo-mode:charger] TypeError: Failed to fetch` **et**
`frontend-anon | ERROR | [uncaught] TypeError: Failed to fetch dynamically imported module: <CHUNK>`,
**les deux à quelques millisecondes**, depuis un client sans session (`preAuth: true`).
Contexte : `ip`, `userAgent`, `preAuth`.
**Statut : ⚪ BRUIT ACCEPTÉ** · gravité **4** · famille **brut / faux positif** · 4 occurrences · 2026-09-13

### Deux appels avortés par la fermeture de la page, rapportés comme des pannes de réseau

### Ce qui a été observé

Le 13/09 à **22:50:26** puis **23:14:43**, deux visiteurs anonymes ont produit chacun **deux lignes à 8 ms
d'intervalle** — la première source `frontend-anon` jamais vue dans la table, alors que le canal existe
depuis le 16/07 (`e883c39d`, `apps/api/src/user-activity/public-client-error.controller.ts`) :

| Ligne | Ce qui a échoué |
|---|---|
| `[demo-mode:charger] TypeError: Failed to fetch` | `fetch('/api/health')` dans `DemoModeService.charger()` (`apps/web/src/app/core/services/demo-mode.service.ts:41`) |
| `[uncaught] TypeError: Failed to fetch dynamically imported module: …/chunk-QKHV2N7U.js` | l'import différé d'une route Angular |

Trois faits, mesurés :

1. **Le chunk existe.** `chunk-QKHV2N7U.js` est **PRÉSENT** dans `/usr/share/nginx/html` de `tracky-web`
   (177 chunks), sur l'image de 20:22 servie depuis 20:25 — 2 h 25 avant la première ligne. Ce n'est pas un
   déploiement qui a retiré un fichier sous un client.
2. **Les clients sont des robots.** `54.221.172.222` et `44.210.103.169` sont des plages **Amazon EC2
   (us-east-1)**, et l'agent annonce *« iPhone; CPU iPhone OS 18_7_8 … Version/26.0 Mobile … Safari »* —
   **Safari 26 n'existe pas sur iOS 18** : la chaîne est fabriquée. Aucune session, aucune trace dans
   `api_traffic_logs` (qui ne capture que l'API publique LP/Maestroo).
3. **Le rapport est arrivé, les appels non.** `reportClientError` envoie son `POST /api/public/client-error`
   avec `keepalive: true` — le seul mode de `fetch` qui **survit à la fermeture de la page**. Les deux appels
   « échoués » étaient en vol quand la page a été détruite : le navigateur les annule, et `fetch` comme
   `import()` rejettent alors `TypeError: Failed to fetch` — **le même texte, mot pour mot, qu'une panne de
   réseau ou de serveur.**

### Cause racine, en une phrase

Un robot charge l'application et l'abandonne au bout d'une seconde ; les requêtes annulées par la
navigation portent le message d'une panne de réseau, et le canal anonyme — qui n'a aucun moyen de
distinguer un utilisateur d'un robot — les livre au centre d'alerte comme des défauts. **Ni la plateforme,
ni le réseau, ni le bundle ne sont en cause.**

> 🔑 **Un message d'erreur de transport ne dit pas pourquoi le transport a échoué.** « Failed to fetch »
> couvre le câble débranché, le serveur mort, le CORS refusé — et l'onglet fermé. Sur un canal sans session,
> le dernier cas est le plus fréquent, parce que c'est celui des robots.

### Correctif proposé

Dans `apps/web/src/app/core/error/report-client-error.ts`, avant d'envoyer :

- **ne pas remonter** un `TypeError` de `fetch` / `import()` quand la page est en train de se fermer —
  `document.visibilityState === 'hidden'` ou un `pagehide` reçu (le rapport lui-même est déjà en
  `keepalive`, donc le test est peu coûteux et la fenêtre est exactement celle du défaut) ;
- sur le chemin **anonyme** seulement, ne remonter que les erreurs qui **ne sont pas de transport** : un
  bug JS pré-login (`ReferenceError`, `NG0…`) reste précieux ; un `Failed to fetch` sans session ne sera
  jamais instruit, faute de savoir qui l'a vu.

**Contrepartie à assumer** : une vraie panne de `/api/health` vue par un anonyme ne produira plus de ligne
sur ce canal — c'est le rôle de la sonde active des dépendances, pas de la remontée des bugs JS.

### Vérification

Sur 7 jours, **0 paire** `frontend-anon` à moins de 100 ms d'écart depuis une adresse sans session, **ET** une
erreur JS réelle pré-login (autre qu'un `fetch` avorté) doit toujours remonter. *Si la source
`frontend-anon` se tait entièrement, on a fermé le canal, pas le bruit.*

---

## TRK-078

**Signature** — *(aucune ligne `error_logs` : angle mort)* — deux alertes `OVERSPEED` du **même
véhicule** portant le **même `payload.startAt`** (l'instant de l'excès, à la seconde), sur deux
`tripId` différents ; et des alertes dont `tripId` est **NULL** alors que `payload.tripId` est
renseigné.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **2** · famille **faux positif** *(doublon)* ·
11 doublons sur 55 en 14 jours · 2026-09-13

### Le recalcul réécrit l'identité du trajet, et l'alerte d'excès de vitesse dédupliquée par trajet part deux fois

### Ce qui a été observé

Le rapport du 10/09 écrivait : *« les dix paires de messages identiques sur 7 jours portent toutes
deux `tripId` distincts — c'est le même véhicule refaisant le même trajet »*. **La lecture était
fausse.** La clé qui le prouve est dans le `payload` de l'alerte : `startAt`, l'instant de l'excès
tel que le GPS l'a daté.

| Sur 14 jours (30/08 → 13/09) | |
|---|---:|
| Alertes `OVERSPEED` nées de l'analyse de trajet (`payload.source = trip-analysis`) | **55** |
...
**Le cas qui se lit à l'œil nu** — EP-047-TY, 11/09. Excès `09:47:32 → 09:47:34`, 70 km/h sur une
voie à 30, 2 s, `overKmh: 40`. Alerte à **10:14:42** sur le trajet *live* `09:46:32 → 09:49:57`
(`tripId fd0d07e7`). Le recalcul de **10:53:57** supprime ce trajet — l'alerte perd son `tripId`
(`Alert.trip` est `onDelete: SetNull`, le `payload` garde l'ancien id, mort) — et **recrée** un
trajet `09:24:59 → 10:34:48` sous l'id `c54f9f88`. L'analyse de ce nouveau trajet retrouve le même
excès à la même seconde, `findFirst({ tripId: c54f9f88 })` ne trouve rien, et **l'alerte repart à
10:54:17**, `payload` identique au caractère près hors `tripId` et `tripStartedAt`. Cinq
destinataires, deux fois.

**Et le recalcul produit des trajets qui se chevauchent** : le même véhicule porte
`09:24:59 → 10:34:48` **et** `10:29:35 → 12:33:50` — 5 min 13 s en commun. Les 9 autres doublons
sont de cette forme : deux trajets `recompute` vivants, découpés différemment, contenant tous deux
l'instant de l'excès (ex. FV-941-LZ 09/09 : trajets à 06:47:57 et 07:12:37 pour un excès à
07:23:15 ; FG-669-DQ 04/09 : deux alertes **dans la même seconde**, 13:17:42, depuis deux trajets).

### Cause racine

`createSpeedingAlert` (`apps/api/src/alerts/alerts.service.ts`) déduplique sur `tripId` — son
commentaire le dit : *« DÉDUPLIQUÉE PAR TRAJET, acquittée ou non : un trajet ré-analysé ne produit
pas une seconde alerte »*. **La garde est juste ; la clé ne l'est pas.** Le `tripId` est une
identité que la plateforme elle-même réécrit : l'automatisation horaire redécoupe sa fenêtre et
crée **150 à 190 trajets `recompute` par jour** — la quasi-totalité du flux — en supprimant les
précédents. Chaque nouvelle identité est un trajet « jamais analysé », donc analysé, donc
ré-alerté. *Vérifié sur l'artefact servi le 13/09 : `tripId: trip.id` ×3 dans
`apps/api/dist/alerts/alerts.service.js`.*

C'est la même racine que **T28** : `trips` n'a ni identité stable ni `updatedAt`, donc rien ne
distingue « le même trajet, recalé » de « un autre trajet ».

### Ce que ça coûte

- **1 notification d'excès sur 5 est un doublon** : sur 275 remises `OVERSPEED` en 14 j (5
  destinataires par alerte), ~55 partent pour un excès déjà notifié. C'est une part de la saturation
  mesurée par [TRK-072](#trk-072) — *calibrer le seuil sans corriger la clé, c'est régler la
  sensibilité d'un instrument qui compte double.*
- Les alertes orphelines ont un **lien « Voir le trajet » mort** (`payload.tripId` → trajet
  supprimé).
- Le compteur `OVERSPEED`/jour suivi par l'audit est **gonflé de ~20 %**.

### Correctif proposé

1. **Dédupliquer sur l'excès, pas sur le trajet.** Avant de créer, chercher une alerte `OVERSPEED`
   du même `vehicleId` dont `payload.startAt` est à moins de quelques secondes de
   `decision.startAt` — ou dont la fenêtre `[startAt, endAt]` chevauche celle de la décision. C'est
   la clé qui a servi à mesurer les 11 doublons : elle est stable parce qu'elle vient du GPS, pas de
   la segmentation. *(Garder le test par `tripId` en plus ne coûte rien.)*
2. **Faire survivre l'identité du trajet au recalcul** — `upsert` sur `(vehicleId, startedAt)` (à
   une tolérance près) au lieu de supprimer/recréer, ou re-pointer les alertes vers le trajet
   remplaçant. Ce geste répare aussi les liens morts, **et il est le prérequis naturel de T28** : une
   journée close ne peut rendre la même valeur deux jours de suite tant que ses trajets changent
   d'id. Regarder aussi pourquoi deux trajets `recompute` peuvent se chevaucher.

### Vérification — double condition

- Sur 7 jours glissants, **0 groupe** (véhicule, `payload.startAt`) de taille > 1 ;
- **ET** le nombre d'excès distincts par jour reste à son régime (**~3/jour** : 44 sur 14 j). *Si les
  alertes tombent à zéro, on a cassé la détection, pas le doublon.*
- `alerts` avec `tripId IS NULL` et `payload ? 'tripId'` ne doit plus croître (**2** le 13/09).

### À ne pas faire

- **Ne pas** « corriger » en supprimant les doublons existants : ce sont des alertes vues et
  acquittées par des humains, et le témoin des disparitions les compterait.
- **Ne pas** dédupliquer par message : deux excès réels au même endroit deux jours de suite
  produisent le même texte hors la date.

---

## TRK-077

**Signature** — `TRIP_AUTOMATION | CRITICAL | Passage d'automatisation interrompu : commencé le <DATE> (planifié), jamais terminé — l'API a redémarré <DURÉE> plus tard.`
Contexte : `phase: 'interrompu'`, `runId`, `origin`, `minutes`, `startedAt`.
**Statut : 🟠 CORRECTIF PROPOSÉ** · gravité **2** · famille **faux positif de garde** · 2 occurrences · 2026-09-10

*(⚠️ **La signature est celle de [TRK-073](#trk-073), et c'est voulu.** TRK-073 a livré le témoin —
il fonctionne, et il vient de faire son travail deux fois. Cette fiche-ci ne porte pas le témoin :
elle porte **le garde-fou censé rendre ce témoin rare**, et qui ne le rend pas.)*

### Ce que ça veut dire

L'automatisation des trajets part à **HH:45** et dure de 2 à 54 minutes. Recréer le conteneur de
l'API pendant ce temps **tue le passage**. Le garde-fou existe depuis le 2026-09-08
(`fd87ca46`) : `deploy.sh` lit `trip_automation_runs` et **refuse de partir** si une ligne
`status = 'running'` est ouverte.

**Il est en place, il est correct, et il n'a rien empêché le 09/09.**

| Heure UTC | Fait |
|---|---|
| ~17:43 | Le déploiement démarre. `deploy.sh` §1 lit `trip_automation_runs` : **aucune ligne `running`**. La garde laisse passer — **et elle a raison** |
...
**La garde est lue au moment où l'on décide de construire, pas au moment où l'on va tuer.**

`deploy.sh` fait sa lecture **une seule fois**, au §1. Puis viennent `git pull` (§2) et
`docker compose up -d --build` (§3). Entre la lecture et la recréation du conteneur, il s'écoule
le temps d'une construction — plusieurs minutes. *Or une construction ne tue personne : elle
fabrique une image. Seule la recréation du conteneur interrompt un passage.*

> 🔑 **Conséquence, et elle est contre-intuitive : la garde protège de tout SAUF du cas le plus
> probable.** Un déploiement lancé entre **HH:40 et HH:45** franchit la garde à coup sûr (rien ne
> tourne encore) **et** tue le passage à coup sûr (la construction finit après HH:45). Plus on
> déploie « juste avant l'heure », plus la garde est inutile — et « juste avant l'heure » est
> exactement le moment où l'on déploie quand on veut éviter de gêner.

*C'est la forme générale du défaut « vérifier puis agir » : entre le contrôle et l'acte, le monde
a le droit de changer. Le contrôle doit être adjacent à l'acte, pas à la décision.*
...
1. **Relire la garde juste avant `docker compose up -d`**, après la construction. C'est le moment
   où l'on va réellement tuer quelque chose, donc le seul où la question se pose. Le refus coûte
   alors une construction perdue — ce qui est le prix juste, et bien inférieur à un passage tué.
2. **Refuser de partir dans la fenêtre HH:40 → HH:45** (sauf `--force`), parce qu'une construction
   lancée là finira forcément après le départ du passage. *Le geste 2 seul ne suffit pas (une
   construction lente lancée à HH:35 tomberait encore mal) ; il évite simplement de jeter trois
   minutes de travail.*

### Vérification — et elle est DOUBLE

| Condition | Ce qu'elle prouve |
|---|---|
| Au prochain déploiement lancé entre HH:40 et HH:45, `deploy.sh` **refuse** — avant de construire, ou après | Le garde-fou est adjacent à l'acte |
| Des lignes « Passage d'automatisation interrompu » **restent possibles** (un `--force` assumé doit toujours en produire une) | On a protégé le passage, **pas éteint le témoin** |

🔴 **Si les deux tombent ensemble, on a désarmé TRK-073.** C'est le piège nommé au §0 de la
procédure, et il est particulièrement facile à tomber ici : le plus court chemin vers « plus de
`CRITICAL` » est de cesser d'en écrire.

### Réserve d'honnêteté, à ne pas effacer

`deploy.sh` **ne pose aucune étiquette** `avant-*`. Or les images du 09/09 portent
`avant-cloison-arbre` (17:46:09) et `avant-purge-comptes` (18:04:55) : ces étiquettes ont été
posées **à la main**. On ne peut donc pas affirmer que le déploiement de 17:46 soit passé par le
script.

**Les deux lectures mènent au même geste :**

- si la garde a été **contournée**, alors elle ne vit que dans un script qu'on peut ne pas appeler —
  et il faut la déplacer là où elle ne se contourne pas ;
- si elle a été **lue trop tôt**, c'est le défaut décrit ci-dessus.

*La seconde est la plus probable : le script vient d'être écrit exactement pour ça, et le
déploiement du 08/09 05:45 — antérieur au garde-fou — a la même signature.*

### Occurrences

| Date | Passage tué | Garde en place ? |
|---|---|---|
| 2026-09-08 05:45:00 | départ 05:45, API redémarrée « moins d'une minute » plus tard | **Non** — `fd87ca46` déployé le 08/09 à 17:12 |
| 2026-09-09 17:45:00 | départ 17:45:00.145, `CRITICAL` à 17:46:43.678 | **Oui**, et vérifiée présente ce matin (ligne 52, arbre git du VPS propre au commit `e4749302`) |

⚠️ **Coût connu** : depuis `f988c74e`, **une `CRITICAL` suffit à déclencher un e-mail**. Chaque
déploiement mal placé envoie donc une alerte au propriétaire. C'est le comportement voulu, et c'est
ce qui rend ce correctif utile plutôt que cosmétique.
...
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ PAR L'ÉCHÉANCE le 2026-09-15** *(déployé le 2026-09-08 à 01:01:57 ; ancien libellé « CORRIGÉ ET DÉPLOYÉ », rectifié le 15/09)* · gravité **2** · famille **brut** · 2 occurrences · 2026-09-07 → 2026-09-15

### ✅ 2026-09-15 — l'échéance de sept jours est atteinte (T27 FAIT)

**0 ligne `getSource` depuis le 07/09 13:04** — **180 h**, dont **168 h après le déploiement**. Et le compte
qui l'avait produite, `standard@cdef31.org`, **est revenu** : 2, 2, 9, 7 et 10 requêtes API les 08, 09,
11, 12 et 13/09, sans une ligne `frontend`. La barre que la fiche s'était donnée est franchie.
⚠️ **Ce que ça ne prouve pas** : qu'une perte de contexte WebGL ait eu lieu et ait été rattrapée par le
bandeau de reprise — elle ne se provoque pas en lecture seule. *Une échéance franchie sans occurrence est
une preuve par l'absence : elle vaut ce que vaut l'exposition — ici cinq jours d'un utilisateur réel sur la
carte.*
...
**Statut : 🟢 CORRIGÉ ET DÉPLOYÉ le 2026-09-08 à 17:12:05** (`dc35f1a3`)
*(en-tête rectifiée le 2026-09-09 ; libellé antérieur conservé en clair : « 🔴 NON CORRIGÉ »)*
· gravité **1** · famille **circulaire** · **27 occurrences** au total · 2026-09-08 → 2026-09-08

> ✅ **LE TRAJET S'EST TU.** Dernière ligne le **08/09 15:55:05**, puis **8 passages horaires
> consécutifs sans aucune ligne** `stage: 'compute'` (17:45 · 18:45 · 19:45 · 20:45 · 21:45 · 22:45 ·
> 23:45 · 00:45, **tous `done`**). Auparavant : **une par passage, sans exception, depuis le 07/09
> 03:45** — 27 au total, dont 12 dans les 24 h précédant le correctif.
>
> **Le correctif** (`dc35f1a3`) : une classe dédiée `PositionsIntrouvablesException` — toujours un
> 422 — que `analyze()` **n'archive plus** et que les **trois** appelants reconnaissent pour figer :
> `fige-retention` sous l'horizon (**muet**), `fige-sans-positions` au-dessus (l'anomalie est dite
> **une** fois, le gel garantissant l'unicité). **Vérifié sur l'ARTEFACT SERVI** :
> `PositionsIntrouvables` présent dans `dist/common/` et cité ×2 dans `trip-analysis.service.js` ;
> `fige-retention` ×5 et `fige-sans-positions` ×5 ; `horizonRetention` ×7 — *le plancher que la
> jumelle avait déjà.*
>
> ⚠️ **LA SECONDE MOITIÉ DE LA DOUBLE CONDITION ÉTAIT INVÉRIFIABLE TELLE QUE JE L'AVAIS ÉCRITE, ET
> ELLE EST REFORMULÉE PLUTÔT QUE DÉCLARÉE SATISFAITE.** « Les candidats tombent de 17 à 14 » suppose
> que le correctif retire des lignes de `trip_analyses` : il n'en retire **aucune**, il **exclut**
> les candidats sous l'horizon *au moment de la sélection*. Une requête en lecture ne voit donc pas
> « 14 » — elle voit le **vivier**, et le vivier **grossit** :
>
> | Mesure | 08/09 | 09/09 |
> |---|---:|---:|
> | Vivier (`limitsCoverage < 0,8`, `computedAt` > 12 h) | 17 | **20** |
> | dont **sous** l'horizon de rétention | 3 | **4** |
>
> *C'est la fuite lente annoncée, à la vitesse annoncée : +3 candidats et +1 immortel par jour.* Ce
> que le correctif change n'est pas le vivier, c'est que les 4 immortels ne sont plus tentés.
>
> **Et le rejeu n'est pas éteint** : les 8 passages depuis la bascule ont analysé **2 à 8 trajets
> chacun**, et **30 analyses** portent un `computedAt` postérieur au déploiement.
>
> 🗓️ **Le test qui tranche, au 10/09** : **24 h pleines sans aucune ligne `stage: 'compute'`**,
> pendant que le vivier sous horizon passe de **4 à ~5**. *Si les lignes reviennent, le gel ne tient
> pas ; si le vivier sous horizon cesse de croître, c'est qu'on a purgé au lieu de borner.*
...
### ✅ 2026-09-14 — PROUVÉ : les quatre lignes se sont refermées seules, 165 h après leur naissance

Déployé le **13/09 à 13:33** (`171857fc`, T25). **À 13:35:00**, deux minutes plus tard, les quatre
`CRITICAL` du 06/09 (17:35, 18:35, 19:35, 20:35) portent `resolvedAt` et la note *« Tâche repassée le
13/09/2026 14:55 (résolution automatique) »*. La sonde archive les lignes ouvertes **antérieures au dernier
passage** de la tâche (borne `createdAt < lastRunAt`), filtrées par le chemin JSON `context.task` — jamais
par le texte du message —, et un archivage qui échoue ne fait taire ni le jugement ni les tâches suivantes.
Relu le 14/09 dans l'artefact servi : `resolvedAt` ×2 dans `dist/observability/scheduled-task-heartbeat.service.js`.
**0 ligne active** de cette source au 14/09 (11 au total, toutes archivées).

⚠️ **Seconde moitié de la double condition — une tâche réellement à l'arrêt doit CONTINUER d'en produire —
non exercée** : `trip_automation_runs` rend 24/24 passages `done` chaque jour depuis. Elle est garantie par
la borne (une ligne écrite APRÈS le dernier passage n'est jamais touchée) et par 7 tests ; à observer au
prochain arrêt réel. *Si plus rien n'apparaît alors, on aura éteint le témoin au lieu de lui apprendre à se
taire.*
...
Contexte : `task`, `cadence`, `silenceHours`, `maxSilenceHours`.
**Statut : 🟢 CORRIGÉ, DÉPLOYÉ ET PROUVÉ le 2026-09-13 à 13:35:00** *(`171857fc`, T25 — les 4 lignes archivées seules, voir la section du 14/09 ci-dessous ; en-tête rectifié le 14/09, ancien en-tête : « 🔴 NON CORRIGÉ »)* · gravité **2** · famille **à lire, pas à notifier** · 4 occurrences · 2026-09-06

*(Branche distincte de celle de [TRK-042](#trk-042), corrigée le 22/08, qui portait sur « aucun
passage enregistré depuis son activation ». Ici la tâche a un historique — il est simplement resté
figé, cf. [TRK-073](#trk-073).)*

### Ce que ça veut dire

Les quatre `CRITICAL` du 06/09 (17:35, 18:35, 19:35, 20:35) décrivaient une condition qui a **cessé
d'être vraie à 20:45**, quand le passage a repris. **Elles étaient toutes encore `ACTIVE` à la
collecte du 07/09 à 01:09**, plus de quatre heures après.

**Le bon comportement existe dans le même dépôt, dans une sentinelle plus récente :**

| Sentinelle | Née le | Que fait-elle quand la condition se referme ? |
|---|---|---|
| `background-tasks/agents-locaux-sentinelle.service.ts` | 05/09 | **Archive ses lignes toute seule** (`:266-272`) : `resolvedAt` + `resolvedNote = « Agent repassé le … (résolution automatique) »` |
| `observability/scheduled-task-heartbeat.service.ts` | 22/08 | **Rien.** Aucune notion de résolution dans le fichier |

Mesuré le 07/09 : les **4 lignes `agents-locaux`** des 05 et 06/09 sont **toutes archivées**
(« Agent repassé le 06/09/2026 à 06:08 », « … à 22:00 »), zéro geste humain. Les **4 lignes
`scheduled-task-heartbeat`** du 06/09 sont **toutes actives**.
...
> centre d'alerte — et c'est exactement ce qui pousse à vouloir « vider l'écran », geste que ce
> dispositif s'interdit depuis [TRK-035](#trk-035).

### Correctif proposé

Porter la résolution automatique de `agents-locaux-sentinelle` vers `scheduled-task-heartbeat` : à
chaque passage, pour chaque tâche redevenue conforme à sa cadence, archiver ses lignes ouvertes avec
`resolvedNote = « Tâche repassée le <date> (résolution automatique) »`.

⚠️ **Filtrer sur une clé STRUCTURÉE** — le nom de la tâche tel qu'il vit dans le contexte
(`meta.task`) — **jamais sur le texte du message.** La sentinelle voisine documente précisément ce
piège (`:254`) : un nom de tâche contenu dans un autre archiverait les lignes d'une tâche tierce.

⚠️ **Double condition** : après correctif, les lignes doivent **s'archiver** quand la tâche repasse,
**et** une tâche réellement arrêtée doit **continuer** d'en produire. *Si plus rien n'apparaît, on a
éteint le témoin au lieu de lui apprendre à se taire.*

⚠️ **Ne pas archiver ces quatre lignes à la main** en attendant. Elles documentent
[TRK-073](#trk-073), dont le correctif n'est pas écrit — et une ligne reste visible tant que le
défaut n'est pas corrigé **et** vérifié.

---

## TRK-072

**Signature** — `sentinelles | ERROR | <EMAIL> a reçu <N> notifications en 24 h, dont <N> de type <TYPE> (et <N> de plus ont été repliées par le regroupement). Le produit est calibré sur deux à trois par jour. À ce rythme, cette personne va couper ses notifications…`. Contexte : `email`, `role`, `type`, `envois`, `regroupes`, `userId`.
**Statut : 🔵 TERRAIN** *(décision produit)* · gravité **2** · famille **à lire, pas à notifier** · 2 occurrences · 2026-09-06

### Ce que ça veut dire

Le seuil « **destinataire saturé** » des sentinelles V6
(`observability/sentinelles-coherence.service.ts:705-710`) a parlé pour la première fois, le 05/09 à
06:30 :

| Compte | Notifications 24 h | dont `OVERSPEED` | repliées par regroupement |
|---|---|---|---|
| `admin@vizyoagency.com` (SUPER_ADMIN) | 15 | 14 | 3 |
| `rougie31@live.fr` (SUPER_ADMIN) | 15 | 14 | 3 |

**Ce n'est pas un défaut : c'est l'effet mesuré de la décision produit du 04/09.** Les alertes de
vitesse ont été armées sur 2 sociétés sur 5 ([TRK-064](#trk-064)), la chaîne V5 a écrit ses premières
`OVERSPEED`, et la première conséquence visible n'est pas un déluge en base — c'est **la saturation
de deux boîtes de réception**.

### Le compte quotidien d'`OVERSPEED` (relevé demandé par le rapport du 05/09)
...
⚠️ **Deux points ne font pas une tendance**, et surtout pas une décroissante. Ce qui est acquis : on
est **très loin** des 1 317 alertes de [TRK-022](#trk-022), et la sentinelle a crié **avant** que le
destinataire ne coupe ses notifications.

> 🔑 **C'est le cas rare d'un instrument qui parle au bon moment.** Le risque qu'il annonce — « cette
> personne va couper ses notifications, et elle ne recevra alors plus rien, pas même un SOS » — est
> exactement le mécanisme par lequel une alerte de vitesse mal calibrée ferait perdre une alerte
> vitale. *Le noter même quand il n'annonce pas de catastrophe.*

### Action proposée — produit, humaine

Trancher entre les deux leviers que la sentinelle nomme elle-même :

1. **relever le seuil** qui produit `OVERSPEED` (vitesse, durée de dépassement, marge) ;
2. **restreindre ses destinataires** — un SUPER_ADMIN n'a probablement pas à recevoir les excès de
   vitesse de **toutes** les flottes ; c'est un rôle d'exploitation, pas d'abonnement.

### ⚠️ Ce qu'il ne faut PAS faire

- **Ne pas désarmer les alertes de vitesse** pour faire taire la sentinelle : ce serait revenir à
  [TRK-064](#trk-064), où la chaîne se taisait parce qu'elle n'était activée nulle part.
- **Ne pas élargir le regroupement** sans regarder le seuil : replier 3 notifications de plus ne
  change pas le fait qu'un excès sur deux n'en est peut-être pas un.

### Vérification

Après réglage, la sentinelle doit **cesser d'écrire** — et le compte quotidien d'`OVERSPEED` doit
rester **non nul**. 🔴 **Double condition :** si les deux tombent, on a éteint la chaîne d'alerte au
lieu de la calibrer.
...
|---|---|---|---|---|
| 2026-09-21 | **351 actives** — 211 défauts + 140 `DEGRADATION` (42 nées sur 24 h, **42 actives**, **36 défauts**, **76 `CRITICAL`** dont 25 `engine-control-interlock`, **18 `sms-gateway-watchdog`**, **11 `engine-control-restore`**, 10 `agents-locaux`, 4 `sms-gateway-status`, **4 `sms-daily-proof`**), 88 archivées *(inchangé)* | 36 revues ; 🟢🔴 **CINQUIÈME NUIT PROBANTE — SOUS UNE VM À 10 % DE SON CPU (VPS-045, levée 13:36), LE MÉCANISME A TENU ET SES INSTRUMENTS ONT MENTI.** 31 reprises / 31 (2,6 → 220 s, **5 SMS de secours dont 2 pour rien**), 30 coupes / 30, 0 refus, HM-733-GA pas rallumé. 🆕 [TRK-090](#trk-090) **gravité 2** : preuve quotidienne 02:30 / 04:30 « REFUSÉE » puis « **ÉCHEC — chaîne cassée** » (4 `CRITICAL`, 2 pushs) **alors que le téléphone l'a reçue 38 s après** (5 échos en base ; délai client 10 s = `failed`, écho ignoré sur un `failed`) — l'interlock n'a tenu que par un SMS de secours à 05:02:57. 🆕 [TRK-091](#trk-091) **gravité 3** : worker RESTORE vs dispatch en ligne (bail absent à la création, numéro lu en mémoire, trame avant la ligne) → 6 commandes, **4 `CRITICAL` « en erreur — intention conservée »** sur des remises acquittées 6–17 s après. 📏 [TRK-083](#trk-083) **×3 dont 1 sans charge** (EP-047-TY CUT 18:00, `jt` 43 ms avant) ; AL-927-QM : SMS 7 s après l'ACK. 📏 [TRK-089](#trk-089) 2ᵉ épisode, cause serveur : 8 `CRITICAL` « aborted due to timeout », 7 pushs, 0 sortie. 📏 [TRK-068](#trk-068) ×8 : personne ne se connecte 05:10 → 06:58. 🆕 [TRK-092](#trk-092) ⚪ 5 messages bruts. 🔴 [TRK-069](#trk-069) pause 4 j, 99 h sans récit. ✅ V35 (steal 2 %), V34 j1, V4 sans passage interrompu | **3** — TRK-090, TRK-091, TRK-092 | agent |
| 2026-09-20 *(couvre 18→20/09 — l'audit du 19 a été lancé en rattrapage à 14:12 UTC et interrompu par l'utilisateur)* | **309 actives** — 175 défauts + 134 `DEGRADATION` (23 nées sur 24 h, **45 depuis le 18/09 01:26, toutes actives**, **57 `CRITICAL`** dont 25 `engine-control-interlock`, **10 `sms-gateway-watchdog`**, 9 `agents-locaux`, 5 `engine-control-restore`, 4 `sms-gateway-status`), 88 archivées *(inchangé)* | 35 revues ; 🟢 **NUITS 3 ET 4 PROBANTES** (18→19 et 19→20, prod `ad0abff4` = `main`, `8e289f38` déployé le 19/09 16:36 après 7 037 s d'attente — **T29 3ᵉ preuve**) : [TRK-066](#trk-066) — **59 coupes / 59 ACK TCP 0,4–6,1 s** (4 + 25, puis 4 + 26 avec HM-787-GA neuf), **35 reprises du 19/09 ≤ 7,5 s**, 0 SMS, 0 refus, 0 `SENT_UNCONFIRMED` ; **HM-769-GA coupé et remis en route pour la 1ʳᵉ fois en 5 nuits** (fix retrouvé 18/09 ~08:30, TRK-086 éteinte après 15 lignes — non corrigée). 🔴 **LE S21 A DORMI 2 H 22** (19/09 02:23:55 → 04:46) : 9 `CRITICAL` watchdog, 2 preuves `INDETERMINEE`, **remises à 04:46 quand le téléphone est revenu** (relais T45) → interlock vert le soir, **et rien ne l'écrit** → 🆕 [TRK-089](#trk-089) **gravité 3** (T68 rejoué sur une 2ᵉ source + verdict jamais relu) ; ✅ **T69 (3) `passerelle-sms` ×3 et (4) `preuve-sms` ×2 exercés**. 🔴🔴 **HORS CENTRE D'ALERTE — VPS-016 nº 7** : un 2ᵉ `docker logs` sans `timeout` (PID 2060212, `--tail 500` foodsqan-traefik, script « PROXY/ROUTEURS », 19/09 **18:30:17**, 4 min après le déploiement marketing) a pris le 2ᵉ cœur (`%idle` 37 → 7 % à 18:40) pendant que V33 (84 h 37) tient le 1ᵉʳ ; **`%steal` 3 → 21 (22:10) → 46 (23:10) → 72 (00:10) → 89 % (01:10)**, charge **56 / 41 / 27** à 01:17 pour 6 % d'user ; Vizyo Auth injoignable 00:00:26 → 00:02:20 ([TRK-068](#trk-068) exercé, 503 rendu en 57 s ; 3ᵉ refus fondu = [TRK-085](#trk-085)) — **les 31 reprises de ce matin partent sur un dixième de CPU**. 🔴 [TRK-069](#trk-069) : pause depuis le 17/09 08:50, **75 h sans récit**, **3 `CRITICAL` « passage manqué » malgré la pause** (reste de T34 / T58). 📏 [TRK-078](#trk-078) : **1 paire / 6 le 18/09** (FV-941-LZ 141,7, 1ʳᵉ alerte sans instant, trajets chevauchants) — rectification : toute pointe peut naître sans instant. 📏 [TRK-082](#trk-082) 2ᵉ faux positif mesuré (alerte présente sur l'ancien `tripId`). 📏 [TRK-084](#trk-084) pt 4 : HM-787-GA `SCHEDULER` 05:09 73 s après une manuelle. 📏 [TRK-053](#trk-053) : la sentinelle « boîtiers muets » liste 4 véhicules déclarés hors service. 📏 [TRK-072](#trk-072) 15 / 11 `OVERSPEED` · [TRK-065](#trk-065) 12 · [TRK-071](#trk-071) 409 h, 0 appel IA en 72 h · [TRK-037](#trk-037) 81 (+7) · [TRK-062](#trk-062) 0 (6ᵉ). T28 : 16/09 216 (3ᵉ point), 17/09 186, 18/09 232 figés à 100 %. 🔵 HM-733-GA rallumé à la main 5 nuits sur 5, GS-187-NY, HD-603-XY, HM-787-GA, EP-047-TY ×2, FV-941-LZ : plannings des deux clients ; A2R parle pour la 1ʳᵉ fois (36 analyses). Toutes mes commandes Docker sous `timeout` + borne (`images` n'a rien rendu : démon saturé), fenêtre `docker logs` citée (21:05:20 → 01:20:22) ; **2 clients résiduels, aucun de cette passe, non tués**. Tests datés : reprises 03:00 / 05:00 UTC sous 89 % de steal, à lire à 07:10 Paris | 1 (TRK-089) | agent d'audit *(tâche planifiée, partie à 03:09 Paris — poste réveillé)* |
| 2026-09-18 | **264 actives** — 145 défauts + 119 `DEGRADATION` (31 nées sur 24 h, **31 encore actives**, **23 défauts**, **45 `CRITICAL`** dont 25 `engine-control-interlock`, 6 `agents-locaux`, 5 `engine-control-restore`, 4 `sms-gateway-status`), 88 archivées *(+1, résolution automatique)* | 34 revues ; 🟢 **DEUXIÈME NUIT PROBANTE** (17→18, prod `1d1521b2` = `origin/main`) : [TRK-066](#trk-066) — preuve 21:30 Paris remise en 5 s, 0 refus d'interlock, **28 coupes / 28 acquittées en 0,4–5,1 s** (EY-613-MF par SMS en 5,1 s : 2ᵉ coupe SMS prouvée, la plus rapide), 0 `SENT_UNCONFIRMED`, T62 exercé (2 lignes `tcp-only`, liste = T61), T69 (2) exercé (14 `SENT` `restore-non-prouvee`) — **T65 : 6 OK / 0 non exercé, second passage OK**. 🔴 **L'INCIDENT DU 17 (doc 31) VU DEPUIS LE CENTRE D'ALERTE** : API en boucle 04:56 → 05:52 (migration lot A en double), 24 `RESTORE` CDEF31 nées **05:53** au lieu de 05:00 (`scheduledAt` NUL), 24 × socket absente → 20 SMS (30 émis, 6 refusés vers les 2 SIM de T61) + 4 TCP, 29/29 acquittées à 06:08, **24 véhicules immobilisés 53–67 min après 07:00 Paris, 0 ligne sur le retard, passage 05:45 absent (23/24) sans ligne** → 🆕 [TRK-084](#trk-084) **gravité 1** ; 6 RESTORE en double (06:02, 06:12, 15:57, 1 SMS payé pour rien) à instruire (`relancer-restore.js`). **7 RESTORE non prouvées à 05:58 → 7 `alertedAt`, 14 notifications, 1 ligne** ; 6 SMS refusés → 4 lignes : 🆕 [TRK-085](#trk-085) **gravité 2** — `ErrorLogger` déduplique sur `source|level|message[0:140]` 60 s, compteur perdu. 🆕 [TRK-086](#trk-086) : HM-769-GA (33,7 h sans fix, 35 trajets bruts) → 8 `ERROR` `TRIP_AUTOMATION` en 7 h, `dirty` choisi depuis le plancher de 60 j, tranche bornée à `windowFrom`, gel qui ne l'atteint pas ; candidats HM-733-GA (65), HM-779-GA (39). 🆕 [TRK-088](#trk-088) (`sms-gateway-status`, 1ʳᵉ parole, 🔵 T61) et 🆕 [TRK-087](#trk-087) (⚪ 503 `MANAGER_INTERNAL_URL`, recette lot A 07:11, clos à 13:37). 📏 [TRK-069](#trk-069) : **session Claude Code expirée 03:21** (401) ; ✅ **T34 exercé** (pause 08:50, e-mail, 1 `DEGRADATION`, 9 passages suspendus sans `CRITICAL`) ; 0 récit depuis 22 h — T75. ✅ **T29 prouvé** ([TRK-077](#trk-077) : recréations 13:37:04 et 15:37:05 une seconde après la fin des passages, 3 355 s et 6 012 s d'attente, 0 `interrupted`). ✅ **T28 prouvé** ([TRK-016](#trk-016) : 15/09 = 222/222/192/0/0 au mot près, 14/09 250 3/3, 16/09 figé 216, 688/688 < 2 h depuis création). ✅ T40 · T42 (TCP à la reconnexion 06:06) · T45 (35/35 `statusUpdatedAt`) · T65 · T67 · T69. 📏 [TRK-078](#trk-078) : 12 excès / 12 alertes / 0 doublon, 7 `absolu` avec instant — rectification : la pointe **au plafond** (130 pile) n'a pas d'instant, pas le motif. 📏 [TRK-072](#trk-072) : saturation par `agent-local-absent` (7/24 h × 2). 📏 [TRK-053](#trk-053) 3 (2ᵉ point) · [TRK-071](#trk-071) 361 h · [TRK-083](#trk-083) non exercé · Overpass 74 (+3). `trip_automation_runs` 23/24, 8 > 45 min (série 7, 5, 6, 8). 🔵 HM-733-GA rallumé à la main 3 nuits sur 3 ; HM-769-GA non coupé 4ᵉ nuit ; GLA•KC•31 359 h, FG-669-DQ 275 h non déclarés. 🔴 **VPS-016 nº 6 : PID 3366708 vivant depuis 36 h 37, `dockerd` 91,7 %, charge 1,67** — V33 non fait ; pas de cette passe. Toutes mes commandes Docker sous `timeout` + borne, fenêtre `docker logs` citée (21:27:25 → 01:24:58). Tests datés : reprises 03:00 / 05:00 UTC à lire à 07:10 Paris ; TRK-016 16/09 = 216 le 19/09 | 5 (TRK-084, TRK-085, TRK-086, TRK-087, TRK-088) | agent d'audit *(tâche planifiée, partie à 03:10 Paris — poste réveillé)* |
| 2026-09-17 | **236 actives** — 125 défauts + 111 `DEGRADATION` (12 nées sur 24 h, dont **10 encore actives** et **6 défauts**, **37 `CRITICAL`** dont 25 `engine-control-interlock` de la nuit 15→16 et 4 `agents-locaux`), 87 archivées *(+3, toutes par résolution automatique)* | 33 revues ; 🟢 **PREMIÈRE NUIT PROBANTE DU CHANTIER COUPE-CIRCUIT** (`87ae29c9` / T69 déployé le 16/09 05:24, 292 s) : [TRK-066](#trk-066) — preuve de **21:30 Paris** partie et remise en 6 s (T69 exercé le soir même), **0 refus d'interlock**, **28 coupes** (4 MH Cars à 20:00 Paris — première nuit armée —, 24 CDEF31 à 22:00), **27 acquittées** (26 TCP en 0,4–5,4 s, **1 SMS prouvée de bout en bout** : HM-733-GA, `engine_control_fallback` `delivered` + accusé entrant, 83 s), 4 reprises MH Cars ≤ 4,1 s, 22 CDEF31 à lire à 07:10 Paris. **T65 : 5 OK / 2 non exercés / 0 rouge** — premier passage vers le Go du banc. 🆕 [TRK-083](#trk-083) **gravité 2** : GR-898-HY `SENT_UNCONFIRMED` alors que son `jt` est arrivé à 20:01:38,3 — **0,9 s avant** l'inscription du guetteur (armé après `beginAttempt` + `writeSent`, 8,5 s cette minute-là ; `AckWaiter` sans mémoire) ; sur une RESTORE = SMS + `CRITICAL` + push à tort ; jumeaux `tracker-commands` / `tracker-fix-mode`, cause plausible d'une part de TRK-014. 🆕 [TRK-082](#trk-082) : la sentinelle « excès sans alerte » (1ʳᵉ parole pour une société armée) juge par `tripId` alors que T30 déduplique par excès — 3 trajets FV-941-LZ recréés à :45 accusés à tort. 📏 [TRK-078](#trk-078) : **2 paires de doublons sur 9** (FM-772-JH : `absolu` sans `startAt`, pointe redécoupée à 79 s > 30 s, trajets chevauchants) — T30 preuve négative. 📏 [TRK-016](#trk-016) / T28 : 15/09 = **222** contre 273 — la journée était encore dans la fenêtre de recalcul (`lookbackHours` 26 h → figée à J+2 00:00 UTC) ; `collecte.sql` gagne `fenetre_recalcul_close` et `cloture_moins_2h_depuis_creation` : **250/250, 222/222, 212/212** ; 14/09 = 250 **2/2**. 📏 [TRK-069](#trk-069) : **le poste dort la nuit** (16/09 02:05→05:55, 17/09 00:05→05:15 Paris) — 2 agents quotidiens manqués et jamais rattrapés, audit +138 min, 4 `CRITICAL`, 5 e-mails. 📏 [TRK-081](#trk-081) : 25 lignes / 7 e-mails sur la nuit 1, **0** la nuit 2. ✅ T9 : déclarations HM-733/769/779 levées à 08:33 par un humain, `GPS_LOST` HM-769-GA 2 min après ([TRK-053](#trk-053) 7 → 3 par retrait). ✅ T45 relais : `statusUpdatedAt` renseigné sur 6/6 sortants. 🔵 HM-733-GA et GS-187-NY rallumés à la main **2 nuits sur 2** (plannings à ajuster) ; HM-769-GA non coupé 3ᵉ nuit « hors champ GPS » (antenne). 📏 V28 : **6 passages > 45 min le 16/09 sans V28** — les durées diurnes sont la charge d'analyse, pas le client bloqué. 🔴 **VPS-016 nº 6** : `docker logs --tail 15 vizyo-auth-api` (PID 3366708, parent `bash -c` 3366707 → `init`) bloqué depuis le 16/09 12:41:08, **14 h 48**, `dockerd` 91,7 %, charge 1,32 — pas de cette passe, pas tué (garde-fou 4) → **V33**. `pgrep -x docker` : 1 (celui-là). Toutes mes commandes Docker sous `timeout` + borne, fenêtre `docker logs` citée (23:02:39 → 03:29:25). | 2 (TRK-083, TRK-082) | agent d'audit *(tâche planifiée, partie à 05:18 Paris au lieu de 03:00 — poste endormi)* |
| 2026-09-16 | **221 actives** — 114 défauts + 107 `DEGRADATION` (32 nées sur 24 h, dont **29 encore actives** et **24 défauts**, **28 `CRITICAL`** dont 20 `engine-control-interlock`), 84 archivées *(+5, toutes par résolution automatique)* | 31 revues ; 🟢 **LE CHANTIER COUPE-CIRCUIT EST EN PRODUCTION** (`fa9ff1d1` 17:35:05, `0c9672c9` 18:14:50, `deploy.sh` ×2 avec attente, arbre VPS `main` propre, V28 tué à 17:20 — charge 0,55) **ET SA PREMIÈRE NUIT N'EST PAS PROBANTE** : [TRK-066](#trk-066) — l'interlock a refusé les **25 coupes de 20:00 UTC** (« dernière preuve de remise SMS trop ancienne (> 24 h) » ; dernière remise prouvée 14/09 07:00:02, preuve manuelle du soir non envoyée, première preuve automatique à 02:30 UTC), **0 `CUT` / 0 `RESTORE` / 0 SMS**, 30 plannings `IN_WINDOW`. **Section T65 lue pour la première fois** : (1) preuve quotidienne non exerçable avant 02:30 ; (2) sentinelle Android 1 épisode (17:37, S21 verrouillé 13:49 → 17:51, T55) ; (3) ping `lastSeen` 01:16:22 / 01:17:22 — **OK à 60 s** ; (4) interlock **rouge par construction** ; (5) RESTORE non prouvées 0 — non exercé ; (6) TCP seul 0 — non exercé. 🆕 [TRK-081](#trk-081) : **20 `CRITICAL` en 5 h, une toutes les 15 min, 5 e-mails du veilleur** — `signalWithheldCut` (T49) n'a pas prévu un interlock rouge neuf heures ; correctif proposé sur la forme seule (T68). ✅ **T67** : 3 rappels sur FV-941-LZ (RESTORE du 14/04) jusqu'à 18:06, **0 depuis** (28 dus), 50 vieilles RESTORE `alertedAt` posé et plus relues — seconde moitié (une RESTORE de la nuit produit sa ligne) non exercée. 📏 [TRK-016](#trk-016) : 13/09 = **86 / 86 / 66 / 20 / 0** (2/2) ; **14/09 = 259 contre 244 hier, 259/259 existaient déjà** — quatre définitions essayées, aucune ne rend 244 : `collecte.sql` gagne **`recalage_journees_closes`** (journée civile de Paris, `AT TIME ZONE 'UTC' AT TIME ZONE 'Europe/Paris'`, `endedAt`), série repartie 13/09 = 88 / 88 / 60 / 28 / 0, 14/09 = 250 / 250 / 239 / 0 / 0, 15/09 = 273 / 273 / 263 / 0 / 0 ; rattrapage 734, 5 644 restants. 📏 [TRK-078](#trk-078) : mardi 5 excès / 5 alertes / 0 doublon / 0 orpheline (1 alerte à `startAt` nul). 📏 [TRK-053](#trk-053) : 7, 11ᵉ point ; les 3 déclarés HM-… dans la liste des coupes refusées (T9). ✅ [TRK-069](#trk-069) : 2 `CRITICAL` nées et refermées seules, 19/20 passages. ✅ T6/T39 : 36 remises 100 % super-admin (3ᵉ point). 📏 [TRK-071](#trk-071) 313 h. `trip_automation_runs` 24/24, 5 > 45 min avant la mort de V28, 3 min à 00:45. Tests datés : preuve SMS 02:45 / 04:45 UTC ; coupes de 20:00 UTC ce soir ; TRK-016 nouvelle définition le 17/09 | 1 (TRK-081) | agent d'audit |
| 2026-09-15 | **194 actives** — 92 défauts + 102 `DEGRADATION` (11 nées sur 24 h, dont **9 encore actives** et **3 défauts**, **4 `CRITICAL`**, 0 `agents-locaux`), 79 archivées *(+15, toutes par résolution automatique)* | 30 revues ; 🔴🔴 **LE FAIT DU JOUR N'EST PAS AU CENTRE D'ALERTE : LE COUPE-CIRCUIT A TOURNÉ SUR L'ANCIEN CODE, ET LA MISE EN PRODUCTION DE 11:40 N'A PAS EU LIEU.** [TRK-066](#trk-066) : plannings CDEF31 réarmés par le client (30/30), **24 `CUT` `SCHEDULER` le 14/09 à 20:00 UTC, toutes `ACKNOWLEDGED`/TCP en 1–5 s**, HM-769-GA différé « hors champ GPS », **2 `RESTORE` manuelles à 21:13/21:14** — dont HM-733-GA, **déclaré « boîtier débranché »** et coupé quand même ([TRK-053](#trk-053) : la déclaration retient les alarmes, pas le planificateur) ; 22 `RESTORE` à lire à 07:10 Paris. [TRK-077](#trk-077) : `deploy.sh` a posé `avant-20260914-1140-9afdf52a`, construit `dcfeb9a5` jusqu'à 11:47:34, et **la seconde lecture de la garde a retenu la recréation** (passage 11:45 → 12:44, 59 min) — conteneur intact, `leadDays` absent, `journal.jsonl` muet, `origin/main` dit « déployé sur prod » : **le garde-fou marche, le refus ne s'écrit nulle part** (🆕 T66). 45 commits de `main` hors production. 🆕 [TRK-080](#trk-080) : sentinelle nº 9, première ligne, sur un réglage écrit hors application (T6) — faux positif d'intention. ✅ [TRK-069](#trk-069) : test daté tombé à 01:50, **13 `CRITICAL` archivées seules à 04:50**, 22/22 passages réussis. ✅ [TRK-076](#trk-076) → prouvé par l'échéance (T27). 📏 [TRK-016](#trk-016) : 13/09 retrouvé 86/86/66/20/0 ; 14/09 = 244/244/233/0/0. 📏 [TRK-078](#trk-078) : 1 qualifié / 1 alerte / 0 doublon. 📏 7 passages d'automatisation > 45 min le 14/09 (3, 3, 0 avant) sous V28 (44 h 38). Test daté : RESTORE du matin à 07:10 ; T14 REQUALIFIER (occasion venue entière) | 1 (TRK-080) | agent d'audit |
| 2026-09-14 | **198 actives** — 102 défauts + 96 `DEGRADATION` (25 nées sur 24 h, dont **16 encore actives** et **11 défauts**, **17 `CRITICAL`** dont 13 `agents-locaux`), 64 archivées *(+17, dont 16 par résolution automatique)* | 29 revues ; 🎯 **PREMIER PASSAGE APRÈS LES HUIT DÉPLOIEMENTS DU 13/09 — ET LA BAISSE VIENT DE CORRECTIFS QUI REFERMENT SEULS.** [TRK-074](#trk-074) → 🟢 : les 4 `CRITICAL` du 06/09 archivées d'elles-mêmes à 13:35 (165 h). [TRK-062](#trk-062) → 🟢 : `SENT_UNCONFIRMED` au premier balayage de 20:30 sur les deux commandes de 298 h, `commandes_en_attente` à **0** pour la première fois. T31 : **cinq contrôles sans rechute** sur la condition exacte de `13471c53`, 12 lignes archivées seules, 13 `CRITICAL` attendent le retour de leurs agents. T28 : première journée close mesurée « à la clôture » — **86 / 86 / 66 / 20 / 0**, à retrouver les 15 et 16/09 ; rattrapage **180 = 12 × 15**. T30 : 0 doublon, 0 excès — *indécidable un dimanche*. T6/T39 : 4 remises après 20:25, **100 % super-admin**. T38 : **0 commande automatique** les 12 et 13/09. 🆕 **[TRK-079](#trk-079)** : deux robots EC2 à agent iPhone falsifié, deux appels avortés par la fermeture de page rapportés en `keepalive` — bruit, T59. 📏 [TRK-069](#trk-069) : variante « hors abonnement / délai dépassé » corrigée sur le poste (`8f1a6c3e`) ; **l'échec `SyntaxError` de `courrier-ia` est muet** sous la clé (agent, motif) — T58, test daté 03:50 UTC. 📏 [TRK-053](#trk-053) : les trois « Retour LLD » **renommés** le 13/09 (HM-…-GA), déclaration intacte, 9ᵉ point à 7. 🔴 **V28 : client Docker toujours bloqué, `dockerd` à 101 % depuis 20 h 47** | 1 (TRK-079) | agent d'audit |
| 2026-09-13 *(couvre 11→13/09)* | **202 actives** — 108 défauts + 94 `DEGRADATION` (14 nées sur 24 h, dont **13 encore actives** et **8 défauts**, **27 `CRITICAL`** dont 19 `agents-locaux`), 47 archivées | 28 revues ; 🎯 **LE FAIT DU JOUR : UN TROISIÈME CANAL IA À SEC, ET C'EST LE SEUL QUI COUPE AUSSI LES AUDITS.** La CLI Claude du poste a atteint son **plafond hebdomadaire** du 10/09 04:00 au 13/09 12:00 (Paris) : 36 passages d'agents en échec, 0 succès pour les trois agents qui rédigent, 7 travaux IA morts, **et les audits des 11 et 12/09 (centre d'alerte) et du 10 au 13/09 (VPS) n'ont pas tourné** — même CLI. **31 des 63 lignes nées en trois jours** ont cette seule cause ([TRK-069](#trk-069) ×25, source neuve `travaux-ia` ×6). Reprise mesurée 12 min après la remise à zéro. ✅ **Deux correctifs prouvés pendant le silence** : [TRK-068](#trk-068) exercée le 12/09 00:00:23 (503, `ERROR`, dépendance nommée, motif conservé, pas de jumelle — **T11 FAIT**) ; [TRK-065](#trk-065) exercée le 11/09 06:30 (`comptesTechniquesEcartes: 1`, compte technique absent ; 53 au lieu de ~21 parce que le numérateur a été ×2,5 — **T17 FAIT**). 📏 **T14 / TRK-053** : trois « Retour LLD » revenus (1 809 et 3 889 positions), **0 alarme, 0 alerte** — occasion à moitié venue, et **3 déclarations « débranché » périmées** à lever. 📏 **Angle mort du 11/09 05:00** : **12 `RESTORE` sur 26 non confirmés** (creux de connectivité, 23–27 boîtiers sur 30), 0 ligne, **0 véhicule immobilisé** (aucun n'était coupé la veille) — question (d) portée à TRK-066/T3. 📏 [TRK-047](#trk-047) : 2ᵉ occurrence après correctif, lacune réelle (trou de 1 h 49), question du trajet brut fantôme. 🔎 TRK-074 5ᵉ et TRK-062 8ᵉ vérifications négatives | **1** — 🆕 [TRK-078](#trk-078) : **le recalcul réécrit l'identité du trajet, et l'alerte d'excès de vitesse dédupliquée par `tripId` part deux fois** — 11 doublons sur 55 en 14 j (20 %), même `startAt` à la seconde ; le guet « tripId NULL » du 10/09 est clos et sa lecture rectifiée | agent d'audit |
| 2026-09-10 | **145 actives** — 70 défauts + 75 `DEGRADATION` (10 nées sur 24 h, dont **7 encore actives** et **1 seul défaut**, **8 `CRITICAL`**), 41 archivées | 26 revues ; 🎯 **LES TROIS TESTS DATÉS DE LA VEILLE SONT FRANCHIS.** (1) [TRK-075](#trk-075) : **33,3 h et 32 passages horaires sans une ligne `stage=compute`**, après *une par passage sans exception*. ⚠️ **Sa seconde moitié — « le vivier sous horizon doit passer de 4 à ~5 » — n'a PAS bougé, et ce n'est pas une purge** : les quatre ont **64, 64, 62 et 61 jours** contre 63, 63, 61 et 60 hier, ce sont **les mêmes**, et **aucun candidat n'existe entre 54 et 60 jours**. *Une consigne datée qui suppose un débit constant sur une grandeur en paquets fabrique un faux verdict dans les deux sens* — reportée au **17/09**. (2) [TRK-016](#trk-016) : le rattrapage tourne, **1 150 → 1 583 trajets recalés (+433 pour ~360 prédits)**, l'écart étant du même ordre que le recalage à la demande du rejeu. 🔴 **Et il a fallu écarter un piège de DÉFINITION pour pouvoir l'écrire** : la même requête sur `createdAt` au lieu de `startedAt` rend **11 475 / 1 713**, soit un **dénominateur en hausse de 1 443 en un jour** — impossible sur une fenêtre glissante qui reçoit ~190 trajets/jour. *Avec la mauvaise définition on publiait « +563 », un chiffre faux obtenu en comparant deux fenêtres différentes.* **Avant de lire une variation, vérifier que la FENÊTRE n'a pas bougé autant que la mesure.** (3) [TRK-064](#trk-064) **franchi avec un jour d'avance** : le passage du 09/09 06:30 tournait déjà sous `8fa14cb4` — la sentinelle **désigne des véhicules** (« 3 véhicules de « mh cars » … FV-941-LZ 84 % de ses 19 analyses ») et porte `vehiculesHorsNorme` ; 🔑 **et la moitié difficile est franchie aussi : « cdef31 » n'a produit AUCUNE ligne**, alors qu'elle en produisait une la veille — *la sentinelle sait se taire, ce qu'un correctif de libellé n'aurait pas su faire* ; 🆕 **[TRK-077](#trk-077) — la garde du déploiement est lue AVANT une construction plus longue que la fenêtre qu'elle protège.** Passage parti à **17:45:00.145**, image construite à **17:46:09**, `CRITICAL` à **17:46:43.678** : le garde-fou `fd87ca46` est **présent, correct, et sans effet**, parce qu'il est lu au moment où l'on décide de construire et non au moment où l'on va tuer. *Forme générale du « vérifier puis agir » : entre le contrôle et l'acte, le monde a le droit de changer* ; 📏 **[TRK-065](#trk-065) — l'arithmétique du « 42 → ~21 » est mesurée** : les deux destinataires `no_device` sont **à ÉGALITÉ, 9 et 9 sur 30 j** — `system@tracky.local` (compte technique, UUID nul) et `tyger.bcn@gmail.com`, **un vrai SUPER_ADMIN sans appareil**. ⚠️ Ceci ne réfute PAS le correctif du 04/09, qui porte sur la ligne hebdomadaire et non sur l'aiguillage ; discriminant attendu le **11/09** ; 📏 **[TRK-072](#trk-072) — `FAILED` = 2 × (`CRITICAL` `agents-locaux` du jour)** : 2→6 ressemble à un triplement, c'est une fonction exacte d'un autre compteur (3 le 09/09, 1 le 08/09, 3 le 06/09, 1 le 07/09) ; 🔎 **[TRK-074](#trk-074) 4ᵉ vérification négative** — 4 `CRITICAL` ouvertes depuis **76,6 h** pendant que sa jumelle en a **ouvert ET refermé trois dans la même journée** (03:50, 08:50, 14:50) ; **TRK-062 7ᵉ vérification d'absence** (203,6 h / 207,0 h, **+24,0 h/jour exactement**, 5ᵉ point) ; 📏 **rectification** : le rapport du 09/09 annonçait « 0 ligne `getSource` sur **48 h** » — l'écart réel valait **24,2 h** au déploiement et 36,1 h à la dernière ligne ; échéance inchangée au 15/09 ; 📏 [TRK-052](#trk-052) **à surveiller** : 2 `OVERSPEED` en 7 j avec `tripId` **NULL** alors que le message nomme un trajet — **elles échappent à la déduplication, qui porte sur `tripId`**. *Ce ne sont PAS des doublons : les 10 paires de messages identiques portent toutes deux `tripId` distincts.* Trois points ou rien ; ⚠️ **`trip_automation_runs` s'érode par le bas pour la 2ᵉ fois** — le 05/09 valait 23 hier, vaut **18** aujourd'hui, et le total de la fenêtre fait **exactement 100** ; TRK-014 **0 acquittement sur 399**, 13ᵉ point ; écart `ins−del−live` **13 250**, 14ᵉ point ; `temoin_arme` **4/4**, **0** nouveau constat depuis 144 h, `errorDeleted = 0` sur 5 nuits ; `cadence_resume` **0** sous 20 s, 10ᵉ point ; `gps_sans_fix` **0** pour le **6ᵉ jour**, toujours trompeur ; TRK-053 `alertes_depuis_declaration` = **7**, **7ᵉ point identique, échéance dépassée de 2 j** ; 🔴 TRK-032 **20 j**, TRK-051 **16 j** ; 🤝 **À FAIRE EN PREMIER : recharger un compte IA — les DEUX sont à sec, 169 h, 8ᵉ jour** | **1** ([TRK-077](#trk-077)) | agent d'audit |
| 2026-09-09 | **138 actives** — 69 défauts + 69 `DEGRADATION` (21 sur 24 h dont **13 défauts**, **7 `CRITICAL`**), 38 archivées | 24 revues ; 🎯 **UNE PREUVE ÉCRITE D'AVANCE EST TOMBÉE AU MOT PRÈS.** La consigne du 08/09 exigeait « 24 lignes, **dont une ou plusieurs MARQUÉES INTERROMPUES** — et si le compte monte à 24 sans qu'aucune ne soit marquée, on a maquillé le carnet ». Le 08/09 rend **24 passages sur 24, dont exactement 1 `interrupted`** : celui de 05:45:00, tué en vol par le déploiement de 05:45. **[TRK-073](#trk-073) est corrigé, déployé et PROUVÉ** *(déploiement du 08/09 17:12:05, `dae97b03` + `dc35f1a3`, `running` ×7 / `interrupted` ×2 sur l'artefact servi)*. Dans le même mouvement, **[TRK-075](#trk-075) s'est tu** : dernière ligne le 08/09 15:55, puis **8 passages horaires sans aucune** — et sa double condition, **invérifiable telle qu'elle avait été écrite la veille**, est **reformulée plutôt que déclarée satisfaite** *(le correctif ne retire pas de candidats, il les exclut à la sélection ; le vivier, lui, GROSSIT — 17 → 20, dont 3 → 4 immortels : la fuite lente, à la vitesse annoncée)*. 🔴 **Et le seul point où le chiffre ment est [TRK-016](#trk-016)** : 85,5 % d'échec de recalage hier, **0,0 % ce matin** — mais **le 07/09 lui-même est passé de 85,5 % à 1,2 % pour les mêmes trajets**, recalés **après** leur clôture par le rattrapage. `trips` n'a **pas d'`updatedAt`** : une colonne de qualité réécrite rétroactivement et sans horodatage **rend toute tendance indécidable**, et la série de dix points ne se prolonge pas. *La bonne nouvelle est réelle — le flux neuf est réparé — mais l'instrument qui la donne a cessé de mesurer ce qu'il mesurait.* ⚠️ **Rectification d'hier** : les « 62 `DEGRADATION` Overpass » du 08/09 étaient le total **toutes sources** ; la famille en valait **43**, elle en vaut **46** ce jour, **0 `ERROR`** — TRK-037 tient, 8ᵉ point. ⚠️ `trip_automation_runs` **ne garde que 100 lignes** : le 04/09 valait 22 le 06/09 et vaut **19** ce jour — la journée la plus ancienne **s'érode par le bas**, et la mise en garde écrite hier vient de servir pour la première fois. 🔴 **[TRK-074](#trk-074) reste non déployée** — 4 `CRITICAL` actives depuis **4 jours** pendant que sa jumelle archive seule. 🤝 **7ᵉ jour sans compte IA** *(T1)*, et **les trois échéances datées sont dépassées** — TRK-053 (9 j), TRK-032 (19 j), TRK-051 (15 j) | **0 fiche neuve** *(1 signature neuve enregistrée sous TRK-073 : « Passage d'automatisation interrompu » — c'est **la voix d'un correctif**, pas un défaut)* | agent |
...
| 2026-09-04 *(soir, PASSE DE CORRECTION)* | — *(passe de correction)* | **ROADMAP CRÉÉE À LA DEMANDE DU PROPRIÉTAIRE** — les 17 fiches ouvertes classées, non par gravité seule mais par : *ce qui nuit MAINTENANT*, puis *ce qui rend le dispositif AVEUGLE*, puis *ce qui se corrige en une passe*. Voir [`ROADMAP-CORRECTIFS.md`](./ROADMAP-CORRECTIFS.md). **Cinq tâches exécutées dans l'ordre. 🟠 TRK-064** — la sentinelle censée dire « un excès n'a pas produit son alerte » sortait sur sa PREMIÈRE ligne parce qu'aucune société n'avait le réglage actif : *elle rendait le MÊME silence qu'une chaîne en parfait état*. Elle sait désormais le dire, en `DEGRADATION` et une fois par semaine. **🟠 TRK-061** — un compte sans crédit sort en `provider_unfunded`, niveau `DEGRADATION`, avec un message qui NOMME L'ACTION et **ne cite aucun sous-traitant** ; le motif du fournisseur part dans le contexte. Même correctif sur le **client GPT, jumeau exact** — *un défaut corrigé d'un seul côté revient toujours par l'autre*. 🔑 **Et la cause du « un incident, deux lignes » est TROUVÉE** : l'appelant passait la CHAÎNE du message au journal, jamais l'instance — or le marqueur anti-doublon ne peut se poser que sur un OBJET. **🟠 TRK-060** — le message dit la conséquence avant la pile ; *on change l'ORDRE, on n'efface rien*, le motif technique reste en fin de phrase. **🟠 TRK-065** — les comptes techniques sortent du décompte, le nombre d'écartés restant visible au contexte. 🔴 **TRK-062 REQUALIFIÉ, et c'est la décision la plus utile de la passe** : l'état terminal cherché — `SENT_UNCONFIRMED` — **existe déjà dans le produit**, posé pour les commandes MOTEUR avec exactement le bon raisonnement… mais dans une **AUTRE énumération**. L'ajouter demande une **migration**, que le §8 exclut d'une passe automatique au même titre qu'une garde de sécurité. *La passe s'arrête donc et le DIT, plutôt que de choisir en douce un statut existant qui mentirait — `CANCELLED` dirait « annulée » d'une commande bel et bien partie.* Spec prête dans la roadmap. 🧹 **TRK-063 rectifié à `CORRIGÉ`** après vérification sur l'**ARTEFACT SERVI** : l'image a été reconstruite à **01:14:35**, quatre minutes après la collecte de l'audit, et le marqueur `filename*=UTF-8` y est présent. *Le rapport du matin disait vrai à 01:10 et faux à 01:15.* 🔑 **CE QUE LA PASSE A APPRIS** : la première version du correctif TRK-064 déclenchait dans **SIX** mondes de test des AUTRES sentinelles. La tentation était d'ajuster les six fixtures ; la vérité était que le correctif confondait **« aucune société armée » et « aucune société du tout »** — sur une plateforme vide, il n'y a rien à armer et rien à signaler. *Les tests des autres sentinelles ont trouvé un défaut de conception que le test de celle-ci ne pouvait pas voir.* Vérifications : **12 tests neufs**, dont 2 prouvés NON TAUTOLOGIQUES (ils tombent sur l'ancien code) ; **suite API complète 207 suites / 2 979 tests VERTS** ; typecheck ; cohérence des 3 surfaces **7/7**. Branche `fix/roadmap-trk-064-061-062-060-065`, **non poussée, NON DÉPLOYÉE** | **0** | passe de correction |
...
| 2026-08-26 | **31 dont 18 actives et 13 archivees** (5 sur 24 h, **0 CRITICAL active**) — derniere erreur le 25/08 17:47, soit **7 h 24 de silence** | 10 revues ; ✅ **TRK-046 PROUVE PAR LA DOUBLE CONDITION, et le piege annonce par la fiche a ete evite** : les deux compteurs ont ete releves SEPAREMENT dans `engine_control_commands` — **31 coupes commandees ce soir** (18:00 et 20:00, motif « sortie de la plage autorisee », 30 acquittees + 1 SENT_UNCONFIRMED) et **0 REJECTED_SPEED depuis le 25/08 04:37**, contre 10 le 24/08 et 10 le 25/08 avant le correctif de 09:22. *Un seul compteur est tombe : c est le defaut qui a ete retire, pas la fonctionnalite.* ✅ **Le centre d alerte vide a ete VERIFIE, pas suppose** — 0 alerte de tout type en 24 h alors que 2 vehicules sont sans fix depuis 15,7 h et 8,6 h ; le journal du conteneur montre le detecteur GPS **actif toutes les 5 minutes**, qui NOMME les deux vehicules et se tait volontairement (zones `UNDERGROUND_PARKING` / `CONFIRMED_BENIGN` **revues par un operateur reel**, 15/07 et 03/08). ⚠️ **Trois tests dates sur cinq sans reponse, et aucun parce qu un correctif aurait echoue** : le filet `OFF_SCHEDULE_MOVEMENT` n a eu **AUCUNE OCCASION** (ni FZ-862-VY ni FS-253-HR n est ressorti — plus une seule position depuis le 25/08 09:30 et 16:34, **les deux episodes de perte sont toujours ouverts**) ; TRK-050 attend un redemarrage d API qui n a pas eu lieu depuis le correctif de 14:58 (`restarts=0`, API demarree a 12:25, soit AVANT) ; **TRK-021 n a JAMAIS ete tente depuis le 15/08 — 11 jours**, dernier essai `shock_on` + `sensitivity` a 13:26, tous deux FAILED **sur le canal TCP**. 🔵 Mesure au passage et **chiffre pour la premiere fois** : **2 des 6 zones qui font taire le GPS** (GS-014-NY, FL-787-KV) ont ete qualifiees parking **AUTOMATIQUEMENT**, `reviewedById` NULL — ce n est PAS un defaut mais la decision du proprietaire du 17/08, dont le cout est ecrit noir sur blanc dans le code ; rattache a [TRK-027](#trk-027). Angles morts : temoin arme **4/4**, **0 constat** (4ᵉ journee pleine), ecart **13 250** inchange (7ᵉ point), `errorDeleted = 0` **10ᵉ jour**, `trackers_failing` **0**, `commandes_en_attente` **0**, `cadence_resume` **0** (3ᵉ point), `cadence_derive` **0 ligne**, TRK-016 **89,2 %** (8ᵉ point, plateau), debit **125 414 trames / 38 emetteurs / 24 579 positions** | **1** ([TRK-051](#trk-051)) | audit quotidien |
| 2026-08-25 *(soir, CORRECTIF TRK-050)* | — *(passe de correction)* | **TRK-050 CORRIGE, TESTE ET DEPLOYE** (PR #136, 14:58). Le garde « un serveur injoignable ne doit pas deconnecter » existait depuis le 03/08 sur le chemin HTTP ; il est desormais branche sur le chemin WebSocket, avec deux corrections que l enquete avait mises au jour : le compteur d echecs est **remis a zero a la reconnexion** (il ne redescendait JAMAIS, donc trois micro-coupures espacees de plusieurs heures suffisaient SANS aucun redemarrage) et le **second chemin d ejection serveur** recoit le meme garde. La decision est extraite en fonction PURE et EXPORTEE, puis APPELEE par le handler — jamais recopiee (motif de `shouldAnnounce`, dont le commentaire previent qu un test qui duplique sa regle ne verifie que sa propre copie). 🔑 **8 tests neufs, dont 4 qui exercent le VRAI handler** via une couture de creation de socket : le chemin WS n avait AUCUN test, et c est exactement ce qui a permis a la correction du 03/08 de n en traiter que la moitie pendant trois semaines. ⚠️ **Verification test-first refaite APRES coup, et c est une lecon** : la premiere passe montrait 5 echecs sur l ancien code — mais pour une erreur d INJECTION (`SwPush` absent), pas pour le defaut. *Un test qui echoue pour la mauvaise raison ne prouve rien, et il est tentant de le lire comme une preuve.* Harnais complete, puis re-verification : **3 echecs sur l ancien code**, dont « API injoignable : dix echecs ne deconnectent JAMAIS » avec le message exact `Expected spy logout not to have been called` ; et le contrepoint « refus reel expire au 3e » **passe sur les DEUX versions** — les tests ne sont donc pas tautologiques et le comportement #9 est preserve. Suite web complete **453 verts**, `ng build` OK. Marqueurs verifies dans le bundle SERVI par des **litteraux de chaine** (`reinitialiser`/`ignorer`/`expirer`) et jamais par un nom de variable, invalide sur bundle minifie (lecon TRK-002). 🔑 **Deploiement WEB UNIQUEMENT : l API n a PAS redemarre** — le correctif de la deconnexion n a deconnecte personne, et c est aussi pourquoi il reste NON EXERCE. 🗓️ Test date au prochain redemarrage d API : une session ouverte avant la bascule doit rester ouverte apres (0 aux trois redemarrages mesures) | **0** | passe de correction |
| 2026-08-25 *(DÉPLOIEMENT, 09:22 UTC)* | — *(passe de livraison)* | **LES TROIS PR FUSIONNÉES ET DÉPLOYÉES**, marqueurs verifies sur l ARTEFACT SERVI. 🆕 **TRK-049 trouvee en verifiant le CUMUL, et c est tout l interet de le verifier** : la suite complete est passee de « 181 suites vertes » a UN echec — `catalogue-exhaustif.spec.ts`. Diagnostic : la campagne TRK-018 du 24/08 a ajoute un `@Cron` dans `engine-control.service.ts` SANS l inscrire au catalogue ; verifie sur la version SERVIE d avant (`f508405`), le cron y est et le catalogue ne le revendique pas — **defaut PREEXISTANT, garde ROUGE depuis le 24/08**, et la cloture des commandes moteur (le coeur de TRK-018) tournait INVISIBLE dans /admin/background-tasks. 🔑 *Un test de completude ne protege que si on lit son verdict* — ce garde avait ete ecrit le 19/08 apres exactement le meme oubli sur la sonde des taches silencieuses. Corrige, puis cumul re-verifie : **181 suites / 2 709 tests VERTS**, typecheck, smoke-boot DI 5/5, `ng build`, Karma 11/11. Deploiement SEQUENTIEL (api puis web, jamais en parallele sur 2 vCPU), smoke-boot jetable AVANT bascule (**un orphelin `api-run` a bien ete produit et nettoye** — le garde anti-2e-instance a paye), api `healthy` `restarts=0`, migration `20260825120000` appliquee, valeur d enum `OFF_SCHEDULE_MOVEMENT` presente en base, `/api/health` ok. ✅ **TRK-048 EXERCE IMMEDIATEMENT sur son cas d ecole** : FS-253-HR, toujours sans trame valide depuis **18,8 h**, porte toujours `1 s` en base (champ volontairement NON reecrit) et la nouvelle section `cadence_reelle` le classe juste — **5 emetteurs rapides REELS et 2 vestiges separes**, la ou le compteur naif les melangeait. ⚠️ **TRK-046 et TRK-047 : NON EXERCES, et le dire est le plus important** — 0 `REJECTED_SPEED` depuis la bascule, mais FZ-862-VY a retrouve son fix a 09:26 et il est 09:26 UTC, donc dans la plage autorisee : **aucune coupe n est tentee, ce zero ne prouve rien**. 🗓️ Le test date de TRK-046 est **la coupe de 18:00 UTC ce soir** (1 vehicule hors champ a cette heure, 6 zones parking validees sur 6 vehicules) ; celui de TRK-047 court sur 7 jours. Aucune erreur neuve depuis la bascule | **1** (TRK-049) | passe de livraison |
| 2026-08-25 *(après-midi, PASSE DE CORRECTION)* | — *(passe de correction, pas d audit)* | **TROIS lots fermes en trois PR, un lot d enquete** — demande du proprietaire (« corrige TRK-046 sur une branche dediee avec un test, puis TRK-048 et TRK-047 ; un parking souterrain est un comportement NORMAL, pas une erreur »). **PR #133 (TRK-046)** : presomption de stationnement — lieu VALIDE parking → CONSIDERE STATIONNE (exception typee, zero commande, zero alerte, badge « Stationne · parking souterrain » liste/fiche/snapshot, vitesse figee retiree de la fiche) ; lieu inconnu → report HONNETE « hors champ GPS depuis N min » ; filet : alerte CRITICAL `OFF_SCHEDULE_MOVEMENT` a la reapparition en roulant hors plage (migration enum, detection a l ingestion, abstentions plage/override/RESTORE-pendant-l obscurite). 🔑 **Le correctif propose par l audit du matin etait INSUFFISANT** : un tunnel ne produit aucune position, le scan d immobilite y est aveugle — autoriser la coupe sur vitesse perimee aurait pu couper un vehicule EN ROULANT sous terre ; on ne coupe donc jamais a l aveugle. Perdu A L ARRET + lieu inconnu : chemin de juillet conserve ; soupcon TRK-040 → jamais de presomption ; RESTORE jamais retenu. **4 tests verifies EN ECHEC sur l ancien code**, 35 tests neufs, smoke-boot DI 5/5, ng build OK. Etat prod : l ancre de FS-253-HR est A 3 M d une zone parking validee (presomption immediate au deploiement) ; celle de FZ-862-VY n a pas encore de zone a son emplacement (seule zone a 6,8 km) → report honnete puis presomption des validation du lieu. **PR #134 (TRK-048)** : `cadenceMesurePerimee` (3 × l intervalle mesure, plancher 3 min) — « non mesurable » sur les ecrans admin, balayage de recuperation borne par `lastValidFrameAt`, jamais de reecriture du champ ; + section `cadence_reelle` dans collecte.sql pour que l audit cesse de compter les vestiges. **PR #135 (TRK-047)** : le trou se juge a l espacement MEDIAN MESURE des positions voisines (3 ×, fail-open vers le signal) ; `STOPPED_THROTTLE_MS` exporte comme LA constante de calibrage. **ENQUETE TRK-035 (volet volume)** : le chiffre du matin etait bon, la causalite fausse — chaque connexion ecrit DEUX lignes (67 % du fichier), l API ouvre ~5-7 connexions/min (pool Prisma par defaut = 5, sans `application_name`, churn synchronise sur les crons de 5 min), et 🎯 **la fenetre n a JAMAIS ete de ~21 jours** : `/etc/logrotate.d/docker-containers` tourne TOUS les journaux de conteneurs chaque jour avec `rotate 3` — 3-4 jours pour tout l hote, quel que soit le volume. Trois remedes proposes (stanza logrotate dediee / application_name+pool dans l URL / statu quo + moisson), AUCUN applique — decision proprietaire. Reste a faire hors perimetre de la session : TRK-018 nº 4 (ecran immobilisations non confirmees), TRK-020 (colonnes d acquittement — bloque la lecture des 57 ACKNOWLEDGED du matin), backlog TRK-013/014/016/021/024, TRK-035 separation des roles | **0** *(3 fiches passees 🟠 CORRECTIF PROPOSÉ)* | passe de correction |
| 2026-08-25 | **25 dont 15 actives et 10 archivees** (8 sur 24 h, **0 CRITICAL active**) | 28 revues ; **passage consacre au CONTROLE DES SEPT CORRECTIFS du 24/08, tous verifies sur l ARTEFACT SERVI** — et les sept tiennent. ✅ **TRK-045 CORRIGE ET VERIFIE** : debit **4 206-4 781 trames/h** la nuit contre **19 794** au plus fort, et **sous** la reference d avant l incident (6 826/h) ; **ZERO** trame `,C,NNm` apres 07:39, la derniere `,C,05m` datant du **24/08 06:30:03**, avant le deploiement ; `HARD_CAP_S = 99` dans le `dist/` servi ; positions stockees **27 787/24 h**, au-dessus de la reference de 25 713. ✅ **TRK-015 : LA DOUBLE CONDITION EST SATISFAITE** — `RECOVERED_BUFFER` **461** ET `SKIPPED_REPLAY` **2 789**, *les deux vivent : si les deux etaient tombes ensemble on aurait supprime la fonctionnalite, pas le defaut*. ✅ **TRK-018 : LA SECONDE DOUBLE CONDITION AUSSI** — `SENT` = **0**, `SENT_UNCONFIRMED` = **314** dont **0** avec `ackedAt` (le temoin est intact, personne n a acquitte d office), **et les coupes DEMANDEES n ont pas baisse** : `CUT` 36 · 65 · 35 · 35 · 37 · **73** du 19 au 24/08 ; migration `20260824150000` presente, `rolled_back_at` NULL ; colonne `channel` renseignee. ✅ **TRK-025** : HTTP 200, 7 blocages, **dernier le 17/08 19:24:59** — 8 j de silence, le tiers n est pas revenu. ✅ **TRK-035** : la journalisation posee cette nuit fonctionne, et **l attribution se referme exactement** — **544 × `172.23.0.3`** (l API), **152 × `[local]`** pour **154 attendues** d une sonde `pg_isready` toutes les 30 s, **aucune autre adresse** ; ⚠️ **il a fallu LIRE LE FICHIER `LogPath`**, `docker logs` etant peu fiable sur cet hote — le piege documente est reel ; 🔴 **mais le volume est 3,4 x l estimation** : **~4,7 Mo/jour** mesures (253 Ko en 77 min) contre 1,4 annonces, soit une fenetre d enquete de **~3 jours** et non ~21 — *un seul point, a confirmer, mais la sonde de TRK-035 existe pour nommer un tiers APRES COUP et trois jours est court*. ⚪ **TRK-026 non concluant** : aucun SMS sortant depuis le 24/08 07:00, passerelle a **365 `queued`** — *ne pas rouvrir une fiche sur une absence de matiere*. 🔴 **🆕 TRK-046, GRAVITE 1, et c est une FONCTION QUI NE S EXECUTE PAS** : FZ-862-VY devait etre immobilise a 20:00, il ne l est toujours pas a 01:02 — **13 `REJECTED_SPEED` d affilee**, toutes citant `27.15 km/h`, la vitesse de sa **derniere position datee du 24/08 17:29:47** ; le boitier est ONLINE et emet mais **sans fix depuis 7,7 h**. 🔑 **Jumeau exact du defaut FS-253 corrige a MOITIE le 08/07** : le garde « stale » de `:388` exempte le SCHEDULER en expliquant qu une vitesse figee « ne prouve AUCUN mouvement », et le garde `:448` relit la meme valeur perimee soixante lignes plus bas, sans exemption — *quand on corrige un raisonnement, il faut chercher tous les endroits qui le tenaient, pas seulement celui qui a crie* ; ⚠️ **PAS une regression du 24/08** (code du 08/07, commit `9ca272c1`) : ce qui est neuf est l OCCASION — 0 `REJECTED_SPEED` les 8 jours precedents, puis 10 et 3 ; ⚠️ TRK-029 ne rattrape pas (`knownDeadline = false` → backoff exponentiel, `stuckMinutes` 31 → **212**). 🔴 **🆕 TRK-048 : L INSTRUMENT DE CONTROLE DE TRK-045 MENT** — FS-253-HR emet **200 trames/h pendant 10 h**, quatre trames consecutives a **20 s pile**, cible 20 s, et `currentFixIntervalS` **= 1** ; `reconcile()` ne recalcule que depuis `lastValidFrameAt`, fige au 24/08 14:40:03 : le champ dit « cadence au dernier fix », pas « cadence actuelle ». 🔑 **Le critere « boitiers a <= 6 s : 0 ou 1 » a rendu 1 — et ce 1 est un VESTIGE, pas un emetteur rapide** : *un critere satisfait par une valeur perimee ne mesure rien*, et un vrai emetteur rapide simultane aurait fait accuser le mauvais boitier. Portee : **3 boitiers sur 43**. Meme famille que TRK-024. 🔴 **🆕 TRK-047 : deux cadences portent le meme nom** — `FENETRE_MIN_ALERTE_MS = 60_000`, commente « trois fois la cadence », mais la cadence visee est celle des TRAMES (20 s) quand la grandeur protegee est celle des positions STOCKEES (~5 min a l arret) ; sur 24 h **178 610 `SKIPPED_THROTTLE` pour 27 787 `INSERTED`**, 87 % des trames volontairement non stockees — le seuil est **cinq fois trop petit dans le seul regime ou il sert**. 🧹 **CINQ STATUTS D INDEX PERIMES RECTIFIES** (TRK-015, TRK-018, TRK-025, TRK-026, TRK-045) : les fiches etaient a jour depuis le 24/08, l INDEX disait encore l inverse — *le motif signale par le document de controle s est reproduit a l identique, et c est l index qu il faudrait deriver de la fiche*. 🟢 **3e journee pleine sans effacement** — `temoin_arme` rend ses 4 declencheurs actifs, **0 constat**, `n_tup_del` inchange a **3 785**, ecart `ins-del-live` fige a **13 250** (**6e point**), `errorDeleted = 0` pour le **9e jour** ; `tracky-api` **healthy, `restarts=0`**, 10 h de stabilite ; 0 commande bloquee > 1 h ; `trackersFailing` **0** ; `cadence_resume` **0 sous 20 s** sur 43 ; 1 seule alerte en 24 h (OVERSPEED, **avec** message — TRK-023 tient, 6e jour) ; 🆕 **le metronome des echecs de commandes a bouge pour la 1re fois en dix jours** : **64,7/j** contre ~72, et **57 `fix_continuous` ACKNOWLEDGED** dans une famille qui n en avait JAMAIS produit — ⚠️ **mais `acquittees` reste a 0 sur ces 57 lignes** (c est TRK-020 : deux colonnes d acquittement, la collecte lit celle qui ne vient pas du boitier), et **deux points ne font pas une tendance** : fait mesure, pas amelioration demontree | **3** (TRK-046, TRK-047, TRK-048) | agent d'audit |
