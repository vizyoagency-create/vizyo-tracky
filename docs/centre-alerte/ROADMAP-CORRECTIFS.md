...
## 🗂️ Tableau de bord — 99 tâches, l'avancement d'un coup d'œil

**Au 2026-09-16 (audit VPS, 05 h 00 UTC) : 49 faites ·
23 déployées, preuve attendue · 0 commitée · 27 ouvertes** *(99 tâches — dont 2 ouvertes en gravité 1)* — *le compte fait foi dans `app/taches.json`.*
