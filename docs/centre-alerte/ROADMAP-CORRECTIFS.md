...
## 🗂️ Tableau de bord — 97 tâches, l'avancement d'un coup d'œil

**Au 2026-09-15 (audit VPS, 02 h 22 UTC) : 23 faites ·
7 déployées, preuve attendue · 16 commitées · 51 ouvertes** *(dont 7 en gravité 1, 3 au-delà de 7 j)* — *le compte fait foi dans `app/taches.json`.*
