...
**Au 2026-09-21 (02 h 50 UTC) : 64 faites ·
19 déployées, preuve attendue · 0 commitée · 32 ouvertes** *(115 tâches — dont 3 ouvertes en gravité 1)* — *le compte fait foi dans `app/taches.json`.*
...
> chose à faire en premier côté VPS : une ligne dans `CLAUDE.md` — `/usr/bin/sleep` dans tout `Monitor`, et une
> surveillance = une session qui boucle côté serveur.**
