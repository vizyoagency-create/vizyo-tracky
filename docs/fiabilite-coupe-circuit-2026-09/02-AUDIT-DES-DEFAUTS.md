...
| CC-003 | P0 | Pas de file TCP persistante | Une socket absente force immédiatement un SMS | Stocker l'intention et vider à la reconnexion |
...
| CC-028 | P0 | Santé réelle de la passerelle Android absente de Tracky | Une passerelle connectée au serveur peut être incapable de se réveiller | Ping signé, fraîcheur, état batterie/charge, version et âge de file visibles |
