...
const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    kind: 'cron', scheduleHuman: 'chaque jour à 04:30, 06:30 et 21:30 (Europe/Paris)', criticality: 'haute', antiOverlap: false,
    ...
    purpose: "Envoie un SMS de preuve vers un numéro neutre 30 min avant les fenêtres de remise en route de 05:00 et 07:00, et 30 min avant la fenêtre de coupe de 22:00 (passage de 21:30 ajouté le 16/09 : la nuit du 15 au 16, l'interlock a retenu 24 coupes faute de preuve < 24 h, sans que personne ne soit prévenu avant l'heure) : c'est la remise prouvée (< 24 h) que l'interlock exige avant toute coupure automatique. Sans elle, les coupes sont retenues.",
  ...
  },
  {
    ...
    source: 'sms/sms-heartbeat.service.ts', category: 'Notifications',
    kind: 'cron', scheduleHuman: 'chaque jour à 04:45, 06:45 et 21:45 (Europe/Paris)', criticality: 'haute', antiOverlap: false,
    note: 'T45. Quatrième @Cron du même fichier. Relit les preuves des 30 dernières minutes, réconcilie leur statut au relais, reconnaît l’écho entrant (preuve envoyée à la SIM du téléphone lui-même) et alerte : ECHEC en CRITICAL, INDETERMINE en ERROR, NON_EMIS en CRITICAL — et, depuis le 16/09, pousse une notification aux super-admins pour tout verdict ≠ OK (événement coupe-circuit.push).',
