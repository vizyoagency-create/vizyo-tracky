...
export const TEMPLATE_META: {
  ...
  { id: 'agents_pause', label: 'Agents du poste en pause', category: 'Supervision', subject: '[Tracky] Agents du poste en pause — {cause}', trigger: "Les agents du poste se sont mis en pause : plafond de la CLI Claude lu dans sa réponse, ou cinq heures d'échecs d'affilée (sentinelle horaire, un courriel par pause)" },
  ...
  { id: 'installation_slot_rejected', label: 'Créneau refusé', category: 'Installation', subject: 'Votre créneau d\'installation n\'a pas pu être retenu', trigger: 'L\'opérateur refuse la demande en cochant « prévenir le client »' },
  { id: 'installation_slot_cancelled', label: 'Rendez-vous annulé', category: 'Installation', subject: 'Votre rendez-vous d\'installation est annulé', trigger: 'L\'opérateur annule une demande (en attente ou confirmée) en cochant « prévenir le client »' },
  ...
  { id: 'reservation_request_pending', label: 'Demande de réservation à valider', category: 'Réservation', subject: 'Demande de réservation à valider', trigger: 'Un demandeur soumet via un lien public — envoyé à ceux qui peuvent valider' },
