...
export const SMS_TEMPLATE_META: (CommTemplateMeta & { id: SmsTemplateId })[] = [
  ...
  { channel: 'SMS', id: 'gateway_daily_proof', label: 'Preuve quotidienne passerelle', category: 'Technique', trigger: 'Cron quotidien (04:30, 06:30 et 21:30)', description: 'Prouve chaque jour, avant le départ des véhicules, que la chaîne SMS remet — la preuve qu’exige l’interlock des coupes automatiques (T45).' },
