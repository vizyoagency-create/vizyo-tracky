...
@Component({
  ...
  styles: [
    `
      ...
      .pl-chip-off { background: color-mix(in srgb, var(--danger) 16%, transparent); color: var(--texte-alerte); }
      ...
      .pl-btn-danger { border-color: var(--danger); color: var(--texte-alerte); }
      ...
      .pl-warn { color: var(--texte-attente); }
      .pl-error { margin: 0; padding: 0.6rem 0.75rem; border-radius: 8px; background: color-mix(in srgb, var(--danger) 16%, transparent); color: var(--texte-alerte); font-size: 0.875rem; }
      ...
      .pl-hint { font-size: 0.72rem; color: var(--texte-attente); }
