...
@Component({
  ...
  template: `
    <div class="flex flex-col gap-6">
      ...
      <!-- ⚠️ L'ONGLET « Configuration boîtier » A ÉTÉ DÉPLACÉ, PAS SUPPRIMÉ (2026-08-18).
           Il vit désormais dans la modale d'ajout de véhicule, à l'endroit exact où le
           besoin apparaît : quand le boîtier n'a pas répondu en TCP. Ici, il demandait
           six champs à la main — IMEI, numéro, APN, numéro admin, IP et port — à un
           SUPER_ADMIN qui ne les connaissait pas mieux que l'installateur. Tout est
           maintenant déduit. Le laisser en double ferait diverger les deux chemins. -->
